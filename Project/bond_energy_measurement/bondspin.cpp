...
#define refsite 0    // You may change the reference site
//===================================================================================
//				BLAS ROUTINES
//===================================================================================
extern "C" {
...
//====================================================================================
BondSpin::BondSpin( const int &lsys, Parameter &para, Super &sup ) {
...
//===============================================================================
inline void BondSpin::CreateSpace( const int &lsys, Parameter &para ) {
...
//===============================================================================================================
inline void BondSpin::CreateFunction( Super &sup ) {
...
//========================================================================================
inline void BondSpin::Correlation_sys( const int &lsys, Parameter &para, Super &sup ) {
	...
	if( i >= refsite ) {
		...
		if( i == 0 )  New_A_Si_initial( 0 );
         ...
         //-----Transform Si operators
		  ...
		  if( para.Table_J[i*para.Total_N + j] == 1 ) {
			...
			cout<<"\n"<<i<<"\t"<<j<<"\t"<<correlation[ i ][ j ];
                ...
                //----Calculate the expectation value of correlation function
		if(para.Table_J[i*para.Total_N + lsys] == 1) {
		...
		cout<<"\n"<<i<<"\t"<<lsys<<"\t"<<correlation[ i ][ lsys ];
                ...
                //----Calculate the expectation value of correlation function
		if(para.Table_J[i*para.Total_N + lsys + 1] == 1) {
...
//==========================================================================
inline void BondSpin::Correlation_ns_ne( const int &lsys, Parameter &para, Super &sup ) {

	if( para.Table_J[ para.Total_N * lsys + lsys + 1 ] == 1 ) {
...
//==========================================================================
inline void BondSpin::Correlation_env( const int &lsys, Parameter &para, Super &sup ) {
	...
	if( i >= refsite ) {
		...
		if( i == 0 )  New_B_Si_initial( 0 );
         ...
         //-----Transform Si operators
		  ...
		  if( para.Table_J[ para.Total_N * (para.Total_N-1-i) + para.Total_N-1-j] == 1 ) {
			...
			cout<<"\n"<<para.Total_N - 1 - j<<"\t"<<para.Total_N - 1 - i<<"\t"<<correlation[ para.Total_N - 1 - i ][ para.Total_N - 1 - j ];
                ...
                //----Calculate the expectation value of correlation function
		if( para.Table_J[ para.Total_N * (para.Total_N-1-i) + lsys + 1 ] == 1 ) {
		...
		cout<<"\n"<<lsys+1<<"\t"<<para.Total_N - 1 - i<<"\t"<<correlation[ para.Total_N - 1 - i ][ lsys+1 ];
                ...
                //----Calculate the expectation value of correlation function
		if( para.Table_J[ para.Total_N * (para.Total_N-1-i) + lsys ] == 1 ) {
...
//				system spin correlation
//========================================================================================
inline void BondSpin::Correlation_sys_env( const int &lsys, Parameter &para, Super &sup ) {
	...
	for( int i = 0; i < lsys; i++ ) 
		...
		for( int m = 0; m < para.Total_N - 2 - lsys; m++ ) 
	        if( m >= refsite && para.Table_J[para.Total_N * i + para.Total_N-1-m] == 1 ) {
...
//                                     New_A_Si_initial
//=========================================================================================
inline void BondSpin::New_A_Si_initial( const int &num ) {
...
//                                     New_B_Si_initial
//=========================================================================================
inline void BondSpin::New_B_Si_initial( const int &num ) {
...
//                                      New_A_Si
//=====================================================================================
inline void BondSpin::New_A_Si_new( const int &num ) {
...
//                                      New_B_Si
//=====================================================================================
inline void BondSpin::New_B_Si_new( const int &num ) {
...
//==========================================================================================
inline void BondSpin::Truncate_A_Si( const int &num ) {
...
//==========================================================================================
inline void BondSpin::Truncate_B_Si( const int &num ) {
...
//                           Initial_A_SiSj
//=========================================================================
inline void BondSpin::Initial_A_SiSj( const int &num ) {
...
//                           Initial_B_SiSj
//=========================================================================
inline void BondSpin::Initial_B_SiSj( const int &num ) {
...
//===============================================================================
inline void BondSpin::Truncate_A_SiSj( const int &num ) {
...
//===============================================================================
inline void BondSpin::Truncate_B_SiSj( const int &num ) {
...
//                                    New A_SiSj
//===================================================================================
inline void BondSpin::New_A_SiSj( const int &num ) {
...
//                                    New B_SiSj
//===================================================================================
inline void BondSpin::New_B_SiSj( const int &num ) {
...
//===============================================================================================================
inline void BondSpin::DeleteFunction( Super &sup ) {
...
//						Delete Space
//===============================================================================================================
inline void BondSpin::DeleteSpace( const int &lsys, Parameter &para ) {
