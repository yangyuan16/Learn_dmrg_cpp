...
#include"sub.h"
#include"super.h"
#include"densitycorrelation_xo.h"

#define constant sqrt(6.0)*0.5
#define hoping -sqrt(2.0)
#define ref_site 46    // You may change the reference site
...
//====================================================================================
DensityCorrelation_xo::DensityCorrelation_xo( const int &lsys, Parameter &para, Super &sup ) {
  ...
  //----Create filename
        stringstream ss;
        ss<<"measurement_density_correlation_xo.dat";
        filename=ss.str();
        fout.precision(12);
...
//===============================================================
inline void DensityCorrelation_xo::CreateSpace( const int &lsys, Parameter &para ) {
...
//===========================================================================
inline void DensityCorrelation_xo::CreateFunction( Super &sup ) {
...
//======================================================================
inline void DensityCorrelation_xo::Density_sys( const int &lsys, Parameter &para, Super &sup ) {
...
//======================================================================
inline void DensityCorrelation_xo::Density_sys_env( const int &lsys, Parameter &para, Super &sup ) {
...
//===================================================================
inline void DensityCorrelation_xo::Density_env( const int &lsys, Parameter &para, Super &sup ) {
...
//========================================================================
inline void DensityCorrelation_xo::Density_ns_ne(const int &lsys, Parameter &para, Super &sup) {
...
//				     A_Initial_Ni
//===================================================================
inline void DensityCorrelation_xo::A_Initial_Ni( const int &num ) {
...
//			     B_Initial_Ni
//=======================================================================
inline void DensityCorrelation_xo::B_Initial_Ni( const int &num ) {
...
//				     A_Truncate
//===========================================================================
inline void DensityCorrelation_xo::A_Truncate_Ni( const int &num ) {
...
//			     B_Truncate
//===============================================================
inline void DensityCorrelation_xo::B_Truncate_Ni( const int &num ) {
...
//		     Truncate_A_SiSj
//=============================================================
inline void DensityCorrelation_xo::Truncate_A_SiSj( const int &num ) {
...
//		     Truncate_B_SiSj
//=============================================================
inline void DensityCorrelation_xo::Truncate_B_SiSj( const int &num ) {
...
//			     A_New
//==================================================================
inline void DensityCorrelation_xo::A_New_Ni( const int &num ) {
...
//			     New_A_SiSj
//==================================================================
inline void DensityCorrelation_xo::New_A_SiSj( const int &num ) {
...
//			     New_B_SiSj
//==================================================================
inline void DensityCorrelation_xo::New_B_SiSj( const int &num ) {
...
//			     B_New
//====================================================================
inline void DensityCorrelation_xo::B_New_Ni( const int &num ) {
...
//			Initial_A_NiNj
//===================================================================
inline void DensityCorrelation_xo::Initial_A_SiSj( const int &num ) {
...
//			Initial_B_NiNj
//===================================================================
inline void DensityCorrelation_xo::Initial_B_SiSj( const int &num ) {
...
//=====================================================================
inline void DensityCorrelation_xo::DeleteFunction( Super &sup ) {
...
//						Delete Space
//======================================================================================
inline void DensityCorrelation_xo::DeleteSpace( const int &lsys, Parameter &para ) {
...
//===============================================================================================================
DensityCorrelation_xo::~DensityCorrelation_xo() {}
//==================================================END==========================================================
