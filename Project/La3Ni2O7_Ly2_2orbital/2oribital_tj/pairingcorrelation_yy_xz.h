...
class PairingCorrelation_yy_xz {

public:

	PairingCorrelation_yy_xz( const int &lsys, Parameter &para, Super &sup );

    ~PairingCorrelation_yy_xz();
...
private:
 ...
 //----Create filestream for saving data
  ...
  //----Create spaces for matrices and functions
	...
	int * A_N_Block_Num_SC;
	int ** A_N_hole_block_SC_bra;
	int ** A_N_hole_block_SC_ket;
	int ** A_N_Num_J_block_SC;
	int *** A_N_J_block_SC_bra;
	int *** A_N_J_block_SC_ket;
	...
	int * B_N_Block_Num_SC;
	int ** B_N_hole_block_SC_bra;
	int ** B_N_hole_block_SC_ket;
	int ** B_N_Num_J_block_SC;
	int *** B_N_J_block_SC_bra;
	int *** B_N_J_block_SC_ket;
	...
	int * A_Block_Num_SC;
	int ** A_hole_block_SC_bra;
	int ** A_hole_block_SC_ket;
	int ** A_Num_J_block_SC;
	int *** A_J_block_SC_bra;
	int *** A_J_block_SC_ket;
	...
	int * B_Block_Num_SC;
	int ** B_hole_block_SC_bra;
	int ** B_hole_block_SC_ket;
	int ** B_Num_J_block_SC;
	int *** B_J_block_SC_bra;
	int *** B_J_block_SC_ket;
