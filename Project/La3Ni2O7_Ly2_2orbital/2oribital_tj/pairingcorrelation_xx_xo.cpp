...
#include"sub.h"
#include"super.h"
#include"pairingcorrelation_xx_xo.h"
...
//====================================================================================
PairingCorrelation_xx_xo::PairingCorrelation_xx_xo( const int &lsys, Parameter &para, Super &sup ) {
  ...
  //----Create filename-----------------------------------------------------------------------------------------
    stringstream ss;
    ss<<"measurement_pairing_xx_xo.dat";
    filename=ss.str();
    fout.precision(12);
...
//===============================================================================================================
inline void PairingCorrelation_xx_xo::CreateSpace( const int &lsys, Parameter &para ) {
...
//===============================================================================================================
inline void PairingCorrelation_xx_xo::CreateFunction( Super &sup ) {
...
//========================================================================================
inline void PairingCorrelation_xx_xo::Correlation_sys_env( const int &lsys, Parameter &para, Super &sup ) {
	...
	if( i == ref_site  &&  j == i + 4 ) {
		...
		if( k % (para.N_u * para.N_y) == 1  &&  l == k + 4 ) {
...
//                                     New_A_Si_initial
//=========================================================================================
inline void PairingCorrelation_xx_xo::New_A_Si_initial( const int &num ) {
...
//                                     New_B_Si_initial
//=========================================================================================
inline void PairingCorrelation_xx_xo::New_B_Si_initial( const int &num ) {
...
//                                      New_A_Ti
//=====================================================================================
inline void PairingCorrelation_xx_xo::New_A_Si_new( const int &num ) {
...
//                                      New_B_Ti
//=====================================================================================
inline void PairingCorrelation_xx_xo::New_B_Si_new( const int &num ) {
...
//==========================================================================================
inline void PairingCorrelation_xx_xo::Truncate_A_Si( const int &num ) {
...
//==========================================================================================
inline void PairingCorrelation_xx_xo::Truncate_B_Si( const int &num ) {
...
//                                     Initial_A_SiSj
//===========================================================================================
inline void PairingCorrelation_xx_xo::Initial_A_SiSj( const int &num ) {
...
//                                     Initial_B_SiSj
//===========================================================================================
inline void PairingCorrelation_xx_xo::Initial_B_SiSj( const int &num ) {
...
//===============================================================================
inline void PairingCorrelation_xx_xo::Truncate_A_SiSj( const int &num ) {
...
//===============================================================================
inline void PairingCorrelation_xx_xo::Truncate_B_SiSj( const int &num ) {
...
//                                    New A_SiSj
//===================================================================================
inline void PairingCorrelation_xx_xo::New_A_SiSj( const int &num ) {
...
//                                    New B_SiSj
//===================================================================================
inline void PairingCorrelation_xx_xo::New_B_SiSj( const int &num ) {
...
//===============================================================================================================
inline void PairingCorrelation_xx_xo::DeleteFunction( Super &sup ) {
...
//						Delete Space
//===============================================================================================================
inline void PairingCorrelation_xx_xo::DeleteSpace( const int &lsys, Parameter &para ) {
...
//===============================================================================================================
PairingCorrelation_xx_xo::~PairingCorrelation_xx_xo() {}
//==================================================END==========================================================
