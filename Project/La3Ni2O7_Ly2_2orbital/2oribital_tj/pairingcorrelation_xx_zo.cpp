...
#include"sub.h"
#include"super.h"
#include"pairingcorrelation_xx_zo.h"
...
//====================================================================================
PairingCorrelation_xx_zo::PairingCorrelation_xx_zo( const int &lsys, Parameter &para, Super &sup ) {
  ...
  //----Create filename-----------------------------------------------------------------------------------------
    stringstream ss;
    ss<<"measurement_pairing_xx_zo.dat";
    filename=ss.str();
    fout.precision(12);
...
//===============================================================================================================
inline void PairingCorrelation_xx_zo::CreateSpace( const int &lsys, Parameter &para ) {
...
//===============================================================================================================
inline void PairingCorrelation_xx_zo::CreateFunction( Super &sup ) {
...
//========================================================================================
inline void PairingCorrelation_xx_zo::Correlation_sys_env( const int &lsys, Parameter &para, Super &sup ) {
	...
	if( i == ref_site  &&  j == i + 4 ) {
		...
		if( k % (para.N_u * para.N_y) == 3  &&  l == k + 4 ) {
...
//                                     New_A_Si_initial
//=========================================================================================
inline void PairingCorrelation_xx_zo::New_A_Si_initial( const int &num ) {
...
//                                     New_B_Si_initial
//=========================================================================================
inline void PairingCorrelation_xx_zo::New_B_Si_initial( const int &num ) {
...
//                                      New_A_Ti
//=====================================================================================
inline void PairingCorrelation_xx_zo::New_A_Si_new( const int &num ) {
...
//                                      New_B_Ti
//=====================================================================================
inline void PairingCorrelation_xx_zo::New_B_Si_new( const int &num ) {
...
//==========================================================================================
inline void PairingCorrelation_xx_zo::Truncate_A_Si( const int &num ) {
...
//==========================================================================================
inline void PairingCorrelation_xx_zo::Truncate_B_Si( const int &num ) {
...
//                                     Initial_A_SiSj
//===========================================================================================
inline void PairingCorrelation_xx_zo::Initial_A_SiSj( const int &num ) {
...
//                                     Initial_B_SiSj
//===========================================================================================
inline void PairingCorrelation_xx_zo::Initial_B_SiSj( const int &num ) {
...
//===============================================================================
inline void PairingCorrelation_xx_zo::Truncate_A_SiSj( const int &num ) {
...
//===============================================================================
inline void PairingCorrelation_xx_zo::Truncate_B_SiSj( const int &num ) {
...
//                                    New A_SiSj
//===================================================================================
inline void PairingCorrelation_xx_zo::New_A_SiSj( const int &num ) {
...
//                                    New B_SiSj
//===================================================================================
inline void PairingCorrelation_xx_zo::New_B_SiSj( const int &num ) {
...
//===============================================================================================================
inline void PairingCorrelation_xx_zo::DeleteFunction( Super &sup ) {
...
//						Delete Space
//===============================================================================================================
inline void PairingCorrelation_xx_zo::DeleteSpace( const int &lsys, Parameter &para ) {
...
//===============================================================================================================
PairingCorrelation_xx_zo::~PairingCorrelation_xx_zo() {}
//==================================================END==========================================================
