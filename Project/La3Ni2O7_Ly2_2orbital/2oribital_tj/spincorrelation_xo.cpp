...
//====================================================================================
SpinCorrelation_xo::SpinCorrelation_xo( const int &lsys, Parameter &para, Super &sup ) {
  ...
  //----Create filename
        stringstream ss;
        ss<<"measurement_spin_correlation_xo.dat";
        filename=ss.str();
        fout.precision(12);
...
//===============================================================================
inline void SpinCorrelation_xo::CreateSpace( const int &lsys, Parameter &para ) {
...
//===============================================================================================================
inline void SpinCorrelation_xo::CreateFunction( Super &sup ) {
...
//========================================================================================
inline void SpinCorrelation_xo::Correlation_sys( const int &lsys, Parameter &para, Super &sup ) {
...
//==========================================================================
inline void SpinCorrelation_xo::Correlation_ns_ne( const int &lsys, Parameter &para, Super &sup ) {
...
//==========================================================================
inline void SpinCorrelation_xo::Correlation_env( const int &lsys, Parameter &para, Super &sup ) {
...
//				system spin correlation
//========================================================================================
inline void SpinCorrelation_xo::Correlation_sys_env( const int &lsys, Parameter &para, Super &sup ) {
...
//                                     New_A_Si_initial
//=========================================================================================
inline void SpinCorrelation_xo::New_A_Si_initial( const int &num ) {
...
//                                     New_B_Si_initial
//=========================================================================================
inline void SpinCorrelation_xo::New_B_Si_initial( const int &num ) {
...
//                                      New_A_Si
//=====================================================================================
inline void SpinCorrelation_xo::New_A_Si_new( const int &num ) {
...
//                                      New_B_Si
//=====================================================================================
inline void SpinCorrelation_xo::New_B_Si_new( const int &num ) {
...
//==========================================================================================
inline void SpinCorrelation_xo::Truncate_A_Si( const int &num ) {
...
//==========================================================================================
inline void SpinCorrelation_xo::Truncate_B_Si( const int &num ) {
...
//                           Initial_A_SiSj
//=========================================================================
inline void SpinCorrelation_xo::Initial_A_SiSj( const int &num ) {
...
//                           Initial_B_SiSj
//=========================================================================
inline void SpinCorrelation_xo::Initial_B_SiSj( const int &num ) {
...
//===============================================================================
inline void SpinCorrelation_xo::Truncate_A_SiSj( const int &num ) {
...
//===============================================================================
inline void SpinCorrelation_xo::Truncate_B_SiSj( const int &num ) {
...
//                                    New A_SiSj
//===================================================================================
inline void SpinCorrelation_xo::New_A_SiSj( const int &num ) {
...
//                                    New B_SiSj
//===================================================================================
inline void SpinCorrelation_xo::New_B_SiSj( const int &num ) {
...
//===============================================================================================================
inline void SpinCorrelation_xo::DeleteFunction( Super &sup ) {
...
//						Delete Space
//===============================================================================================================
inline void SpinCorrelation_xo::DeleteSpace( const int &lsys, Parameter &para ) {
...
//===============================================================================================================
SpinCorrelation_xo::~SpinCorrelation_xo() {}
//==================================================END==========================================================
