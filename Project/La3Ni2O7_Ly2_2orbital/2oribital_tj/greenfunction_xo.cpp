...
#include"sub.h"
#include"super.h"
#include"greenfunction_xo.h"

#define constant sqrt(6.0)*0.5
#define hoping -sqrt(2.0)
#define ref_site 46	// You may change the reference site here
//===================================================================================
//				BLAS ROUTINES
//===================================================================================
extern "C" {
...
//====================================================================================
GreenFunction_xo::GreenFunction_xo( const int &lsys, Parameter &para, Super &sup ) {
	...
	//----Create filename
        stringstream ss;
        ss<<"measurement_green_function_xo.dat";
        filename=ss.str();
        fout.precision(12);
...
//============================================================================
inline void GreenFunction_xo::CreateSpace( const int &lsys, Parameter &para ) {
...
//=============================================================================
inline void GreenFunction_xo::CreateFunction( Super &sup ) {
...
//				system 
//========================================================================
inline void GreenFunction_xo::Correlation_sys( const int &lsys, Parameter &para, Super &sup ) {
...
//				environment
//========================================================================
inline void GreenFunction_xo::Correlation_env( const int &lsys, Parameter &para, Super &sup ) {
...
//				ns and ne
//========================================================================
inline void GreenFunction_xo::Correlation_ns_ne( const int &lsys, Parameter &para, Super &sup ) {
...
//========================================================================
inline void GreenFunction_xo::Correlation_sys_env( const int &lsys, Parameter &para, Super &sup ) {
...
//                                     New_A_Si_initial
//=========================================================================================
inline void GreenFunction_xo::New_A_Si_initial( const int &num ) {
...
//                                     New_B_Si_initial
//=========================================================================================
inline void GreenFunction_xo::New_B_Si_initial( const int &num ) {
...
//                                      New_A_Ti
//=====================================================================================
inline void GreenFunction_xo::New_A_Si_new( const int &num ) {
...
//                                      New_B_Ti
//=====================================================================================
inline void GreenFunction_xo::New_B_Si_new( const int &num ) {
...
//========================================================================
inline void GreenFunction_xo::Truncate_A_Si( const int &num ) {
...
//==========================================================================================
inline void GreenFunction_xo::Truncate_B_Si( const int &num ) {
...
//                           Initial_A_SiSj
//========================================================================
inline void GreenFunction_xo::Initial_A_SiSj( const int &num ) {
...
//                           Initial_B_SiSj
//========================================================================
inline void GreenFunction_xo::Initial_B_SiSj( const int &num ) {
...
//===============================================================================
inline void GreenFunction_xo::Truncate_A_SiSj( const int &num ) {
...
//===============================================================================
inline void GreenFunction_xo::Truncate_B_SiSj( const int &num ) {
...
//                                    New A_SiSj
//===================================================================================
inline void GreenFunction_xo::New_A_SiSj( const int &num ) {
...
//                                    New B_SiSj
//===================================================================================
inline void GreenFunction_xo::New_B_SiSj( const int &num ) {
...
//=================================================================
inline void GreenFunction_xo::DeleteFunction( Super &sup ) {
...
//			Delete Space
//==================================================================
inline void GreenFunction_xo::DeleteSpace( const int &lsys, Parameter &para ) {
...
//===============================================================================================================
GreenFunction_xo::~GreenFunction_xo() {}
//==================================================END==========================================================
