...
#define ref_site 44    // You may change the reference site
...
//====================================================================================
DensityCorrelation::DensityCorrelation( const int &lsys, Parameter &para, Super &sup ) {
  ...
  //----Create filename
        stringstream ss;
        ss<<"measurement_density_correlation.dat";
        filename=ss.str();
        fout.precision(12);
...
//===============================================================
inline void DensityCorrelation::CreateSpace( const int &lsys, Parameter &para ) {
...
//===========================================================================
inline void DensityCorrelation::CreateFunction( Super &sup ) {
...
//======================================================================
inline void DensityCorrelation::Density_sys( const int &lsys, Parameter &para, Super &sup ) {
...
//======================================================================
inline void DensityCorrelation::Density_sys_env( const int &lsys, Parameter &para, Super &sup ) {
...
//===================================================================
inline void DensityCorrelation::Density_env( const int &lsys, Parameter &para, Super &sup ) {
...
//========================================================================
inline void DensityCorrelation::Density_ns_ne(const int &lsys, Parameter &para, Super &sup) {
...
//				     A_Initial_Ni
//===================================================================
inline void DensityCorrelation::A_Initial_Ni( const int &num ) {
...
//			     B_Initial_Ni
//=======================================================================
inline void DensityCorrelation::B_Initial_Ni( const int &num ) {
...
//				     A_Truncate
//===========================================================================
inline void DensityCorrelation::A_Truncate_Ni( const int &num ) {
...
//			     B_Truncate
//===============================================================
inline void DensityCorrelation::B_Truncate_Ni( const int &num ) {
...
//		     Truncate_A_SiSj
//=============================================================
inline void DensityCorrelation::Truncate_A_SiSj( const int &num ) {
...
//		     Truncate_B_SiSj
//=============================================================
inline void DensityCorrelation::Truncate_B_SiSj( const int &num ) {
...
//			     A_New
//==================================================================
inline void DensityCorrelation::A_New_Ni( const int &num ) {
...
//			     New_A_SiSj
//==================================================================
inline void DensityCorrelation::New_A_SiSj( const int &num ) {
...
//			     New_B_SiSj
//==================================================================
inline void DensityCorrelation::New_B_SiSj( const int &num ) {
...
//			     B_New
//====================================================================
inline void DensityCorrelation::B_New_Ni( const int &num ) {
...
//			Initial_A_NiNj
//===================================================================
inline void DensityCorrelation::Initial_A_SiSj( const int &num ) {
...
//			Initial_B_NiNj
//===================================================================
inline void DensityCorrelation::Initial_B_SiSj( const int &num ) {
...
//=====================================================================
inline void DensityCorrelation::DeleteFunction( Super &sup ) {
...
//						Delete Space
//======================================================================================
inline void DensityCorrelation::DeleteSpace( const int &lsys, Parameter &para ) {
...
//===============================================================================================================
DensityCorrelation::~DensityCorrelation() {}
//==================================================END==========================================================
