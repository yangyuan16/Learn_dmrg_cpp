...
#define ref_site 44	// You may change the reference site here
//===================================================================================
//				BLAS ROUTINES
//===================================================================================
extern "C" {
...
//====================================================================================
GreenFunction::GreenFunction( const int &lsys, Parameter &para, Super &sup ) {
	...
	//----Create filename
        stringstream ss;
        ss<<"measurement_green_function.dat";
        filename=ss.str();
        fout.precision(12);
...
//============================================================================
inline void GreenFunction::CreateSpace( const int &lsys, Parameter &para ) {
...
//=============================================================================
inline void GreenFunction::CreateFunction( Super &sup ) {
...
//				system 
//========================================================================
inline void GreenFunction::Correlation_sys( const int &lsys, Parameter &para, Super &sup ) {
...
//				environment
//========================================================================
inline void GreenFunction::Correlation_env( const int &lsys, Parameter &para, Super &sup ) {
...
//				ns and ne
//========================================================================
inline void GreenFunction::Correlation_ns_ne( const int &lsys, Parameter &para, Super &sup ) {
...
//========================================================================
inline void GreenFunction::Correlation_sys_env( const int &lsys, Parameter &para, Super &sup ) {
...
//                                     New_A_Si_initial
//=========================================================================================
inline void GreenFunction::New_A_Si_initial( const int &num ) {
...
//                                     New_B_Si_initial
//=========================================================================================
inline void GreenFunction::New_B_Si_initial( const int &num ) {
...
//                                      New_A_Ti
//=====================================================================================
inline void GreenFunction::New_A_Si_new( const int &num ) {
...
//                                      New_B_Ti
//=====================================================================================
inline void GreenFunction::New_B_Si_new( const int &num ) {
...
//========================================================================
inline void GreenFunction::Truncate_A_Si( const int &num ) {
...
//==========================================================================================
inline void GreenFunction::Truncate_B_Si( const int &num ) {
...
//                           Initial_A_SiSj
//========================================================================
inline void GreenFunction::Initial_A_SiSj( const int &num ) {
...
//                           Initial_B_SiSj
//========================================================================
inline void GreenFunction::Initial_B_SiSj( const int &num ) {
...
//===============================================================================
inline void GreenFunction::Truncate_A_SiSj( const int &num ) {
...
//===============================================================================
inline void GreenFunction::Truncate_B_SiSj( const int &num ) {
...
//                                    New A_SiSj
//===================================================================================
inline void GreenFunction::New_A_SiSj( const int &num ) {
...
//                                    New B_SiSj
//===================================================================================
inline void GreenFunction::New_B_SiSj( const int &num ) {
...
//=================================================================
inline void GreenFunction::DeleteFunction( Super &sup ) {
...
//			Delete Space
//==================================================================
inline void GreenFunction::DeleteSpace( const int &lsys, Parameter &para ) {
