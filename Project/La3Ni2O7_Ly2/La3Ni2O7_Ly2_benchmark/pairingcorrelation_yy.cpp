...
//====================================================================================
PairingCorrelation_yy::PairingCorrelation_yy( const int &lsys, Parameter &para, Super &sup ) {
...
//===============================================================================================================
inline void PairingCorrelation_yy::CreateSpace( const int &lsys, Parameter &para ) {
...
//===============================================================================================================
inline void PairingCorrelation_yy::CreateFunction( Super &sup ) {
...
//========================================================================================
inline void PairingCorrelation_yy::Correlation_sys_env( const int &lsys, Parameter &para, Super &sup ) {
...
//                                     New_A_Si_initial
//=========================================================================================
inline void PairingCorrelation_yy::New_A_Si_initial( const int &num ) {
...
//                                     New_B_Si_initial
//=========================================================================================
inline void PairingCorrelation_yy::New_B_Si_initial( const int &num ) {
...
//                                      New_A_Ti
//=====================================================================================
inline void PairingCorrelation_yy::New_A_Si_new( const int &num ) {
...
//                                      New_B_Ti
//=====================================================================================
inline void PairingCorrelation_yy::New_B_Si_new( const int &num ) {
...
//==========================================================================================
inline void PairingCorrelation_yy::Truncate_A_Si( const int &num ) {
...
//==========================================================================================
inline void PairingCorrelation_yy::Truncate_B_Si( const int &num ) {
...
//                                     Initial_A_SiSj
//===========================================================================================
inline void PairingCorrelation_yy::Initial_A_SiSj( const int &num ) {
...
//                                     Initial_B_SiSj
//===========================================================================================
inline void PairingCorrelation_yy::Initial_B_SiSj( const int &num ) {
...
//===============================================================================
inline void PairingCorrelation_yy::Truncate_A_SiSj( const int &num ) {
...
//===============================================================================
inline void PairingCorrelation_yy::Truncate_B_SiSj( const int &num ) {
...
//                                    New A_SiSj
//===================================================================================
inline void PairingCorrelation_yy::New_A_SiSj( const int &num ) {
...
//                                    New B_SiSj
//===================================================================================
inline void PairingCorrelation_yy::New_B_SiSj( const int &num ) {
...
//===============================================================================================================
inline void PairingCorrelation_yy::DeleteFunction( Super &sup ) {
...
//						Delete Space
//===============================================================================================================
inline void PairingCorrelation_yy::DeleteSpace( const int &lsys, Parameter &para ) {
...
//===============================================================================================================
PairingCorrelation_yy::~PairingCorrelation_yy() {}
//==================================================END==========================================================
