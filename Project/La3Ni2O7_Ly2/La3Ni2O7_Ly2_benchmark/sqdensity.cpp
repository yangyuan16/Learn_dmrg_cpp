...
#define ref_site 61    // You may change the reference site
...
//====================================================================================
SqDensity::SqDensity( const int &lsys, Parameter &para, Super &sup ) {
...
//===============================================================
inline void SqDensity::CreateSpace( const int &lsys, Parameter &para ) {
...
//===========================================================================
inline void SqDensity::CreateFunction( Super &sup ) {
...
//======================================================================
inline void SqDensity::Density_sys( const int &lsys, Parameter &para, Super &sup ) {
...
//======================================================================
inline void SqDensity::Density_sys_env( const int &lsys, Parameter &para, Super &sup ) {
...
//===================================================================
inline void SqDensity::Density_env( const int &lsys, Parameter &para, Super &sup ) {
...
//========================================================================
inline void SqDensity::Density_ns_ne(const int &lsys, Parameter &para, Super &sup) {
...
//				     A_Initial_Ni
//===================================================================
inline void SqDensity::A_Initial_Ni( const int &num ) {
...
//			     B_Initial_Ni
//=======================================================================
inline void SqDensity::B_Initial_Ni( const int &num ) {
...
//				     A_Truncate
//===========================================================================
inline void SqDensity::A_Truncate_Ni( const int &num ) {
...
//			     B_Truncate
//===============================================================
inline void SqDensity::B_Truncate_Ni( const int &num ) {
...
//		     Truncate_A_SiSj
//=============================================================
inline void SqDensity::Truncate_A_SiSj( const int &num ) {
...
//		     Truncate_B_SiSj
//=============================================================
inline void SqDensity::Truncate_B_SiSj( const int &num ) {
...
//			     A_New
//==================================================================
inline void SqDensity::A_New_Ni( const int &num ) {
...
//			     New_A_SiSj
//==================================================================
inline void SqDensity::New_A_SiSj( const int &num ) {
...
//			     New_B_SiSj
//==================================================================
inline void SqDensity::New_B_SiSj( const int &num ) {
...
//			     B_New
//====================================================================
inline void SqDensity::B_New_Ni( const int &num ) {
...
//			Initial_A_NiNj
//===================================================================
inline void SqDensity::Initial_A_SiSj( const int &num ) {
...
//			Initial_B_NiNj
//===================================================================
inline void SqDensity::Initial_B_SiSj( const int &num ) {
...
//=====================================================================
inline void SqDensity::DeleteFunction( Super &sup ) {
...
//						Delete Space
//======================================================================================
inline void SqDensity::DeleteSpace( const int &lsys, Parameter &para ) {
