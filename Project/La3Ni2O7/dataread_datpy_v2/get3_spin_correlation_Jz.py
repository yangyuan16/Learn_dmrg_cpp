...
if __name__ == "__main__":
    ...
    L04, = ax1.plot(r_Jz04,corre_Jz04,label="Jz={}".format(0.4),ls="-",lw=1.5,color="r",
             ...
             markerfacecolor='w')
    L05, = ax1.plot(r_Jz05,corre_Jz05,label="Jz={}".format(0.5),ls="-",lw=1.5,color="blue",
             marker='o',alpha=1,markersize=6,markeredgewidth=1.5, markeredgecolor="k",
             markerfacecolor='k')
    ...
    legend1=plt.legend(handles=[L01,L02,L03,L04,L05,L06,L07,L08,L09], loc = 4, bbox_to_anchor=(0.38, 0.18),
