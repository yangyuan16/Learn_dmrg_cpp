...
if __name__ =="__main__":
    ...
    # 得到子图
    ax1 = plt.axes([0.1,0.58,0.35,0.4])
    ax2 = plt.axes([0.55,0.58,0.35,0.4])
    ax3 = plt.axes([0.1,0.1,0.35,0.4])
    ax4 = plt.axes([0.55,0.1,0.35,0.4])
    ...
    #
    plt.savefig("E:\\WORK\\Work\\Project\\La3Ni2O7\\datashow_datpy_poster\\figs\\fig1_p1.eps",
