...
if __name__ =="__main__":
    ...
    ax1 = plt.gca()
    #------------------------
    df_pyy_Jz01 = get_data_pyy(Lz=Lz,Ly=Ly,Lx=48,dop=88,t=t,J=J,Jz=0.1,dim=dim)
    df_pyy_Jz06 = get_data_pyy(Lz=Lz,Ly=Ly,Lx=48,dop=88,t=t,J=J,Jz=0.6,dim=dim)
    df_pyy_Jz10 = get_data_pyy(Lz=Lz,Ly=Ly,Lx=48,dop=88,t=t,J=J,Jz=1.0,dim=dim)
    df_pyy_Jz15 = get_data_pyy(Lz=Lz,Ly=Ly,Lx=48,dop=88,t=t,J=J,Jz=1.5,dim=dim)
    df_pyy_Jz175 = get_data_pyy(Lz=Lz,Ly=Ly,Lx=48,dop=88,t=t,J=J,Jz=1.75,dim=dim)
    df_pyy_Jz20 = get_data_pyy(Lz=Lz,Ly=Ly,Lx=48,dop=88,t=t,J=J,Jz=2.0,dim=dim)
    df_pyy_Jz225 = get_data_pyy(Lz=Lz,Ly=Ly,Lx=48,dop=88,t=t,J=J,Jz=2.25,dim=dim)
    #--------- J_\bot = 0.1
    slope = df_pyy_Jz01["slope_exp"].values[0]
    xi = round(-1/slope,2)  
    label = r"$J_{\bot}$=%.1f $\xi_{SC}^{yy}$=%.2f"%(0.1,xi)
    L01, = ax1.plot(df_pyy_Jz01["r"],df_pyy_Jz01["corre_abs"],label=label,ls="-",lw=1.5,color="red",
             marker='o',alpha=1,markersize=6,markeredgewidth=1, markeredgecolor="red", markerfacecolor='None')
    L01_, = ax1.plot(df_pyy_Jz01["r"],df_pyy_Jz01["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
    ...
    L06, = ax1.plot(df_pyy_Jz06["r"],df_pyy_Jz06["corre_abs"],label=label,ls="-",lw=1.5,color="blue",
             marker='s',alpha=1,markersize=6,markeredgewidth=1, markeredgecolor="blue", markerfacecolor='None')
    L06_, = ax1.plot(df_pyy_Jz06["r"],df_pyy_Jz06["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
    ...
    L10, = ax1.plot(df_pyy_Jz10["r"],df_pyy_Jz10["corre_abs"],label=label,ls="-",lw=1.5,color="green",
    ...
    xi = round(-1/slope,2)  
    label = r"$J_{\bot}$=%.1f $\xi_{SC}^{yy}$=%.2f"%(1.5,xi)
    L15, = ax1.plot(df_pyy_Jz15["r"],df_pyy_Jz15["corre_abs"],label=label,ls="-",lw=1.5,color="magenta",
    ...
    L175, = ax1.plot(df_pyy_Jz175["r"],df_pyy_Jz175["corre_abs"],label=label,ls="-",lw=1.5,color="cyan",
    ...
    L20, = ax1.plot(df_pyy_Jz20["r"],df_pyy_Jz20["corre_abs"],label=label,ls="-",lw=1.5,color="brown",
             marker='>',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="brown", markerfacecolor='None')
    L20_, = ax1.plot(df_pyy_Jz20["r"],df_pyy_Jz20["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
             marker='>',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #-------- J_\bot = 2.25
    slope = df_pyy_Jz225["slope_exp"].values[0]
    xi = round(-1/slope,2)  
    label = r"$J_{\bot}$=%.2f $\xi_{SC}^{yy}$=%.2f"%(2.25,xi)
    L225, = ax1.plot(df_pyy_Jz225["r"],df_pyy_Jz225["corre_abs"],label=label,ls="-",lw=1.5,color="olive",
             marker='h',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="olive", markerfacecolor='None')
    L225_, = ax1.plot(df_pyy_Jz225["r"],df_pyy_Jz225["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
    ...
    #=========================================================
    ax1.text(4,0.005,"(a)",fontsize = 20, color='black', rotation = 0)
    ax1.text(2,1.0e-6, r'$\mathrm{\delta} = 0.4583$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
    ...
    L01, = ax2.plot(df_pyy_Jz01["r"],df_pyy_Jz01["corre_abs"],label=label,ls="-",lw=1.5,color="red",
             marker='o',alpha=1,markersize=6,markeredgewidth=1, markeredgecolor="red", markerfacecolor='None')
    L01_, = ax2.plot(df_pyy_Jz01["r"],df_pyy_Jz01["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #--------- J_\bot = 0.6
    ...
    L10, = ax2.plot(df_pyy_Jz10["r"],df_pyy_Jz10["corre_abs"],label=label,ls="-",lw=1.5,color="green",
             marker='^',alpha=1,markersize=6,markeredgewidth=1, markeredgecolor="green", markerfacecolor='None')
    ...
    L15, = ax2.plot(df_pyy_Jz15["r"],df_pyy_Jz15["corre_abs"],label=label,ls="-",lw=1.5,color="magenta",
             marker='v',alpha=1,markersize=6,markeredgewidth=1, markeredgecolor="magenta", markerfacecolor='None')
    L15_, = ax2.plot(df_pyy_Jz15["r"],df_pyy_Jz15["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='v',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #-------- J_\bot = 1.75
    slope = df_pyy_Jz175["slope_pow"].values[0]
    Kp = round(-slope,2)  
    label = r"$J_{\bot}$=%.2f $K_{SC}^{yy}$=%.2f"%(1.75,Kp)
    L175, = ax2.plot(df_pyy_Jz175["r"],df_pyy_Jz175["corre_abs"],label=label,ls="-",lw=1.5,color="cyan",
             marker='<',alpha=1,markersize=6,markeredgewidth=1, markeredgecolor="cyan", markerfacecolor='None')
    L175_, = ax2.plot(df_pyy_Jz175["r"],df_pyy_Jz175["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='<',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #-------- J_\bot = 2.0
    ...
    L225, = ax2.plot(df_pyy_Jz225["r"],df_pyy_Jz225["corre_abs"],label=label,ls="-",lw=1.5,color="olive",
             marker='h',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="olive", markerfacecolor='None')
    L225_, = ax2.plot(df_pyy_Jz225["r"],df_pyy_Jz225["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='h',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #--------
    ####图例设置
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 12, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L01,L06,], loc = 4, bbox_to_anchor=(0.99, 0.75),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    legend2=plt.legend(handles=[L10,L15,L175,L20,L225], loc = 4, bbox_to_anchor=(0.54, -0.01),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    plt.gca().add_artist(legend1)#####把图例legend1重新加载回来
    label_x = r"r"
    label_y = "$P^{yy}(r)$"
    ...
    #=========================================================
    ax2.text(2.2, 0.015,"(b)",fontsize = 20, color='black', rotation = 0)
    ax2.text(2.2, 1.0e-5, r'$\mathrm{\delta} = 0.4583$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
    ...
    ax3 = plt.gca()
    #------------------------
    df_pzz_Jz01 = get_data_pzz(Lz=Lz,Ly=Ly,Lx=48,dop=88,t=t,J=J,Jz=0.1,dim=dim)
    df_pzz_Jz06 = get_data_pzz(Lz=Lz,Ly=Ly,Lx=48,dop=88,t=t,J=J,Jz=0.6,dim=dim)
    df_pzz_Jz10 = get_data_pzz(Lz=Lz,Ly=Ly,Lx=48,dop=88,t=t,J=J,Jz=1.0,dim=dim)
    df_pzz_Jz15 = get_data_pzz(Lz=Lz,Ly=Ly,Lx=48,dop=88,t=t,J=J,Jz=1.5,dim=dim)
    df_pzz_Jz175 = get_data_pzz(Lz=Lz,Ly=Ly,Lx=48,dop=88,t=t,J=J,Jz=1.75,dim=dim)
    df_pzz_Jz20 = get_data_pzz(Lz=Lz,Ly=Ly,Lx=48,dop=88,t=t,J=J,Jz=2.0,dim=dim)
    df_pzz_Jz225 = get_data_pzz(Lz=Lz,Ly=Ly,Lx=48,dop=88,t=t,J=J,Jz=2.25,dim=dim)
    #--------- J_\bot = 0.1
    slope = df_pzz_Jz01["slope_exp"].values[0]
    xi = round(-1/slope,2)  
    label = r"$J_{\bot}$=%.1f $\xi_{SC}^{zz}$=%.2f"%(0.1,xi)
    L01, = ax3.plot(df_pzz_Jz01["r"],df_pzz_Jz01["corre_abs"],label=label,ls="-",lw=1.5,color="red",
             marker='o',alpha=1,markersize=6,markeredgewidth=1, markeredgecolor="red", markerfacecolor='None')
    L01_, = ax3.plot(df_pzz_Jz01["r"],df_pzz_Jz01["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #--------- J_\bot = 0.6
    ...
    L10, = ax3.plot(df_pzz_Jz10["r"],df_pzz_Jz10["corre_abs"],label=label,ls="-",lw=1.5,color="green",
             marker='^',alpha=1,markersize=6,markeredgewidth=1, markeredgecolor="green", markerfacecolor='None')
    L10_, = ax3.plot(df_pzz_Jz10["r"],df_pzz_Jz10["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
             marker='^',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #--------- J_\bot = 1.5
    slope = df_pzz_Jz15["slope_exp"].values[0]
    xi = round(-1/slope,2)  
    label = r"$J_{\bot}$=%.1f $\xi_{SC}^{zz}$=%.2f"%(1.5,xi)
    L15, = ax3.plot(df_pzz_Jz15["r"],df_pzz_Jz15["corre_abs"],label=label,ls="-",lw=1.5,color="magenta",
             marker='v',alpha=1,markersize=6,markeredgewidth=1, markeredgecolor="magenta", markerfacecolor='None')
    L15_, = ax3.plot(df_pzz_Jz15["r"],df_pzz_Jz15["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
             marker='v',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #-------- J_\bot = 1.75
    slope = df_pzz_Jz175["slope_exp"].values[0]
    xi = round(-1/slope,2)  
    label = r"$J_{\bot}$=%.2f $\xi_{SC}^{zz}$=%.2f"%(1.75,xi)
    L175, = ax3.plot(df_pzz_Jz175["r"],df_pzz_Jz175["corre_abs"],label=label,ls="-",lw=1.5,color="cyan",
             marker='<',alpha=1,markersize=6,markeredgewidth=1, markeredgecolor="cyan", markerfacecolor='None')
    ...
    L20_, = ax3.plot(df_pzz_Jz20["r"],df_pzz_Jz20["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
             marker='>',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #-------- J_\bot = 2.25
    slope = df_pzz_Jz225["slope_exp"].values[0]
    xi = round(-1/slope,2)  
    label = r"$J_{\bot}$=%.2f $\xi_{SC}^{zz}$=%.2f"%(2.25,xi)
    L225, = ax3.plot(df_pzz_Jz225["r"],df_pzz_Jz225["corre_abs"],label=label,ls="-",lw=1.5,color="olive",
             marker='h',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="olive", markerfacecolor='None')
    L225_, = ax3.plot(df_pzz_Jz225["r"],df_pzz_Jz225["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
             marker='h',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #--------
    ####图例设置
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 12, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L01,L06,L10,L15], loc = 4, bbox_to_anchor=(1.01, 0.8),
    ...
    ax3.set_xlim([0,40])
    ax3.set_ylim([1.0e-7,8.0e-2])
    #ax3.set_xticks([0,10,20,30])
    #ax3.set_yticks([-1,-0.5,0,0.5,1])  
    #=========================================================
    ax3.text(35,0.2e-6,"(c)",fontsize = 20, color='black', rotation = 0)
    ax3.text(0.5,1.0e-5, r'$\mathrm{\delta} = 0.4583$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
    ...
    L01, = ax4.plot(df_pzz_Jz01["r"],df_pzz_Jz01["corre_abs"],label=label,ls="-",lw=1.5,color="red",
             marker='o',alpha=1,markersize=6,markeredgewidth=1, markeredgecolor="red", markerfacecolor='None')
    L01_, = ax4.plot(df_pzz_Jz01["r"],df_pzz_Jz01["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #--------- J_\bot = 0.6
    ...
    L10, = ax4.plot(df_pzz_Jz10["r"],df_pzz_Jz10["corre_abs"],label=label,ls="-",lw=1.5,color="green",
             marker='^',alpha=1,markersize=6,markeredgewidth=1, markeredgecolor="green", markerfacecolor='None')
    ...
    L15, = ax4.plot(df_pzz_Jz15["r"],df_pzz_Jz15["corre_abs"],label=label,ls="-",lw=1.5,color="magenta",
             marker='v',alpha=1,markersize=6,markeredgewidth=1, markeredgecolor="magenta", markerfacecolor='None')
    L15_, = ax4.plot(df_pzz_Jz15["r"],df_pzz_Jz15["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='v',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #-------- J_\bot = 1.75
    slope = df_pzz_Jz175["slope_pow"].values[0]
    Kg = round(-slope,2)  
    label = r"$J_{\bot}$=%.2f $K_{SC}^{zz}$=%.2f"%(1.75,Kg)
    L175, = ax4.plot(df_pzz_Jz175["r"],df_pzz_Jz175["corre_abs"],label=label,ls="-",lw=1.5,color="cyan",
             marker='<',alpha=1,markersize=6,markeredgewidth=1, markeredgecolor="cyan", markerfacecolor='None')
    ...
    L225, = ax4.plot(df_pzz_Jz225["r"],df_pzz_Jz225["corre_abs"],label=label,ls="-",lw=1.5,color="olive",
             marker='h',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="olive", markerfacecolor='None')
    L225_, = ax4.plot(df_pzz_Jz225["r"],df_pzz_Jz225["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='h',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #--------
    ####图例设置
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 12, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    ...
    #                   ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    legend2=plt.legend(handles=[L01,L06,L10,L15,L175,L20,L225], loc = 4, bbox_to_anchor=(0.54, -0.045),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #plt.gca().add_artist(legend1)#####把图例legend1重新加载回来
    label_x = r"r"
    label_y = "$P^{zz}(r)$"
    ...
    ax4.set_xlim([0,40])
    ax4.set_ylim([1.0e-7,2.0e-2])
    ax4.set_xticks([5,10,20,30])
    #ax4.set_yticks([-1,-0.5,0,0.5,1])  
    #=========================================================
    ax4.text(28,1.50e-7,"(d)",fontsize = 20, color='black', rotation = 0)
    ax4.text(8,1.0e-2, r'$\mathrm{\delta} = 0.4583$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
    ...
    plt.savefig("E:\\WORK\\Work\\Project\\La3Ni2O7\\datashow_datpy_paper\\figs\\fig_04583_2.eps",
