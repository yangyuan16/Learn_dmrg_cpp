...
if __name__ =="__main__":
    ...
    legend1=plt.legend(handles=[L025,L05,L075,L10,L125,L15,L175], loc = 4, bbox_to_anchor=(0.98, 0.32),
    ...
    #=========================================================
    ax1.text(36,3e-5,"(a)",fontsize = 20, color='black', rotation = 0)
    ax1.text(17.5,3e-5, r'$\mathrm{\delta} = \frac{1}{2}$', fontsize = 20, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
