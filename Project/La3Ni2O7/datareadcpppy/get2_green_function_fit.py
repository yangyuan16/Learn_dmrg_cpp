...
if __name__ == "__main__":
    ...
    print(len(df))
    #================选定某些数据点=============================
    df_cut_exp = df.loc[[3,9,14,19,22,25]] # for exponential fit 
    df_cut_pow = df.loc[[3,9,14,19,22,25]] # for power law fit
    ...
    Issave = True
    if Issave:
        filepath4 = "\\measurement_green_function_ref74_fit.parquet"
