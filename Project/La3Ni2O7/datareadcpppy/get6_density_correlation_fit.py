...
if __name__ == "__main__":
    ...
    print(len(df))
    #================选定某些数据点==========================
    df_cut_exp = df.loc[[0,2,4,6,8,10,12]] # for exponential fit 
    df_cut_pow = df.loc[[0,2,4,6,8,10,12]] # for power law fit
    #df_cut = df
    ...
    Issave = True 
    if Issave:
        filepath4 = "\\measurement_density_correlation_ref%d_fit.parquet" % (rs)
