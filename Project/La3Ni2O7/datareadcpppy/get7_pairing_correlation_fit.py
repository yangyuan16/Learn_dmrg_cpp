...
if __name__ == "__main__":
    ...
    print(len(df))
    #================选定某些数据点==========================
    df_cut_exp = df.loc[[1,3,5,7,9,11,13]] # exponential fit
    df_cut_pow = df.loc[[1,3,5,7,9,11,13]] # power law fit
    ...
    Issave = True
    if Issave:
        filepath4 = "\\measurement_pairing_" +bonds+"_ref%d_fit.parquet" % (rs)
