...
if __name__ == "__main__":
    ...
    L10, = ax1.plot(r_Jz10,corre_Jz10,label="Jz={}".format(1.0),ls="-",lw=1.5,color="r",
             ...
             markerfacecolor='w')
    L125, = ax1.plot(r_Jz125,corre_Jz125,label="Jz={}".format(1.25),ls="-",lw=1.5,color="r",
             marker='s',alpha=1,markersize=6,markeredgewidth=1.5, markeredgecolor="k",
             markerfacecolor='w')    
    ...
    L225, = ax1.plot(r_Jz225,corre_Jz225,label="Jz={}".format(2.25),ls="-",lw=1.5,color="blue",
             marker='s',alpha=1,markersize=6,markeredgewidth=1.5, markeredgecolor="k",
             markerfacecolor='k')
    L25, = ax1.plot(r_Jz25,corre_Jz25,label="Jz={}".format(2.5),ls="-",lw=1.5,color="blue",
             marker='h',alpha=1,markersize=6,markeredgewidth=1.5, markeredgecolor="k",
             markerfacecolor='k')
    L275, = ax1.plot(r_Jz275,corre_Jz275,label="Jz={}".format(2.75),ls="-",lw=1.5,color="green",
             marker='h',alpha=1,markersize=6,markeredgewidth=1.5, markeredgecolor="k",
             markerfacecolor='k')
    '''
    ...
    legend1=plt.legend(handles=[L01, L02,L04,L06,L08,L10,L20,L30,], loc = 4, bbox_to_anchor=(0.38, 0.0),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    
    label_x = r"|i-j|"
    label_y = "YY pairing correlation"
    plt.yscale("log")
    plt.xscale("log")      
    ...
    plt.title("YY pairing, dim=%d"%dim, fontsize=25)
    plt.show()