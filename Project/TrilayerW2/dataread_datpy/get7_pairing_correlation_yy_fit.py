...
def plot_corre_sign(df):
    ...
    plt.title("Sign of YY Pairing, Jz=%.2f"%Jz, fontsize=25)
    plt.show()
    return
#
if __name__ == "__main__":
    ...
    print(len(df))
    #================选定某些数据点==========================
    df_cut_exp = df.loc[[4,7,10,13,16,19,22,25,28]] # exponential fit
    df_cut_pow = df.loc[[0,4,7,10,13,16,19,22,25,28]] # power law fit
    ...
    Issave = True
    if Issave:
        filepath4 = "\\measurement_pairing_yy_fit.parquet" 
