...
def plot_corre_sign(df):
    ...
    plt.title("Up-layer:Sign of Green Fun. Jz=%.2f"%Jz, fontsize=25)
    plt.show()
    return
#
if __name__ == "__main__":
    ...
    filepath3 = "\\measurement_green_function_s1.dat"
    ...
    print(len(df))
    #================选定某些数据点=============================
    df_cut_exp = df.loc[[2,9,16,20,23,27]] # for exponential fit 
    df_cut_pow = df.loc[[0,5,9,16,20]] # for power law fit
    ...
    Issave = True
    if Issave:
        filepath4 = "\\measurement_green_function_s1_fit.parquet"
