...
def plot_corre_sign(df):
    ...
    plt.title("Sign of Green Fun. Jz=%.2f"%Jz, fontsize=25)
    plt.show()
    return
#
if __name__ == "__main__":
    ...
    print(len(df))
    #================选定某些数据点=============================
    df_cut_exp = df.loc[[7,10,13,17,21,25,26]] # for exponential fit 
    df_cut_pow = df.loc[[0,7,10,13,17,21,25]] # for power law fit
