...
def plot_corre_sign(df):
    ...
    plt.title("Sign of Density Corre. Jz=%.2f"%Jz, fontsize=25)
    plt.show()
    return
#
if __name__ == "__main__":
    ...
    print(len(df))
    #================选定某些数据点==========================
    df_cut_exp = df.loc[[5,10,12,14,16,18,20]] # for exponential fit 
    df_cut_pow = df.loc[[0,3,8,12,15]] # for power law fit
    #df_cut = df
