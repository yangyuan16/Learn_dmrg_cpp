...
if __name__ =="__main__":
    ...
    L90_Gmu1mu2_12000, = ax1.plot(df_cicj_Jz90_mu1_12000["r"],df_cicj_Jz90_mu1_12000["corre_abs"]*df_cicj_Jz90_mu2_12000["corre_abs"],
    ...
    L90_Gmu2mu3_12000, = ax1.plot(df_cicj_Jz90_mu2_12000["r"],df_cicj_Jz90_mu2_12000["corre_abs"]*df_cicj_Jz90_mu3_12000["corre_abs"],
    ...
    legend1=plt.legend(handles=[L90_pzzmu12_12000,L90_pzzmu23_12000,L90_Gmu1mu2_12000,L90_Gmu2mu3_12000,], 
    ...
    #Ks = round(-slope,2)
    label = r"$G(r)^{\mu=1}G(r)^{\mu=2}$"
    L120_Gmu1mu2_12000, = ax2.plot(df_cicj_Jz120_mu1_12000["r"],df_cicj_Jz120_mu1_12000["corre_abs"]*df_cicj_Jz120_mu2_12000["corre_abs"],
                                   label=label,ls="-",lw=1.5,color="blue", marker='^',alpha=1,markersize=8,markeredgewidth=1, 
                                   markeredgecolor="blue", markerfacecolor='None')
    #----------------- plot G(r)^{\mu=2} * G(r)^{\mu=3} -------------------------------------------------------------------
    ...
    #Ks = round(-slope,2)
    label = r"$G(r)^{\mu=2}G(r)^{\mu=3}$"
    L120_Gmu2mu3_12000, = ax2.plot(df_cicj_Jz120_mu2_12000["r"],df_cicj_Jz120_mu2_12000["corre_abs"]*df_cicj_Jz120_mu3_12000["corre_abs"],
                                   label=label,ls="-",lw=1.5,color="green", marker='v',alpha=1,markersize=8,markeredgewidth=1, 
                                   markeredgecolor="green", markerfacecolor='None')
    #---------------------------------------------------------------------------------------------------------------------
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 14, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L120_pzzmu12_12000,L120_pzzmu23_12000,L120_Gmu1mu2_12000,L120_Gmu2mu3_12000,], 
                       loc = 4, bbox_to_anchor=(0.55, -0.05),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #legend2=plt.legend(handles=[], loc = 4, bbox_to_anchor=(0.65, -0.04),
    #                   ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    ...
    #Ks = round(-slope,2)
    label = r"$G(r)^{\mu=1}G(r)^{\mu=2}$"
    L150_Gmu1mu2_12000, = ax3.plot(df_cicj_Jz150_mu1_12000["r"],df_cicj_Jz150_mu1_12000["corre_abs"]*df_cicj_Jz150_mu2_12000["corre_abs"],
                                   label=label,ls="-",lw=1.5,color="blue", marker='^',alpha=1,markersize=8,markeredgewidth=1, 
                                   markeredgecolor="blue", markerfacecolor='None')
    #----------------- plot G(r)^{\mu=2} * G(r)^{\mu=3} -------------------------------------------------------------------
    #slope = df_cicj_Jz120_mu2_12000['slope_pow'].values[0]
    #Ks = round(-slope,2)
    label = r"$G(r)^{\mu=2}G(r)^{\mu=3}$"
    L150_Gmu2mu3_12000, = ax3.plot(df_cicj_Jz150_mu2_12000["r"],df_cicj_Jz150_mu2_12000["corre_abs"]*df_cicj_Jz150_mu3_12000["corre_abs"],
                                   label=label,ls="-",lw=1.5,color="green", marker='v',alpha=1,markersize=8,markeredgewidth=1, 
                                   markeredgecolor="green", markerfacecolor='None')
    #---------------------------------------------------------------------------------------------------------------------
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 14, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L150_pzzmu12_12000,L150_pzzmu23_12000,L150_Gmu1mu2_12000,L150_Gmu2mu3_12000,], 
                       loc = 4, bbox_to_anchor=(0.55, -0.05),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #legend2=plt.legend(handles=[], loc = 4, bbox_to_anchor=(0.65, -0.04),
    #                   ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    ...
    #Ks = round(-slope,2)
    label = r"$G(r)^{\mu=1}G(r)^{\mu=2}$"
    L180_Gmu1mu2_12000, = ax4.plot(df_cicj_Jz180_mu1_12000["r"],df_cicj_Jz180_mu1_12000["corre_abs"]*df_cicj_Jz180_mu2_12000["corre_abs"],
                                   label=label,ls="-",lw=1.5,color="blue", marker='^',alpha=1,markersize=8,markeredgewidth=1, 
                                   markeredgecolor="blue", markerfacecolor='None')
    #----------------- plot G(r)^{\mu=2} * G(r)^{\mu=3} -------------------------------------------------------------------
    #slope = df_cicj_Jz180_mu2_12000['slope_pow'].values[0]
    #Ks = round(-slope,2)
    label = r"$G(r)^{\mu=2}G(r)^{\mu=3}$"
    L180_Gmu2mu3_12000, = ax4.plot(df_cicj_Jz180_mu2_12000["r"],df_cicj_Jz180_mu2_12000["corre_abs"]*df_cicj_Jz180_mu3_12000["corre_abs"],
                                   label=label,ls="-",lw=1.5,color="green", marker='v',alpha=1,markersize=8,markeredgewidth=1, 
                                   markeredgecolor="green", markerfacecolor='None')
    #---------------------------------------------------------------------------------------------------------------------
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 14, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L180_pzzmu12_12000,L180_pzzmu23_12000,L180_Gmu1mu2_12000,L180_Gmu2mu3_12000,], 
                       loc = 4, bbox_to_anchor=(0.55, -0.05),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #legend2=plt.legend(handles=[], loc = 4, bbox_to_anchor=(0.65, -0.04),
    #                   ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
