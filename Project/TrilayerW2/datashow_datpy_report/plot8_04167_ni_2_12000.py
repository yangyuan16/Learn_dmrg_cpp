...
if __name__ =="__main__":
    ...
    ax1 = plt.gca()
    df_ni_Jz90 = get_data_ni(Lz=Lz,Ly=Ly,Lx=Lx,dop=120,t=t,J=J,Jz=9.0,dim=12000)
    #
    ...
    ax1.text(30,0.60, r'D=12000', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=======================================================================================
    # 坐标轴设置第一层
    ...
    ax2 = plt.gca()
    df_ni_Jz120 = get_data_ni(Lz=Lz,Ly=Ly,Lx=Lx,dop=120,t=t,J=J,Jz=12.0,dim=12000)
    #
    ...
    ax2.text(30,0.59, r'D=12000', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=======================================================================================
    # 坐标轴设置第一层
    ...
    ax3 = plt.gca()
    df_ni_Jz150 = get_data_ni(Lz=Lz,Ly=Ly,Lx=Lx,dop=120,t=t,J=J,Jz=15.0,dim=12000)
    #
    ...
    ax3.text(30,0.59, r'D=12000', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=======================================================================================
    # 坐标轴设置第一层
    ...
    ax4 = plt.gca()
    df_ni_Jz180 = get_data_ni(Lz=Lz,Ly=Ly,Lx=Lx,dop=120,t=t,J=J,Jz=18.0,dim=12000)
    #
    ...
    ax4.text(30,0.58, r'D=12000', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=======================================================================================
    # 坐标轴设置第一层
