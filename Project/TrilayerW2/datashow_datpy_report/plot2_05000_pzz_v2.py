...
if __name__ =="__main__":
    ...
    ax1 = plt.gca()
    #
    df_pzz_Jz10_mu12 = get_data_pzz_layer12(Lz=Lz,Ly=Ly,Lx=Lx,dop=144,t=t,J=J,Jz=1.0,dim=6000)
    df_pzz_Jz10_mu23 = get_data_pzz_layer23(Lz=Lz,Ly=Ly,Lx=Lx,dop=144,t=t,J=J,Jz=1.0,dim=6000)
    df_pzz_Jz10_mu13 = get_data_pzz_layer13(Lz=Lz,Ly=Ly,Lx=Lx,dop=144,t=t,J=J,Jz=1.0,dim=6000)
    #--------- layer 12
    ...
    legend1=plt.legend(handles=[L10_mu12,L10_mu23,], loc = 4, bbox_to_anchor=(0.35, 0.18),
    ...
    ax1.text(3.5,0.005, r'$\mathrm{\delta} = 0.5$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax1.text(8,0.005, r'$J_{\bot}=1.0$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ...
    ax2 = plt.gca()
    #
    df_pzz_Jz40_mu12 = get_data_pzz_layer12(Lz=Lz,Ly=Ly,Lx=Lx,dop=144,t=t,J=J,Jz=4.0,dim=6000)
    df_pzz_Jz40_mu23 = get_data_pzz_layer23(Lz=Lz,Ly=Ly,Lx=Lx,dop=144,t=t,J=J,Jz=4.0,dim=6000)
    df_pzz_Jz40_mu13 = get_data_pzz_layer13(Lz=Lz,Ly=Ly,Lx=Lx,dop=144,t=t,J=J,Jz=4.0,dim=6000)
    #--------- layer 12
    ...
    # 
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 14, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L40_mu12,L40_mu23,], loc = 4, bbox_to_anchor=(0.35, 0.18),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #legend2=plt.legend(handles=[], loc = 4, bbox_to_anchor=(0.65, -0.04),
    #                   ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #plt.gca().add_artist(legend1)
    ...
    ax2.text(3.8,0.02, r'$\mathrm{\delta} = 0.5$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax2.text(8,0.02, r'$J_{\bot}=4.0$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ...
    ax3 = plt.gca()
    #
    df_pzz_Jz80_mu12 = get_data_pzz_layer12(Lz=Lz,Ly=Ly,Lx=Lx,dop=144,t=t,J=J,Jz=8.0,dim=16000)
    df_pzz_Jz80_mu23 = get_data_pzz_layer23(Lz=Lz,Ly=Ly,Lx=Lx,dop=144,t=t,J=J,Jz=8.0,dim=16000)
    df_pzz_Jz80_mu13 = get_data_pzz_layer13(Lz=Lz,Ly=Ly,Lx=Lx,dop=144,t=t,J=J,Jz=8.0,dim=16000)
    #--------- layer 12
    ...
    # 
    #legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 14, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L80_mu12,L80_mu23,], loc = 4, bbox_to_anchor=(0.35, 0.18),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #legend2=plt.legend(handles=[], loc = 4, bbox_to_anchor=(0.65, -0.04),
    #                   ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #plt.gca().add_artist(legend1)
    ...
    ax3.text(3.8,0.05, r'$\mathrm{\delta} = 0.5$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax3.text(8,0.05, r'$J_{\bot}=8.0$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax3.text(8,0.008, r'$D=16000$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
    ...
    ax4 = plt.gca()
    #
    df_pzz_Jz120_mu12 = get_data_pzz_layer12(Lz=Lz,Ly=Ly,Lx=Lx,dop=144,t=t,J=J,Jz=10.0,dim=8000)
    df_pzz_Jz120_mu23 = get_data_pzz_layer23(Lz=Lz,Ly=Ly,Lx=Lx,dop=144,t=t,J=J,Jz=10.0,dim=8000)
    df_pzz_Jz120_mu13 = get_data_pzz_layer13(Lz=Lz,Ly=Ly,Lx=Lx,dop=144,t=t,J=J,Jz=10.0,dim=8000)
    #--------- layer 12
    ...
    # 
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 14, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L120_mu12,L120_mu23], loc = 4, bbox_to_anchor=(0.35, 0.18),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #legend2=plt.legend(handles=[], loc = 4, bbox_to_anchor=(0.65, -0.04),
    #                   ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #plt.gca().add_artist(legend1)
    ...
    ax4.text(3.8,0.05, r'$\mathrm{\delta} = 0.5$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax4.text(8,0.05, r'$J_{\bot}=10.0$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ...
    ax5 = plt.gca()
    #
    df_pzz_Jz240_mu12 = get_data_pzz_layer12(Lz=Lz,Ly=Ly,Lx=Lx,dop=144,t=t,J=J,Jz=12.0,dim=14000)
    df_pzz_Jz240_mu23 = get_data_pzz_layer23(Lz=Lz,Ly=Ly,Lx=Lx,dop=144,t=t,J=J,Jz=12.0,dim=14000)
    df_pzz_Jz240_mu13 = get_data_pzz_layer13(Lz=Lz,Ly=Ly,Lx=Lx,dop=144,t=t,J=J,Jz=12.0,dim=14000)
    #--------- layer 12
    ...
    # 
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 14, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L240_mu12,L240_mu23,], loc = 4, bbox_to_anchor=(0.35, 0.18),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #legend2=plt.legend(handles=[], loc = 4, bbox_to_anchor=(0.65, -0.04),
    #                   ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #plt.gca().add_artist(legend1)
    ...
    ax5.text(3.5,0.05, r'$\mathrm{\delta} = 0.5$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax5.text(8,0.05, r'$J_{\bot}=12.0$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax5.text(8,0.012, r'$D=14000$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
    ...
    ax6 = plt.gca()
    #
    df_pzz_Jz480_mu12 = get_data_pzz_layer12(Lz=Lz,Ly=Ly,Lx=Lx,dop=144,t=t,J=J,Jz=24.0,dim=6000)
    df_pzz_Jz480_mu23 = get_data_pzz_layer23(Lz=Lz,Ly=Ly,Lx=Lx,dop=144,t=t,J=J,Jz=24.0,dim=6000)
    df_pzz_Jz480_mu13 = get_data_pzz_layer13(Lz=Lz,Ly=Ly,Lx=Lx,dop=144,t=t,J=J,Jz=24.0,dim=6000)
    #--------- layer 12
    ...
    # 
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 14, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L480_mu12,L480_mu23,], loc = 4, bbox_to_anchor=(0.35, 0.18),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #legend2=plt.legend(handles=[], loc = 4, bbox_to_anchor=(0.65, -0.04),
    #                   ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #plt.gca().add_artist(legend1)
    ...
    ax6.text(2.5,0.08, r'$\mathrm{\delta} = 0.5$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax6.text(5,0.08, r'$J_{\bot}=24.0$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax6.text(5,0.04, r'$D=6000$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
    ...
    #plt.savefig("E:\\WORK\\Work\\Project\\TrilayerW2-tj-Jz-openz\\datashow_datpy_report\\figs\\fig_05000_pzz_v2.eps",
