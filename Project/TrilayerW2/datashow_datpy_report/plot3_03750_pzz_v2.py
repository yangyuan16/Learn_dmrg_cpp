...
if __name__ =="__main__":
    ...
    ax1 = plt.gca()
    #
    df_pzz_Jz10_mu12 = get_data_pzz_layer12(Lz=Lz,Ly=Ly,Lx=Lx,dop=108,t=t,J=J,Jz=0.5,dim=12000)
    df_pzz_Jz10_mu23 = get_data_pzz_layer23(Lz=Lz,Ly=Ly,Lx=Lx,dop=108,t=t,J=J,Jz=0.5,dim=12000)
    df_pzz_Jz10_mu13 = get_data_pzz_layer13(Lz=Lz,Ly=Ly,Lx=Lx,dop=108,t=t,J=J,Jz=0.5,dim=12000)
    #--------- layer 12
    ...
    ax1.text(3,0.007, r'$\mathrm{\delta} = 0.3750$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax1.text(8,0.007, r'$J_{\bot}=0.50$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax1.text(8,0.001, r'$D=12000$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
    ...
    ax2 = plt.gca()
    #
    df_pzz_Jz40_mu12 = get_data_pzz_layer12(Lz=Lz,Ly=Ly,Lx=Lx,dop=108,t=t,J=J,Jz=4.0,dim=12000)
    df_pzz_Jz40_mu23 = get_data_pzz_layer23(Lz=Lz,Ly=Ly,Lx=Lx,dop=108,t=t,J=J,Jz=4.0,dim=12000)
    df_pzz_Jz40_mu13 = get_data_pzz_layer13(Lz=Lz,Ly=Ly,Lx=Lx,dop=108,t=t,J=J,Jz=4.0,dim=12000)
    #--------- layer 12
    ...
    ax2.text(3,0.04, r'$\mathrm{\delta} = 0.3750$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax2.text(8,0.04, r'$J_{\bot}=4.0$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ...
    ax3 = plt.gca()
    #
    df_pzz_Jz80_mu12 = get_data_pzz_layer12(Lz=Lz,Ly=Ly,Lx=Lx,dop=108,t=t,J=J,Jz=8.0,dim=12000)
    df_pzz_Jz80_mu23 = get_data_pzz_layer23(Lz=Lz,Ly=Ly,Lx=Lx,dop=108,t=t,J=J,Jz=8.0,dim=12000)
    df_pzz_Jz80_mu13 = get_data_pzz_layer13(Lz=Lz,Ly=Ly,Lx=Lx,dop=108,t=t,J=J,Jz=8.0,dim=12000)
    #--------- layer 12
    ...
    ax3.text(3,0.035, r'$\mathrm{\delta} = 0.375$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax3.text(8,0.035, r'$J_{\bot}=8.0$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax3.text(8,0.008, r'$D=12000$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
    ...
    ax4 = plt.gca()
    #
    df_pzz_Jz120_mu12 = get_data_pzz_layer12(Lz=Lz,Ly=Ly,Lx=Lx,dop=108,t=t,J=J,Jz=12.0,dim=14000)
    df_pzz_Jz120_mu23 = get_data_pzz_layer23(Lz=Lz,Ly=Ly,Lx=Lx,dop=108,t=t,J=J,Jz=12.0,dim=14000)
    df_pzz_Jz120_mu13 = get_data_pzz_layer13(Lz=Lz,Ly=Ly,Lx=Lx,dop=108,t=t,J=J,Jz=12.0,dim=14000)
    #--------- layer 12
    ...
    ax4.text(3,0.05, r'$\mathrm{\delta} = 0.3750$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ...
    ax5 = plt.gca()
    #
    df_pzz_Jz240_mu12 = get_data_pzz_layer12(Lz=Lz,Ly=Ly,Lx=Lx,dop=108,t=t,J=J,Jz=24.0,dim=6000)
    df_pzz_Jz240_mu23 = get_data_pzz_layer23(Lz=Lz,Ly=Ly,Lx=Lx,dop=108,t=t,J=J,Jz=24.0,dim=6000)
    df_pzz_Jz240_mu13 = get_data_pzz_layer13(Lz=Lz,Ly=Ly,Lx=Lx,dop=108,t=t,J=J,Jz=24.0,dim=6000)
    #--------- layer 12
    ...
    #
    #=========================================================
    ax5.text(25,0.2,"(e)",fontsize = 20, color='black', rotation = 0)
    ax5.text(3,0.2, r'$\mathrm{\delta} = 0.3750$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax5.text(8,0.2, r'$J_{\bot}=24.0$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax5.text(8,0.02, r'$D=6000$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
    ...
    #plt.savefig("E:\\WORK\\Work\\Project\\TrilayerW2-tj-Jz-openz\\datashow_datpy_report\\figs\\fig_03750_pzz.eps",
