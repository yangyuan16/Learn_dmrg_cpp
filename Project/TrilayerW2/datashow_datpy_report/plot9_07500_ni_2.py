...
if __name__ =="__main__":
    ...
    #
    L, =ax2.plot([0,50],[0.25,0.25],label=" ",ls="--",lw=1.5,color="k",
    ...
    #=========================================================
    ax2.text(4,0.16,"(b)",fontsize = 20, color='black', rotation = 0)
    ax2.text(10,0.18, r'$\mathrm{J_{\bot}} = 12.0$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax2.text(25,0.18, r'$\mathrm{\delta} = \frac{3}{4}$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax2.text(10,0.17, r'D=10000', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=======================================================================================
    # 坐标轴设置第一层
    ...
    #
    L, =ax6.plot([0,50],[0.25,0.25],label=" ",ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=1.5, markeredgecolor="red", markerfacecolor='None')
    ...
    #=========================================================
    ax6.text(4,0.11,"(f)",fontsize = 20, color='black', rotation = 0)
    ax6.text(10,0.17, r'$\mathrm{J_{\bot}} = 24.0$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax6.text(25,0.17, r'$\mathrm{\delta} = \frac{3}{4}$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax6.text(10,0.14, r'D=6000', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=======================================================================================
    # 坐标轴设置第一层
