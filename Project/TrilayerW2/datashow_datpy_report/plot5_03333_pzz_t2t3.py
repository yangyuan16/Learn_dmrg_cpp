...
if __name__ =="__main__":
    ...
    Ks = round(-slope,2) 
    label = r"t=3,J=1, $K_{P_{zz}}^{1,2}$=%.2f"%(Ks)
    ...
    Ks = round(-slope,2) 
    label = r"t=2,J=1, $K_{P_{zz}}^{1,2}$=%.2f"%(Ks)
    L120t2_pzzmu12_6000, = ax1.plot(df_pzz_t2Jz120_mu12_6000["r"],df_pzz_t2Jz120_mu12_6000["corre_abs"],label=label,ls="-",lw=1.5,color="blue",
             marker='o',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="blue", markerfacecolor='None')
    L120t2_pzzmu12_6000_, = ax1.plot(df_pzz_t2Jz120_mu12_6000["r"],df_pzz_t2Jz120_mu12_6000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #--------------------------------------------------------------------------------------------------------
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 14, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L120_pzzmu12_6000,L120t2_pzzmu12_6000], loc = 4, bbox_to_anchor=(0.55, -0.05),
    ...
    ax1.text(4,0.01, r'$\mathrm{\delta} = \frac{1}{3}$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax1.text(7,0.01, r'D=6000', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax1.text(14,0.01, r'$J_{\bot}=12$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
    ...
    Ks = round(-slope,2) 
    label = r"t=2,J=1, $K_{P_{zz}}^{1,2}$=%.2f"%(Ks)
    L80t2_pzzmu12_6000, = ax2.plot(df_pzz_t2Jz80_mu12_6000["r"],df_pzz_t2Jz80_mu12_6000["corre_abs"],label=label,ls="-",lw=1.5,color="blue",
             marker='o',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="blue", markerfacecolor='None')
    L80t2_pzzmu12_6000_, = ax2.plot(df_pzz_t2Jz80_mu12_6000["r"],df_pzz_t2Jz80_mu12_6000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #--------------------------------------------------------------------------------------------------------
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 14, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L80_pzzmu12_6000,L80t2_pzzmu12_6000], loc = 4, bbox_to_anchor=(0.55, -0.05),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #legend2=plt.legend(handles=[], loc = 4, bbox_to_anchor=(0.65, -0.04),
    #                   ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #plt.gca().add_artist(legend1)
    ...
    #=========================================================
    ax2.text(25,0.01,"(b)",fontsize = 20, color='black', rotation = 0)
    ax2.text(4,0.01, r'$\mathrm{\delta} = \frac{1}{3}$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax2.text(7,0.01, r'D=6000', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax2.text(14,0.01, r'$J_{\bot}=8$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
    ...
    Ks = round(-slope,2) 
    label = r"t=2,J=1, $K_{P_{zz}}^{1,2}$=%.2f"%(Ks)
    L40t2_pzzmu12_6000, = ax3.plot(df_pzz_t2Jz40_mu12_6000["r"],df_pzz_t2Jz40_mu12_6000["corre_abs"],label=label,ls="-",lw=1.5,color="blue",
             marker='o',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="blue", markerfacecolor='None')
    L40t2_pzzmu12_6000_, = ax3.plot(df_pzz_t2Jz40_mu12_6000["r"],df_pzz_t2Jz40_mu12_6000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #--------------------------------------------------------------------------------------------------------
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 14, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L40_pzzmu12_6000,L40t2_pzzmu12_6000], loc = 4, bbox_to_anchor=(0.55, -0.05),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #legend2=plt.legend(handles=[], loc = 4, bbox_to_anchor=(0.65, -0.04),
    #                   ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #plt.gca().add_artist(legend1)
    ...
    ax3.text(4,0.01, r'$\mathrm{\delta} = \frac{1}{3}$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax3.text(7,0.01, r'D=6000', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax3.text(14,0.01, r'$J_{\bot}=4$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
    ...
    Ks = round(-slope,2) 
    label = r"t=3,J=1, $K_{P_{zz}}^{2,3}$=%.2f"%(Ks)
    L120_pzzmu23_6000, = ax4.plot(df_pzz_Jz120_mu23_6000["r"],df_pzz_Jz120_mu23_6000["corre_abs"],label=label,ls="-",lw=1.5,color="red",
             marker='o',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="red", markerfacecolor='None')
    L120_pzzmu23_6000_, = ax4.plot(df_pzz_Jz120_mu23_6000["r"],df_pzz_Jz120_mu23_6000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #----------------- plot pzz^{12} t=2 -----------------------------------------------------------------------
    slope = df_pzz_t2Jz120_mu23_6000["slope_pow"].values[0]
    Ks = round(-slope,2) 
    label = r"t=2,J=1, $K_{P_{zz}}^{2,3}$=%.2f"%(Ks)
    L120t2_pzzmu23_6000, = ax4.plot(df_pzz_t2Jz120_mu23_6000["r"],df_pzz_t2Jz120_mu23_6000["corre_abs"],label=label,ls="-",lw=1.5,color="blue",
             marker='o',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="blue", markerfacecolor='None')
    ...
    #--------------------------------------------------------------------------------------------------------
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 14, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L120_pzzmu23_6000,L120t2_pzzmu23_6000], loc = 4, bbox_to_anchor=(0.55, -0.05),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #legend2=plt.legend(handles=[], loc = 4, bbox_to_anchor=(0.65, -0.04),
    #                   ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #plt.gca().add_artist(legend1)
    ...
    #=========================================================
    ax4.text(25,0.01,"(d)",fontsize = 20, color='black', rotation = 0)
    ax4.text(4,0.01, r'$\mathrm{\delta} = \frac{1}{3}$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax4.text(7,0.01, r'D=6000', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax4.text(12,0.01, r'$J_{\bot}=12$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
    ...
    Ks = round(-slope,2) 
    label = r"t=3,J=1, $K_{P_{zz}}^{2,3}$=%.2f"%(Ks)
    L80_pzzmu23_6000, = ax5.plot(df_pzz_Jz80_mu23_6000["r"],df_pzz_Jz80_mu23_6000["corre_abs"],label=label,ls="-",lw=1.5,color="red",
             marker='o',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="red", markerfacecolor='None')
    L80_pzzmu23_6000_, = ax5.plot(df_pzz_Jz80_mu23_6000["r"],df_pzz_Jz80_mu23_6000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #----------------- plot pzz^{12} t=2 -----------------------------------------------------------------------
    slope = df_pzz_t2Jz80_mu23_6000["slope_pow"].values[0]
    Ks = round(-slope,2) 
    label = r"t=2,J=1, $K_{P_{zz}}^{2,3}$=%.2f"%(Ks)
    L80t2_pzzmu23_6000, = ax5.plot(df_pzz_t2Jz80_mu23_6000["r"],df_pzz_t2Jz80_mu23_6000["corre_abs"],label=label,ls="-",lw=1.5,color="blue",
             marker='o',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="blue", markerfacecolor='None')
    ...
    #--------------------------------------------------------------------------------------------------------
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 14, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L80_pzzmu23_6000,L80t2_pzzmu23_6000], loc = 4, bbox_to_anchor=(0.55, -0.05),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #legend2=plt.legend(handles=[], loc = 4, bbox_to_anchor=(0.65, -0.04),
    #                   ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #plt.gca().add_artist(legend1)
    ...
    #=========================================================
    ax5.text(25,0.01,"(e)",fontsize = 20, color='black', rotation = 0)
    ax5.text(4,0.01, r'$\mathrm{\delta} = \frac{1}{3}$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax5.text(7,0.01, r'D=6000', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax5.text(12,0.01, r'$J_{\bot}=8$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
    ...
    Ks = round(-slope,2) 
    label = r"t=3,J=1, $K_{P_{zz}}^{2,3}$=%.2f"%(Ks)
    L40_pzzmu23_6000, = ax6.plot(df_pzz_Jz40_mu23_6000["r"],df_pzz_Jz40_mu23_6000["corre_abs"],label=label,ls="-",lw=1.5,color="red",
             marker='o',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="red", markerfacecolor='None')
    L40_pzzmu23_6000_, = ax6.plot(df_pzz_Jz40_mu23_6000["r"],df_pzz_Jz40_mu23_6000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #----------------- plot pzz^{12} t=2 -----------------------------------------------------------------------
    slope = df_pzz_t2Jz40_mu23_6000["slope_pow"].values[0]
    Ks = round(-slope,2) 
    label = r"t=2,J=1, $K_{P_{zz}}^{2,3}$=%.2f"%(Ks)
    L40t2_pzzmu23_6000, = ax6.plot(df_pzz_t2Jz40_mu23_6000["r"],df_pzz_t2Jz40_mu23_6000["corre_abs"],label=label,ls="-",lw=1.5,color="blue",
             marker='o',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="blue", markerfacecolor='None')
    ...
    #--------------------------------------------------------------------------------------------------------
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 14, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L40_pzzmu23_6000,L40t2_pzzmu23_6000], loc = 4, bbox_to_anchor=(0.55, -0.05),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #legend2=plt.legend(handles=[], loc = 4, bbox_to_anchor=(0.65, -0.04),
    #                   ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #plt.gca().add_artist(legend1)
    ...
    ax6.text(4,0.01, r'$\mathrm{\delta} = \frac{1}{3}$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax6.text(7,0.01, r'D=6000', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax6.text(12,0.01, r'$J_{\bot}=4$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
