...
if __name__ =="__main__":
    ...
    #=========================================================
    ax2.text(4,0.26,"(b)",fontsize = 20, color='black', rotation = 0)
    ax2.text(10,0.28, r'$\mathrm{J_{\bot}} = 12.0$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax2.text(25,0.28, r'$\mathrm{\delta} = \frac{2}{3}$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax2.text(10,0.27, r'D=10000', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=======================================================================================
    # 坐标轴设置第一层
    ...
    #=========================================================
    ax4.text(3,0.16,"(d)",fontsize = 20, color='black', rotation = 0)
    ax4.text(10,0.20, r'$\mathrm{J_{\bot}} = 18.0$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax4.text(25,0.20, r'$\mathrm{\delta} = \frac{2}{3}$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax4.text(10,0.16, r'D=10000', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=======================================================================================
    # 坐标轴设置第一层
    ...
    #=========================================================
    ax6.text(4,0.125,"(f)",fontsize = 20, color='black', rotation = 0)
    ax6.text(10,0.20, r'$\mathrm{J_{\bot}} = 24.0$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax6.text(25,0.20, r'$\mathrm{\delta} = \frac{2}{3}$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax6.text(10,0.16, r'D=10000', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=======================================================================================
    # 坐标轴设置第一层
