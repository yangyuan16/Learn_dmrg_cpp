...
if __name__ =="__main__":
    ...
    ax1 = plt.gca()
    df_ni_Jz10 = get_data_ni(Lz=Lz,Ly=Ly,Lx=Lx,dop=144,t=t,J=J,Jz=1.0,dim=6000)
    #
    ...
    #=========================================================
    ax1.text(2,0.5025,"(a)",fontsize = 20, color='black', rotation = 0)
    ax1.text(10,0.501, r'$\mathrm{J_{\bot}} = 1.0$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax1.text(25,0.501, r'$\mathrm{\delta} = 0.5$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=======================================================================================
    # 坐标轴设置第一层
    ...
    ax2 = plt.gca()
    df_ni_Jz40 = get_data_ni(Lz=Lz,Ly=Ly,Lx=Lx,dop=144,t=t,J=J,Jz=4.0,dim=6000)
    #
    ...
    ####图例设置
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 16, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L40_mu1,L40_mu2,L40_mu3], loc = 4, bbox_to_anchor=(0.76, 0.01),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)    
    #legend2=plt.legend(handles=[L04g,L10g,L20g], loc = 4, bbox_to_anchor=(0.64, 0.02),
    #                   ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #plt.gca().add_artist(legend1)#####把图例legend1重新加载回来
    ...
    #=========================================================
    ax2.text(4,0.50065,"(b)",fontsize = 20, color='black', rotation = 0)
    ax2.text(10,0.5004, r'$\mathrm{J_{\bot}} = 4.0$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax2.text(25,0.5004, r'$\mathrm{\delta} = 0.5$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=======================================================================================
    # 坐标轴设置第一层
    ...
    ax3 = plt.gca()
    df_ni_Jz80 = get_data_ni(Lz=Lz,Ly=Ly,Lx=Lx,dop=144,t=t,J=J,Jz=8.0,dim=6000)
    #
    ...
    #=========================================================
    ax3.text(2,0.545,"(c)",fontsize = 20, color='black', rotation = 0)
    ax3.text(2,0.43, r'$\mathrm{J_{\bot}} = 8.0$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax3.text(15,0.43, r'$\mathrm{\delta} = 0.5$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=======================================================================================
    # 坐标轴设置第一层
    ...
    ax4 = plt.gca()
    df_ni_Jz120 = get_data_ni(Lz=Lz,Ly=Ly,Lx=Lx,dop=144,t=t,J=J,Jz=12.0,dim=6000)
    #
    ...
    #=========================================================
    ax4.text(2,0.392,"(d)",fontsize = 20, color='black', rotation = 0)
    ax4.text(10,0.392, r'$\mathrm{J_{\bot}} = 12.0$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax4.text(25,0.392, r'$\mathrm{\delta} = 0.5$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=======================================================================================
    # 坐标轴设置第一层
    ...
    ax5 = plt.gca()
    df_ni_Jz240 = get_data_ni(Lz=Lz,Ly=Ly,Lx=Lx,dop=144,t=t,J=J,Jz=18.0,dim=6000)
    #
    L, =ax5.plot([0,50],[0.5,0.5],label=" ",ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=1.5, markeredgecolor="red", markerfacecolor='None')
    ...
    ####图例设置
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 16, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L240_mu1,L240_mu2,L240_mu3], loc = 4, bbox_to_anchor=(0.56, 0.51),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)    
    #legend2=plt.legend(handles=[L04g,L10g,L20g], loc = 4, bbox_to_anchor=(0.64, 0.02),
    #                   ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #plt.gca().add_artist(legend1)#####把图例legend1重新加载回来
    ...
    #=========================================================
    ax5.text(2,0.348,"(e)",fontsize = 20, color='black', rotation = 0)
    ax5.text(10,0.348, r'$\mathrm{J_{\bot}} = 18.0$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax5.text(25,0.348, r'$\mathrm{\delta} = 0.5$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=======================================================================================
    # 坐标轴设置第一层
    ...
    ax6 = plt.gca()
    df_ni_Jz480 = get_data_ni(Lz=Lz,Ly=Ly,Lx=Lx,dop=144,t=t,J=J,Jz=24.0,dim=6000)
    #
