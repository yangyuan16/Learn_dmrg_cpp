...
if __name__ =="__main__":
    ...
    ax1 = plt.gca()
    #
    df_pzz_Jz10_mu12 = get_data_pzz_layer12(Lz=Lz,Ly=Ly,Lx=Lx,dop=36,t=t,J=J,Jz=1.0,dim=10000)
    df_pzz_Jz10_mu23 = get_data_pzz_layer23(Lz=Lz,Ly=Ly,Lx=Lx,dop=36,t=t,J=J,Jz=1.0,dim=10000)
    df_pzz_Jz10_mu13 = get_data_pzz_layer13(Lz=Lz,Ly=Ly,Lx=Lx,dop=36,t=t,J=J,Jz=1.0,dim=10000)
    #--------- layer 12
    ...
    ax1.text(3,0.003, r'$\mathrm{\delta} = 0.125$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax1.text(8,0.003, r'$J_{\bot}=1.0$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax1.text(8,0.0002, r'$D=10000$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
    ...
    ax2 = plt.gca()
    #
    df_pzz_Jz40_mu12 = get_data_pzz_layer12(Lz=Lz,Ly=Ly,Lx=Lx,dop=36,t=t,J=J,Jz=4.0,dim=8000)
    df_pzz_Jz40_mu23 = get_data_pzz_layer23(Lz=Lz,Ly=Ly,Lx=Lx,dop=36,t=t,J=J,Jz=4.0,dim=8000)
    df_pzz_Jz40_mu13 = get_data_pzz_layer13(Lz=Lz,Ly=Ly,Lx=Lx,dop=36,t=t,J=J,Jz=4.0,dim=8000)
    #--------- layer 12
    ...
    #
    #=========================================================
    ax2.text(25,1e-5,"(b)",fontsize = 20, color='black', rotation = 0)
    ax2.text(3,1e-5, r'$\mathrm{\delta} = 0.125$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax2.text(8,1e-5, r'$J_{\bot}=4.0$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax2.text(8,1e-6, r'$D=8000$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
    ...
    ax3 = plt.gca()
    #
    df_pzz_Jz80_mu12 = get_data_pzz_layer12(Lz=Lz,Ly=Ly,Lx=Lx,dop=36,t=t,J=J,Jz=8.0,dim=6000)
    df_pzz_Jz80_mu23 = get_data_pzz_layer23(Lz=Lz,Ly=Ly,Lx=Lx,dop=36,t=t,J=J,Jz=8.0,dim=6000)
    df_pzz_Jz80_mu13 = get_data_pzz_layer13(Lz=Lz,Ly=Ly,Lx=Lx,dop=36,t=t,J=J,Jz=8.0,dim=6000)
    #--------- layer 12
    ...
    #
    #=========================================================
    ax3.text(25,3e-6,"(c)",fontsize = 20, color='black', rotation = 0)
    ax3.text(3,3e-6, r'$\mathrm{\delta} = 0.125$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax3.text(8,3e-6, r'$J_{\bot}=8.0$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax3.text(8,1e-7, r'$D=6000$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
    ...
    ax4 = plt.gca()
    #
    df_pzz_Jz120_mu12 = get_data_pzz_layer12(Lz=Lz,Ly=Ly,Lx=Lx,dop=36,t=t,J=J,Jz=12.0,dim=8000)
    df_pzz_Jz120_mu23 = get_data_pzz_layer23(Lz=Lz,Ly=Ly,Lx=Lx,dop=36,t=t,J=J,Jz=12.0,dim=8000)
    df_pzz_Jz120_mu13 = get_data_pzz_layer13(Lz=Lz,Ly=Ly,Lx=Lx,dop=36,t=t,J=J,Jz=12.0,dim=8000)
    #--------- layer 12
    ...
    #
    #=========================================================
    ax4.text(25,1e-6,"(d)",fontsize = 20, color='black', rotation = 0)
    ax4.text(3,1e-6, r'$\mathrm{\delta} = 0.125$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax4.text(8,1e-6, r'$J_{\bot}=12.0$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax4.text(8,1e-7, r'$D=8000$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
    ...
    ax5 = plt.gca()
    #
    df_pzz_Jz240_mu12 = get_data_pzz_layer12(Lz=Lz,Ly=Ly,Lx=Lx,dop=36,t=t,J=J,Jz=24.0,dim=6000)
    df_pzz_Jz240_mu23 = get_data_pzz_layer23(Lz=Lz,Ly=Ly,Lx=Lx,dop=36,t=t,J=J,Jz=24.0,dim=6000)
    df_pzz_Jz240_mu13 = get_data_pzz_layer13(Lz=Lz,Ly=Ly,Lx=Lx,dop=36,t=t,J=J,Jz=24.0,dim=6000)
    #--------- layer 12
    ...
    #
    #=========================================================
    ax5.text(25,3e-7,"(e)",fontsize = 20, color='black', rotation = 0)
    ax5.text(3,3e-7, r'$\mathrm{\delta} = 0.125$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax5.text(8,3e-7, r'$J_{\bot}=24.0$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax5.text(8,1e-8, r'$D=6000$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
    ...
    #plt.savefig("E:\\WORK\\Work\\Project\\TrilayerW2-tj-Jz-openz\\datashow_datpy_report\\figs\\fig_01250_pzz.eps",
