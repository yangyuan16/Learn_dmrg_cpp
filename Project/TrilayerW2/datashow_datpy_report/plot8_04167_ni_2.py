...
if __name__ =="__main__":
    ...
    ax1 = plt.gca()
    df_ni_Jz90 = get_data_ni(Lz=Lz,Ly=Ly,Lx=Lx,dop=120,t=t,J=J,Jz=9.0,dim=10000)
    #
    L, =ax1.plot([0,50],[0.5833,0.5833],label=" ",ls="--",lw=1.5,color="k",
    ...
    #=========================================================
    ax1.text(2,0.51,"(a)",fontsize = 20, color='black', rotation = 0)
    ax1.text(30,0.62, r'$\mathrm{J_{\bot}} = 9.0$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax1.text(30,0.61, r'$\mathrm{\delta} = 0.4167$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax1.text(30,0.60, r'D=10000', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=======================================================================================
    # 坐标轴设置第一层
    ...
    ax2 = plt.gca()
    df_ni_Jz120 = get_data_ni(Lz=Lz,Ly=Ly,Lx=Lx,dop=120,t=t,J=J,Jz=12.0,dim=10000)
    #
    L, =ax2.plot([0,50],[0.5833,0.5833],label=" ",ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=1.5, markeredgecolor="red", markerfacecolor='None')
    ...
    #=========================================================
    ax2.text(2,0.49,"(b)",fontsize = 20, color='black', rotation = 0)
    ax2.text(30,0.63, r'$\mathrm{J_{\bot}} = 12.0$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax2.text(30,0.61, r'$\mathrm{\delta} = 0.4167$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax2.text(30,0.59, r'D=10000', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=======================================================================================
    # 坐标轴设置第一层
    ...
    ax3 = plt.gca()
    df_ni_Jz150 = get_data_ni(Lz=Lz,Ly=Ly,Lx=Lx,dop=120,t=t,J=J,Jz=15.0,dim=10000)
    #
    L, =ax3.plot([0,50],[0.5833,0.5833],label=" ",ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=1.5, markeredgecolor="red", markerfacecolor='None')
    ...
    #=========================================================
    ax3.text(2,0.48,"(c)",fontsize = 20, color='black', rotation = 0)
    ax3.text(30,0.63, r'$\mathrm{J_{\bot}} = 15.0$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax3.text(30,0.61, r'$\mathrm{\delta} = 0.4167$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax3.text(30,0.59, r'D=10000', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=======================================================================================
    # 坐标轴设置第一层
    ...
    ax4 = plt.gca()
    df_ni_Jz180 = get_data_ni(Lz=Lz,Ly=Ly,Lx=Lx,dop=120,t=t,J=J,Jz=18.0,dim=10000)
    #
    L, =ax4.plot([0,50],[0.5833,0.5833],label=" ",ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=1.5, markeredgecolor="red", markerfacecolor='None')
    ...
    #=========================================================
    ax4.text(2,0.44,"(d)",fontsize = 20, color='black', rotation = 0)
    ax4.text(30,0.64, r'$\mathrm{J_{\bot}} = 18.0$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax4.text(30,0.61, r'$\mathrm{\delta} = 0.4167$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax4.text(30,0.58, r'D=10000', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=======================================================================================
    # 坐标轴设置第一层
    ...
    ax5 = plt.gca()
    df_ni_Jz210 = get_data_ni(Lz=Lz,Ly=Ly,Lx=Lx,dop=120,t=t,J=J,Jz=21.0,dim=10000)
    #
    L, =ax5.plot([0,50],[0.5833,0.5833],label=" ",ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=1.5, markeredgecolor="red", markerfacecolor='None')
    ...
    ####图例设置
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 16, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L210_mu1,L210_mu2,L210_mu3], loc = 4, bbox_to_anchor=(0.56, 0.46),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)    
    #legend2=plt.legend(handles=[L04g,L10g,L20g], loc = 4, bbox_to_anchor=(0.64, 0.02),
    #                   ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #plt.gca().add_artist(legend1)#####把图例legend1重新加载回来
    ...
    #=========================================================
    ax5.text(2,0.44,"(e)",fontsize = 20, color='black', rotation = 0)
    ax5.text(30,0.64, r'$\mathrm{J_{\bot}} = 21.0$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax5.text(30,0.61, r'$\mathrm{\delta} = 0.4167$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax5.text(30,0.58, r'D=10000', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=======================================================================================
    # 坐标轴设置第一层
    ...
    ax6 = plt.gca()
    df_ni_Jz240 = get_data_ni(Lz=Lz,Ly=Ly,Lx=Lx,dop=120,t=t,J=J,Jz=24.0,dim=10000)
    #
    L, =ax6.plot([0,50],[0.5833,0.5833],label=" ",ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=1.5, markeredgecolor="red", markerfacecolor='None')
    ...
    ####图例设置
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 16, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L240_mu1,L240_mu2,L240_mu3], loc = 4, bbox_to_anchor=(0.56, 0.46),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)    
    #legend2=plt.legend(handles=[L04g,L10g,L20g], loc = 4, bbox_to_anchor=(0.64, 0.02),
    #                   ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #plt.gca().add_artist(legend1)#####把图例legend1重新加载回来
    ...
    #=========================================================
    ax6.text(2,0.44,"(f)",fontsize = 20, color='black', rotation = 0)
    ax6.text(30,0.64, r'$\mathrm{J_{\bot}} = 24.0$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax6.text(30,0.61, r'$\mathrm{\delta} = 0.4167$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax6.text(30,0.58, r'D=10000', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=======================================================================================
    # 坐标轴设置第一层
