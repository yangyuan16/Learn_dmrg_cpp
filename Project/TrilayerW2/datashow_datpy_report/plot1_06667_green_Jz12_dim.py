...
if __name__ =="__main__":
    ...
    ax1 = plt.gca()
    #
    df_cicj_Jz120_mu1_6000 = get_data_cicj_layer1(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=12.0,dim=6000)
    ...
    Ks = round(-slope,2)  
    label = r"$K_G$=%.2f,D=%d"%(Ks,6000)
    L120_mu1_6000, = ax1.plot(df_cicj_Jz120_mu1_6000["r"],df_cicj_Jz120_mu1_6000["corre_abs"],label=label,ls="-",lw=1.5,color="red",
             marker='o',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="red", markerfacecolor='None')
    L120_mu1_6000_, = ax1.plot(df_cicj_Jz120_mu1_6000["r"],df_cicj_Jz120_mu1_6000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
    ...
    Ks = round(-slope,2)
    label = r"$K_G$=%.2f,D=%d"%(Ks,12000)
    L120_mu1_12000, = ax1.plot(df_cicj_Jz120_mu1_12000["r"],df_cicj_Jz120_mu1_12000["corre_abs"],label=label,ls="-",lw=1.5,color="blue",
             marker='o',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="blue", markerfacecolor='None')
    L120_mu1_12000_, = ax1.plot(df_cicj_Jz120_mu1_12000["r"],df_cicj_Jz120_mu1_12000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 14, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L120_mu1_6000,L120_mu1_12000], loc = 4, bbox_to_anchor=(0.45, 0.2),
    ...
    ax1.text(8,0.1, r'$J_{\bot}=12.0$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax1.text(8,0.05, r'$\mu=1$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
    ...
    ax2 = plt.gca()
    #
    df_cicj_Jz120_mu2_6000 = get_data_cicj_layer2(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=12.0,dim=6000)
    ...
    Ks = round(-slope,2)  
    label = r"$K_G$=%.2f,D=%d"%(Ks,6000)
    L120_mu2_6000, = ax2.plot(df_cicj_Jz120_mu2_6000["r"],df_cicj_Jz120_mu2_6000["corre_abs"],label=label,ls="-",lw=1.5,color="red",
             marker='o',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="red", markerfacecolor='None')
    L120_mu2_6000_, = ax2.plot(df_cicj_Jz120_mu2_6000["r"],df_cicj_Jz120_mu2_6000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #--------- layer 1 dim=12000
    slope = df_cicj_Jz120_mu2_12000['slope_pow'].values[0]
    Ks = round(-slope,2)
    label = r"$K_G$=%.2f,D=%d"%(Ks,12000)
    L120_mu2_12000, = ax2.plot(df_cicj_Jz120_mu2_12000["r"],df_cicj_Jz120_mu2_12000["corre_abs"],label=label,ls="-",lw=1.5,color="blue",
             marker='o',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="blue", markerfacecolor='None')
    L120_mu2_12000_, = ax2.plot(df_cicj_Jz120_mu2_12000["r"],df_cicj_Jz120_mu2_12000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 14, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L120_mu2_6000,L120_mu2_12000], loc = 4, bbox_to_anchor=(0.45, 0.2),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #legend2=plt.legend(handles=[], loc = 4, bbox_to_anchor=(0.65, -0.04),
    #                   ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #plt.gca().add_artist(legend1)
    ...
    ax2.text(8,0.1, r'$J_{\bot}=12.0$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax2.text(8,0.05, r'$\mu=2$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
    ...
    ax3 = plt.gca()
    #
    df_cicj_Jz120_mu3_6000 = get_data_cicj_layer3(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=12.0,dim=6000)
    ...
    Ks = round(-slope,2)  
    label = r"$K_G$=%.2f,D=%d"%(Ks,6000)
    L120_mu3_6000, = ax3.plot(df_cicj_Jz120_mu3_6000["r"],df_cicj_Jz120_mu3_6000["corre_abs"],label=label,ls="-",lw=1.5,color="red",
             marker='o',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="red", markerfacecolor='None')
    L120_mu3_6000_, = ax3.plot(df_cicj_Jz120_mu3_6000["r"],df_cicj_Jz120_mu3_6000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #--------- layer 3 dim=12000
    slope = df_cicj_Jz120_mu3_12000['slope_pow'].values[0]
    Ks = round(-slope,2)
    label = r"$K_G$=%.2f,D=%d"%(Ks,12000)
    L120_mu3_12000, = ax3.plot(df_cicj_Jz120_mu3_12000["r"],df_cicj_Jz120_mu3_12000["corre_abs"],label=label,ls="-",lw=1.5,color="blue",
             marker='o',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="blue", markerfacecolor='None')
    L120_mu3_12000_, = ax3.plot(df_cicj_Jz120_mu3_12000["r"],df_cicj_Jz120_mu3_12000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 14, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L120_mu3_6000,L120_mu3_12000], loc = 4, bbox_to_anchor=(0.45, 0.2),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #legend2=plt.legend(handles=[], loc = 4, bbox_to_anchor=(0.65, -0.04),
    #                   ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #plt.gca().add_artist(legend1)
    ...
    ax3.text(8,0.1, r'$J_{\bot}=12.0$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax3.text(8,0.05, r'$\mu=3$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
