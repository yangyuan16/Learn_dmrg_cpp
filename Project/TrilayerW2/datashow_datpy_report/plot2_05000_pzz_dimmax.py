...
if __name__ =="__main__":
    ...
    legend1=plt.legend(handles=[L90_pzzmu12_12000,L90_pzzmu23_12000,], 
    ...
    #---------------------------------------------------------------------------------------------------------------------
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 14, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L150_pzzmu12_12000,L150_pzzmu23_12000,], 
                       loc = 4, bbox_to_anchor=(0.65, -0.05),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #legend2=plt.legend(handles=[], loc = 4, bbox_to_anchor=(0.65, -0.04),
    #                   ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    ...
    L210_pzzmu12_10000, = ax5.plot(df_pzz_Jz210_mu12_10000["r"],df_pzz_Jz210_mu12_10000["corre_abs"],label=label,ls="-",lw=1.5,color="red",
             marker='s',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="red", markerfacecolor='None')
    ...
    L210_pzzmu23_10000, = ax5.plot(df_pzz_Jz210_mu23_10000["r"],df_pzz_Jz210_mu23_10000["corre_abs"],label=label,ls="-",lw=1.5,color="magenta",
             marker='s',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="magenta", markerfacecolor='None')
    ...
    ax5.text(5,0.03, r'$\mathrm{\delta} = \frac{1}{2}$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ...
    ax6 = plt.gca()
    #
    df_pzz_Jz240_mu12_14000 = get_data_pzz_layer12(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=24.0,dim=14000)
    df_pzz_Jz240_mu23_14000 = get_data_pzz_layer23(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=24.0,dim=14000)
    #----------------- plot pzz^{12} D= 12000-----------------------------------------------------------------------
    slope = df_pzz_Jz240_mu12_14000["slope_pow"].values[0]
    Ks = round(-slope,2) 
    label = r"$P_{zz}^{1,2}$, $K_{P_{zz}}^{1,2}$=%.2f, D=14000"%(Ks)
    L240_pzzmu12_14000, = ax6.plot(df_pzz_Jz240_mu12_14000["r"],df_pzz_Jz240_mu12_14000["corre_abs"],label=label,ls="-",lw=1.5,color="cyan",
             marker='s',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="cyan", markerfacecolor='None')
    L240_pzzmu12_14000_, = ax6.plot(df_pzz_Jz240_mu12_14000["r"],df_pzz_Jz240_mu12_14000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='s',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #----------------- plot pzz^{23} D=12000-----------------------------------------------------------------------
    slope = df_pzz_Jz240_mu23_14000["slope_pow"].values[0]
    Ks = round(-slope,2) 
    label = r"$P_{zz}^{2,3}$, $K_{P_{zz}}^{2,3}$=%.2f, D=14000"%(Ks)
    L240_pzzmu23_14000, = ax6.plot(df_pzz_Jz240_mu23_14000["r"],df_pzz_Jz240_mu23_14000["corre_abs"],label=label,ls="-",lw=1.5,color="olive",
             marker='s',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="olive", markerfacecolor='None')
    L240_pzzmu23_14000_, = ax6.plot(df_pzz_Jz240_mu23_14000["r"],df_pzz_Jz240_mu23_14000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='s',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w') 
    #---------------------------------------------------------------------------------------------------------------------
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 14, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L240_pzzmu12_14000,L240_pzzmu23_14000], 
                       loc = 4, bbox_to_anchor=(0.65, -0.05),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #legend2=plt.legend(handles=[], loc = 4, bbox_to_anchor=(0.65, -0.04),
    #                   ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
