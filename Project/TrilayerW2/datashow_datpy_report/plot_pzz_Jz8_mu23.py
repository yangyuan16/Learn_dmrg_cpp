...
if __name__ =="__main__":
    ...
    ax2 = plt.gca()
    #------- J_\bot = 8.0, delta = 0.3750
    df_pzz_0375_Jz80_mu12 = get_data_pzz_layer12(Lz=3,Ly=2,Lx=48,dop=108,t=3,J=1,Jz=8.0,dim=12000)
    df_pzz_0375_Jz80_mu23 = get_data_pzz_layer23(Lz=3,Ly=2,Lx=48,dop=108,t=3,J=1,Jz=8.0,dim=12000)
    df_pzz_0375_Jz80_mu13 = get_data_pzz_layer13(Lz=3,Ly=2,Lx=48,dop=108,t=3,J=1,Jz=8.0,dim=12000)
    #------ J_\bot = 8.0, delta = 0.50
    df_pzz_05_Jz80_mu12 = get_data_pzz_layer12(Lz=3,Ly=2,Lx=48,dop=144,t=3,J=1,Jz=8.0,dim=16000)
    df_pzz_05_Jz80_mu23 = get_data_pzz_layer23(Lz=3,Ly=2,Lx=48,dop=144,t=3,J=1,Jz=8.0,dim=16000)
    df_pzz_05_Jz80_mu13 = get_data_pzz_layer13(Lz=3,Ly=2,Lx=48,dop=144,t=3,J=1,Jz=8.0,dim=16000)
    #----- J_\bot = 8.0, delta = 0.6667
    df_pzz_0667_Jz80_mu12 = get_data_pzz_layer12(Lz=3,Ly=2,Lx=48,dop=192,t=3,J=1,Jz=8.0,dim=6000)
    df_pzz_0667_Jz80_mu23 = get_data_pzz_layer23(Lz=3,Ly=2,Lx=48,dop=192,t=3,J=1,Jz=8.0,dim=6000)
    df_pzz_0667_Jz80_mu13 = get_data_pzz_layer13(Lz=3,Ly=2,Lx=48,dop=192,t=3,J=1,Jz=8.0,dim=6000)
    #
    ...
    slope = df_pzz_0375_Jz80_mu23['slope_pow'].values[0]
    Ks = round(-slope,2)
    label = r"$\delta=0.375,K_{P_{zz}}^{2,3}$=%.2f,D=%d"%(Ks,12000)
    L0375_80_mu23, = ax2.plot(df_pzz_0375_Jz80_mu23["r"],df_pzz_0375_Jz80_mu23["corre_abs"],label=label,ls="-",lw=1.5,color="magenta",
             marker='o',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="magenta", markerfacecolor='None')
    L0375_80_mu23_, = ax2.plot(df_pzz_0375_Jz80_mu23["r"],df_pzz_0375_Jz80_mu23["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #--------------------------------------------------------------------------------------
    ...
    slope = df_pzz_05_Jz80_mu23['slope_pow'].values[0]
    Ks = round(-slope,2)
    label = r"$\delta=0.5,K_{P_{zz}}^{2,3}$=%.2f,D=%d"%(Ks,16000)
    L05_80_mu23, = ax2.plot(df_pzz_05_Jz80_mu23["r"],df_pzz_05_Jz80_mu23["corre_abs"],label=label,ls="-",lw=1.5,color="cyan",
             marker='^',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="cyan", markerfacecolor='None')
    L05_80_mu23_, = ax2.plot(df_pzz_05_Jz80_mu23["r"],df_pzz_05_Jz80_mu23["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='^',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #-------------------------------------------------------------------------------------------
    ...
    slope = df_pzz_0667_Jz80_mu23['slope_pow'].values[0]
    Ks = round(-slope,2)
    label = r"$\delta=0.6667,K_{P_{zz}}^{2,3}$=%.2f,D=%d"%(Ks,6000)
    L0667_80_mu23, = ax2.plot(df_pzz_0667_Jz80_mu23["r"],df_pzz_0667_Jz80_mu23["corre_abs"],label=label,ls="-",lw=1.5,color="olive",
             marker='s',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="olive", markerfacecolor='None')
    L0667_80_mu23_, = ax2.plot(df_pzz_0667_Jz80_mu23["r"],df_pzz_0667_Jz80_mu23["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='s',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #-------------------------------------------------------------------------------------------
    ####图例设置
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 15, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L0375_80_mu23,L05_80_mu23,L0667_80_mu23], 
    ...
    ax2.text(8,0.05, r'$J_{\bot}=8.0$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
    ...
    #plt.savefig("E:\\WORK\\Work\\Project\\TrilayerW2-tj-Jz-openz\\datashow_datpy_report\\figs\\fig_pzz_J8.eps",
