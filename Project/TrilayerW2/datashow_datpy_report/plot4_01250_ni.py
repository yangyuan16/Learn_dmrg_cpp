...
if __name__ =="__main__":
    ...
    ax1 = plt.gca()
    df_ni_Jz10 = get_data_ni(Lz=Lz,Ly=Ly,Lx=Lx,dop=36,t=t,J=J,Jz=1.0,dim=10000)
    #
    L, =ax1.plot([0,50],[0.875,0.875],label=" ",ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=1.5, markeredgecolor="red", markerfacecolor='None')
    ni_layer1 = np.array(df_ni_Jz10['dy0'] /2 + df_ni_Jz10["dy1"] / 2)
    label = r"$\mu =1$"
    L10_mu1, =ax1.plot(df_ni_Jz10["rmean"].values,ni_layer1,label=label,ls="-",lw=1.5,color="red",
             marker='o',alpha=1,markersize=9,markeredgewidth=1.5, markeredgecolor="red", markerfacecolor='None')
    #
    ni_layer2 = np.array(df_ni_Jz10['dy2'] /2 + df_ni_Jz10["dy3"] / 2)
    label = r"$\mu =2$"
    L10_mu2, =ax1.plot(df_ni_Jz10["rmean"].values,ni_layer2,label=label,ls="-",lw=1.5,color="blue",
             marker='o',alpha=1,markersize=9,markeredgewidth=1.5, markeredgecolor="blue", markerfacecolor='None')
    #
    ni_layer3 = np.array(df_ni_Jz10['dy4'] /2 + df_ni_Jz10["dy5"] / 2)
    label = r"$\mu =3$"
    L10_mu3, =ax1.plot(df_ni_Jz10["rmean"].values,ni_layer3,label=label,ls="-",lw=1.5,color="magenta",
    ...
    legend1=plt.legend(handles=[L10_mu1,L10_mu2,L10_mu3], loc = 4, bbox_to_anchor=(0.56, -0.05),
    ...
    #=========================================================
    ax1.text(4,0.98,"(a)",fontsize = 20, color='black', rotation = 0)
    ax1.text(10,0.98, r'$\mathrm{J_{\bot}} = 1.0$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax1.text(25,0.98, r'$\mathrm{\delta} = 0.125$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax1.text(25,0.96, r'$D = 10000$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=======================================================================================
    # 坐标轴设置第一层
    ...
    ax2 = plt.gca()
    df_ni_Jz40 = get_data_ni(Lz=Lz,Ly=Ly,Lx=Lx,dop=36,t=t,J=J,Jz=4.0,dim=8000)
    #
    L, =ax2.plot([0,50],[0.875,0.875],label=" ",ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=1.5, markeredgecolor="red", markerfacecolor='None')
    ni_layer1 = np.array(df_ni_Jz40['dy0'] /2 + df_ni_Jz40["dy1"] / 2)
    label = r"$\mu =1$"
    L40_mu1, =ax2.plot(df_ni_Jz40["rmean"].values,ni_layer1,label=label,ls="-",lw=1.5,color="red",
             marker='o',alpha=1,markersize=9,markeredgewidth=1.5, markeredgecolor="red", markerfacecolor='None')
    #
    ni_layer2 = np.array(df_ni_Jz40['dy2'] /2 + df_ni_Jz40["dy3"] / 2)
    label = r"$\mu =2$"
    L40_mu2, =ax2.plot(df_ni_Jz40["rmean"].values,ni_layer2,label=label,ls="-",lw=1.5,color="blue",
             marker='o',alpha=1,markersize=9,markeredgewidth=1.5, markeredgecolor="blue", markerfacecolor='None')
    #
    ni_layer3 = np.array(df_ni_Jz40['dy4'] /2 + df_ni_Jz40["dy5"] / 2)
    label = r"$\mu =3$"
    L40_mu3, =ax2.plot(df_ni_Jz40["rmean"].values,ni_layer3,label=label,ls="-",lw=1.5,color="magenta",
             marker='o',alpha=1,markersize=9,markeredgewidth=1.5, markeredgecolor="magenta", markerfacecolor='None')
    ####图例设置
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 16, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L40_mu1,L40_mu2,L40_mu3], loc = 4, bbox_to_anchor=(0.96, 0.46),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)    
    #legend2=plt.legend(handles=[L04g,L10g,L20g], loc = 4, bbox_to_anchor=(0.64, 0.02),
    #                   ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #plt.gca().add_artist(legend1)#####把图例legend1重新加载回来
    ...
    #=========================================================
    ax2.text(4,0.98,"(b)",fontsize = 20, color='black', rotation = 0)
    ax2.text(10,0.98, r'$\mathrm{J_{\bot}} = 4.0$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax2.text(22,0.98, r'$\mathrm{\delta} = 0.125$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax2.text(35,0.98, r'$D = 8000$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=======================================================================================
    # 坐标轴设置第一层
    ...
    ax3 = plt.gca()
    df_ni_Jz80 = get_data_ni(Lz=Lz,Ly=Ly,Lx=Lx,dop=36,t=t,J=J,Jz=8.0,dim=6000)
    #
    L, =ax3.plot([0,50],[0.875,0.875],label=" ",ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=1.5, markeredgecolor="red", markerfacecolor='None')
    ni_layer1 = np.array(df_ni_Jz80['dy0'] /2 + df_ni_Jz80["dy1"] / 2)
    label = r"$\mu =1$"
    L80_mu1, =ax3.plot(df_ni_Jz80["rmean"].values,ni_layer1,label=label,ls="-",lw=1.5,color="red",
             marker='o',alpha=1,markersize=9,markeredgewidth=1.5, markeredgecolor="red", markerfacecolor='None')
    #
    ni_layer2 = np.array(df_ni_Jz80['dy2'] /2 + df_ni_Jz80["dy3"] / 2)
    label = r"$\mu =2$"
    L80_mu2, =ax3.plot(df_ni_Jz80["rmean"].values,ni_layer2,label=label,ls="-",lw=1.5,color="blue",
             marker='o',alpha=1,markersize=9,markeredgewidth=1.5, markeredgecolor="blue", markerfacecolor='None')
    #
    ni_layer3 = np.array(df_ni_Jz80['dy4'] /2 + df_ni_Jz80["dy5"] / 2)
    label = r"$\mu =3$"
    L80_mu3, =ax3.plot(df_ni_Jz80["rmean"].values,ni_layer3,label=label,ls="-",lw=1.5,color="magenta",
             marker='o',alpha=1,markersize=9,markeredgewidth=1.5, markeredgecolor="magenta", markerfacecolor='None')
    ####图例设置
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 16, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L80_mu1,L80_mu2,L80_mu3], loc = 4, bbox_to_anchor=(0.96, 0.5),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)    
    #legend2=plt.legend(handles=[L04g,L10g,L20g], loc = 4, bbox_to_anchor=(0.64, 0.02),
    #                   ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #plt.gca().add_artist(legend1)#####把图例legend1重新加载回来
    ...
    #=========================================================
    ax3.text(2,0.98,"(c)",fontsize = 20, color='black', rotation = 0)
    ax3.text(7,0.98, r'$\mathrm{J_{\bot}} = 8.0$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax3.text(19,0.98, r'$\mathrm{\delta} = 0.125$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax3.text(32,0.98, r'$D = 6000$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=======================================================================================
    # 坐标轴设置第一层
    ...
    ax4 = plt.gca()
    df_ni_Jz120 = get_data_ni(Lz=Lz,Ly=Ly,Lx=Lx,dop=36,t=t,J=J,Jz=12.0,dim=8000)
    #
    L, =ax4.plot([0,50],[0.875,0.875],label=" ",ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=1.5, markeredgecolor="red", markerfacecolor='None')
    ni_layer1 = np.array(df_ni_Jz120['dy0'] /2 + df_ni_Jz120["dy1"] / 2)
    label = r"$\mu =1$"
    L120_mu1, =ax4.plot(df_ni_Jz120["rmean"].values,ni_layer1,label=label,ls="-",lw=1.5,color="red",
             marker='o',alpha=1,markersize=9,markeredgewidth=1.5, markeredgecolor="red", markerfacecolor='None')
    #
    ni_layer2 = np.array(df_ni_Jz120['dy2'] /2 + df_ni_Jz120["dy3"] / 2)
    label = r"$\mu =2$"
    L120_mu2, =ax4.plot(df_ni_Jz120["rmean"].values,ni_layer2,label=label,ls="-",lw=1.5,color="blue",
             marker='o',alpha=1,markersize=9,markeredgewidth=1.5, markeredgecolor="blue", markerfacecolor='None')
    #
    ni_layer3 = np.array(df_ni_Jz120['dy4'] /2 + df_ni_Jz120["dy5"] / 2)
    label = r"$\mu =3$"
    L120_mu3, =ax4.plot(df_ni_Jz120["rmean"].values,ni_layer3,label=label,ls="-",lw=1.5,color="magenta",
             marker='o',alpha=1,markersize=9,markeredgewidth=1.5, markeredgecolor="magenta", markerfacecolor='None')
    ####图例设置
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 16, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L120_mu1,L120_mu2,L120_mu3], loc = 4, bbox_to_anchor=(0.66, 0.36),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)    
    #legend2=plt.legend(handles=[L04g,L10g,L20g], loc = 4, bbox_to_anchor=(0.64, 0.02),
    #                   ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #plt.gca().add_artist(legend1)#####把图例legend1重新加载回来
    ...
    #=========================================================
    ax4.text(2,0.98,"(d)",fontsize = 20, color='black', rotation = 0)
    ax4.text(7,0.98, r'$\mathrm{J_{\bot}} = 12.0$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax4.text(19,0.98, r'$\mathrm{\delta} = 0.125$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax4.text(35,0.98, r'$D = 8000$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=======================================================================================
    # 坐标轴设置第一层
    ...
    ax5 = plt.gca()
    df_ni_Jz240 = get_data_ni(Lz=Lz,Ly=Ly,Lx=Lx,dop=36,t=t,J=J,Jz=24.0,dim=6000)
    #
    L, =ax5.plot([0,50],[0.875,0.875],label=" ",ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=1.5, markeredgecolor="red", markerfacecolor='None')
    ni_layer1 = np.array(df_ni_Jz240['dy0'] /2 + df_ni_Jz240["dy1"] / 2)
    label = r"$\mu =1$"
    L240_mu1, =ax5.plot(df_ni_Jz240["rmean"].values,ni_layer1,label=label,ls="-",lw=1.5,color="red",
             marker='o',alpha=1,markersize=9,markeredgewidth=1.5, markeredgecolor="red", markerfacecolor='None')
    #
    ni_layer2 = np.array(df_ni_Jz240['dy2'] /2 + df_ni_Jz240["dy3"] / 2)
    label = r"$\mu =2$"
    L240_mu2, =ax5.plot(df_ni_Jz240["rmean"].values,ni_layer2,label=label,ls="-",lw=1.5,color="blue",
             marker='o',alpha=1,markersize=9,markeredgewidth=1.5, markeredgecolor="blue", markerfacecolor='None')
    #
    ni_layer3 = np.array(df_ni_Jz240['dy4'] /2 + df_ni_Jz240["dy5"] / 2)
    label = r"$\mu =3$"
    L240_mu3, =ax5.plot(df_ni_Jz240["rmean"].values,ni_layer3,label=label,ls="-",lw=1.5,color="magenta",
             marker='o',alpha=1,markersize=9,markeredgewidth=1.5, markeredgecolor="magenta", markerfacecolor='None')
    ####图例设置
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 16, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L240_mu1,L240_mu2,L240_mu3], loc = 4, bbox_to_anchor=(0.56, 0.5),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)    
    #legend2=plt.legend(handles=[L04g,L10g,L20g], loc = 4, bbox_to_anchor=(0.64, 0.02),
    #                   ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #plt.gca().add_artist(legend1)#####把图例legend1重新加载回来
    ...
    ax5.set_xlim([0,48])
    #ax5.set_ylim([0.74,0.96])
    ax5.set_xticks([0,10,20,30,40,48])
    #ax5.set_yticks([0.75,0.8,0.85,0.9,0.95]) 
    #=========================================================
    ax5.text(2,0.98,"(e)",fontsize = 20, color='black', rotation = 0)
    ax5.text(7,0.98, r'$\mathrm{J_{\bot}} = 24.0$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax5.text(21,0.98, r'$\mathrm{\delta} = 0.125$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax5.text(35,0.98, r'$D = 6000$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=======================================================================================
    # 坐标轴设置第一层
    ...
    #plt.savefig("E:\\WORK\\Work\\Project\\TrilayerW2-tj-Jz-openz\\datashow_datpy_report\\figs\\fig_01250_ni.eps",
