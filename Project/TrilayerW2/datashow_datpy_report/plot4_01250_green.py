...
if __name__ =="__main__":
    ...
    ax5_sub = plt.axes([0.47,0.31,0.18,0.06])
    # plt.subplots_adjust(left=0.1, bottom=0.1, right=0.98, top=0.96, wspace=0.32, hspace=0.26)
    # 选择子图 ax1 进行绘图
    plt.sca(ax1) ## 选择对 ax1 进行绘图
    ax1 = plt.gca()
    #
    df_cicj_Jz10_mu1 = get_data_cicj_layer1(Lz=Lz,Ly=Ly,Lx=Lx,dop=36,t=t,J=J,Jz=1.0,dim=10000)
    df_cicj_Jz10_mu2 = get_data_cicj_layer2(Lz=Lz,Ly=Ly,Lx=Lx,dop=36,t=t,J=J,Jz=1.0,dim=10000)
    df_cicj_Jz10_mu3 = get_data_cicj_layer3(Lz=Lz,Ly=Ly,Lx=Lx,dop=36,t=t,J=J,Jz=1.0,dim=10000)
    #--------- layer 1
    ...
    ax1.text(3,0.1, r'$\mathrm{\delta} = 0.125$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ...
    ax2 = plt.gca()
    #
    df_cicj_Jz40_mu1 = get_data_cicj_layer1(Lz=Lz,Ly=Ly,Lx=Lx,dop=36,t=t,J=J,Jz=4.0,dim=8000)
    df_cicj_Jz40_mu2 = get_data_cicj_layer2(Lz=Lz,Ly=Ly,Lx=Lx,dop=36,t=t,J=J,Jz=4.0,dim=8000)
    df_cicj_Jz40_mu3 = get_data_cicj_layer3(Lz=Lz,Ly=Ly,Lx=Lx,dop=36,t=t,J=J,Jz=4.0,dim=8000)
    #--------- layer 1
    ...
    ax2.text(3,0.1, r'$\mathrm{\delta} = 0.125$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ...
    ax3 = plt.gca()
    #
    df_cicj_Jz80_mu1 = get_data_cicj_layer1(Lz=Lz,Ly=Ly,Lx=Lx,dop=36,t=t,J=J,Jz=8.0,dim=6000)
    df_cicj_Jz80_mu2 = get_data_cicj_layer2(Lz=Lz,Ly=Ly,Lx=Lx,dop=36,t=t,J=J,Jz=8.0,dim=6000)
    df_cicj_Jz80_mu3 = get_data_cicj_layer3(Lz=Lz,Ly=Ly,Lx=Lx,dop=36,t=t,J=J,Jz=8.0,dim=6000)
    #--------- layer 1
    ...
    # 
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 14, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L80_mu3,L80_mu2,L80_mu1], loc = 4, bbox_to_anchor=(0.45, 0.5),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #legend2=plt.legend(handles=[], loc = 4, bbox_to_anchor=(0.65, -0.04),
    #                   ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #plt.gca().add_artist(legend1)
    ...
    #
    #=========================================================
    ax3.text(25,0.1,"(c)",fontsize = 20, color='black', rotation = 0)
    ax3.text(3,0.1, r'$\mathrm{\delta} = 0.125$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ...
    ax4 = plt.gca()
    #
    df_cicj_Jz120_mu1 = get_data_cicj_layer1(Lz=Lz,Ly=Ly,Lx=Lx,dop=36,t=t,J=J,Jz=12.0,dim=8000)
    df_cicj_Jz120_mu2 = get_data_cicj_layer2(Lz=Lz,Ly=Ly,Lx=Lx,dop=36,t=t,J=J,Jz=12.0,dim=8000)
    df_cicj_Jz120_mu3 = get_data_cicj_layer3(Lz=Lz,Ly=Ly,Lx=Lx,dop=36,t=t,J=J,Jz=12.0,dim=8000)
    #--------- layer 1
    ...
    # 
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 14, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L120_mu3,L120_mu2,L120_mu1], loc = 4, bbox_to_anchor=(0.45, 0.5),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #legend2=plt.legend(handles=[], loc = 4, bbox_to_anchor=(0.65, -0.04),
    #                   ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #plt.gca().add_artist(legend1)
    ...
    #
    #=========================================================
    ax4.text(25,0.1,"(d)",fontsize = 20, color='black', rotation = 0)
    ax4.text(3,0.1, r'$\mathrm{\delta} = 0.125$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax4.text(8,0.1, r'$J_{\bot}=12.0$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax4.text(8,0.008, r'$D=8000$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
    ...
    ax5 = plt.gca()
    #
    df_cicj_Jz240_mu1 = get_data_cicj_layer1(Lz=Lz,Ly=Ly,Lx=Lx,dop=36,t=t,J=J,Jz=24.0,dim=6000)
    df_cicj_Jz240_mu2 = get_data_cicj_layer2(Lz=Lz,Ly=Ly,Lx=Lx,dop=36,t=t,J=J,Jz=24.0,dim=6000)
    df_cicj_Jz240_mu3 = get_data_cicj_layer3(Lz=Lz,Ly=Ly,Lx=Lx,dop=36,t=t,J=J,Jz=24.0,dim=6000)
    #--------- layer 1
    ...
    # 
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 14, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L240_mu1,L240_mu2,L240_mu3], loc = 4, bbox_to_anchor=(0.75, 0.25),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #legend2=plt.legend(handles=[], loc = 4, bbox_to_anchor=(0.65, -0.04),
    #                   ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #plt.gca().add_artist(legend1)
    ...
    #
    #=========================================================
    ax5.text(31,0.8e-1,"(e)",fontsize = 20, color='black', rotation = 0)
    ax5.text(1,0.1e-4, r'$\mathrm{\delta} = 0.125$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ...
    #plt.savefig("E:\\WORK\\Work\\Project\\TrilayerW2-tj-Jz-openz\\datashow_datpy_report\\figs\\fig_01250_green.eps",
