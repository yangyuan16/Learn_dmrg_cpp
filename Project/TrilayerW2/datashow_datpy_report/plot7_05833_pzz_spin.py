...
if __name__ =="__main__":
    ...
    ax1.text(5,0.03, r'$\mathrm{\delta} = \frac{7}{12}$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ...
    #
    df_sisj_Jz120_mu1_10000 = get_data_sisj_layer1(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=12.0,dim=10000)
    df_sisj_Jz120_mu2_10000 = get_data_sisj_layer2(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=12.0,dim=10000)
    df_sisj_Jz120_mu3_10000 = get_data_sisj_layer3(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=12.0,dim=10000)
    #----------------- plot pzz^{12}-----------------------------------------------------------------------
    ...
    L120_pzzmu23_10000_, = ax2.plot(df_pzz_Jz120_mu23_10000["r"],df_pzz_Jz120_mu23_10000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #------------------ plot F(r)^{\mu=1}---------------------------------------------------------------------
    slope = df_sisj_Jz120_mu1_10000['slope_pow'].values[0]
    Ks = round(-slope,2)
    label = r"$F(r)^{\mu=1}$,$K_F^{\mu=1}$=%.2f"%(Ks,)
    L120_Fmu1_10000, = ax2.plot(df_sisj_Jz120_mu1_10000["r"],df_sisj_Jz120_mu1_10000["corre_abs"],label=label,ls="-",lw=1.5,color="cyan",
             marker='s',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="cyan", markerfacecolor='None')
    L120_Fmu1_10000_, = ax2.plot(df_sisj_Jz120_mu1_10000["r"],df_sisj_Jz120_mu1_10000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #----------------- plot F(r)^{\mu=2} -------------------------------------------------------------------
    slope = df_sisj_Jz120_mu2_10000['slope_pow'].values[0]
    Ks = round(-slope,2)
    label = r"$F(r)^{\mu=2}$,$K_F^{\mu=3}$=%.2f"%(Ks,)
    L120_Fmu2_10000, = ax2.plot(df_sisj_Jz120_mu2_10000["r"],df_sisj_Jz120_mu2_10000["corre_abs"],label=label,ls="-",lw=1.5,color="olive",
             marker='>',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="olive", markerfacecolor='None')
    #L120_Fmu2_10000_, = ax2.plot(df_sisj_Jz120_mu2_10000["r"],df_sisj_Jz120_mu2_10000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
    #         marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #----------------- plot F(r)^{\mu=3} -------------------------------------------------------------------
    slope = df_sisj_Jz120_mu3_10000['slope_pow'].values[0]
    Ks = round(-slope,2)
    label = r"$F(r)^{\mu=3}$,$K_F^{\mu=3}$=%.2f"%(Ks,)
    L120_Fmu3_10000, = ax2.plot(df_sisj_Jz120_mu3_10000["r"],df_sisj_Jz120_mu3_10000["corre_abs"],label=label,ls="-",lw=1.5,color="green",
             marker='>',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="green", markerfacecolor='None')
    #L120_Fmu3_10000_, = ax2.plot(df_sisj_Jz120_mu3_10000["r"],df_sisj_Jz120_mu3_10000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
    #         marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')    
    #---------------------------------------------------------------------------------------------------------------------
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 14, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L120_pzzmu12_10000,L120_pzzmu23_10000,L120_Fmu1_10000,L120_Fmu2_10000,L120_Fmu3_10000], 
                       loc = 4, bbox_to_anchor=(0.55, -0.05),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #legend2=plt.legend(handles=[], loc = 4, bbox_to_anchor=(0.65, -0.04),
    #                   ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    ...
    ax2.text(5,0.03, r'$\mathrm{\delta} = \frac{7}{12}$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ...
    ax3.text(5,0.03, r'$\mathrm{\delta} = \frac{7}{12}$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ...
    ax4.text(5,0.03, r'$\mathrm{\delta} = \frac{7}{12}$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ...
    ax5.text(5,0.03, r'$\mathrm{\delta} = \frac{7}{12}$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ...
    ax6.text(5,0.03, r'$\mathrm{\delta} = \frac{7}{12}$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
