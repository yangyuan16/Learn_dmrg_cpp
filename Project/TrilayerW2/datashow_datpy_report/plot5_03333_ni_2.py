...
if __name__ =="__main__":
    ...
    ax1 = plt.gca()
    df_ni_Jz90 = get_data_ni(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=9.0,dim=10000)
    #
    L, =ax1.plot([0,50],[0.6667,0.6667],label=" ",ls="--",lw=1.5,color="k",
    ...
    legend1=plt.legend(handles=[L90_mu1,L90_mu2,L90_mu3], loc = 4, bbox_to_anchor=(0.96, 0.06),
    ...
    #=========================================================
    ax1.text(4,0.81,"(a)",fontsize = 20, color='black', rotation = 0)
    ax1.text(10,0.73, r'$\mathrm{J_{\bot}} = 9.0$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax1.text(25,0.73, r'$\mathrm{\delta} = \frac{1}{3}$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax1.text(10,0.70, r'D=10000', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=======================================================================================
    # 坐标轴设置第一层
    ...
    ax2 = plt.gca()
    df_ni_Jz120 = get_data_ni(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=12.0,dim=10000)
    #
    L, =ax2.plot([0,50],[0.6667,0.6667],label=" ",ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=1.5, markeredgecolor="red", markerfacecolor='None')
    ...
    #=========================================================
    ax2.text(4,0.86,"(b)",fontsize = 20, color='black', rotation = 0)
    ax2.text(10,0.75, r'$\mathrm{J_{\bot}} = 12.0$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax2.text(25,0.75, r'$\mathrm{\delta} = \frac{1}{3}$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax2.text(10,0.70, r'D=10000', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=======================================================================================
    # 坐标轴设置第一层
    ...
    ax3 = plt.gca()
    df_ni_Jz150 = get_data_ni(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=15.0,dim=10000)
    #
    L, =ax3.plot([0,50],[0.6667,0.6667],label=" ",ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=1.5, markeredgecolor="red", markerfacecolor='None')
    ...
    ####图例设置
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 16, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L150_mu1,L150_mu2,L150_mu3], loc = 4, bbox_to_anchor=(0.96, 0.06),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)    
    #legend2=plt.legend(handles=[L04g,L10g,L20g], loc = 4, bbox_to_anchor=(0.64, 0.02),
    #                   ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #plt.gca().add_artist(legend1)#####把图例legend1重新加载回来
    ...
    #=========================================================
    ax3.text(4,0.86,"(c)",fontsize = 20, color='black', rotation = 0)
    ax3.text(10,0.75, r'$\mathrm{J_{\bot}} = 15.0$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax3.text(25,0.75, r'$\mathrm{\delta} = \frac{1}{3}$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax3.text(10,0.70, r'D=10000', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=======================================================================================
    # 坐标轴设置第一层
    ...
    ax4 = plt.gca()
    df_ni_Jz180 = get_data_ni(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=18.0,dim=10000)
    #
    L, =ax4.plot([0,50],[0.6667,0.6667],label=" ",ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=1.5, markeredgecolor="red", markerfacecolor='None')
    ni_layer1 = np.array(df_ni_Jz180['dy0'] /2 + df_ni_Jz180["dy1"] / 2)
    label = r"$\mu =1$"
    L120_mu1, =ax4.plot(df_ni_Jz180["rmean"].values,ni_layer1,label=label,ls="-",lw=1.5,color="red",
             marker='o',alpha=1,markersize=9,markeredgewidth=1.5, markeredgecolor="red", markerfacecolor='None')
    #
    ni_layer2 = np.array(df_ni_Jz180['dy2'] /2 + df_ni_Jz180["dy3"] / 2)
    label = r"$\mu =2$"
    L120_mu2, =ax4.plot(df_ni_Jz180["rmean"].values,ni_layer2,label=label,ls="-",lw=1.5,color="blue",
             marker='o',alpha=1,markersize=9,markeredgewidth=1.5, markeredgecolor="blue", markerfacecolor='None')
    #
    ni_layer3 = np.array(df_ni_Jz180['dy4'] /2 + df_ni_Jz180["dy5"] / 2)
    label = r"$\mu =3$"
    L120_mu3, =ax4.plot(df_ni_Jz180["rmean"].values,ni_layer3,label=label,ls="-",lw=1.5,color="magenta",
             marker='o',alpha=1,markersize=9,markeredgewidth=1.5, markeredgecolor="magenta", markerfacecolor='None')
    ####图例设置
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 16, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L120_mu1,L120_mu2,L120_mu3], loc = 4, bbox_to_anchor=(0.96, 0.06),
    ...
    #=========================================================
    ax4.text(3,0.92,"(d)",fontsize = 20, color='black', rotation = 0)
    ax4.text(10,0.80, r'$\mathrm{J_{\bot}} = 18.0$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax4.text(25,0.80, r'$\mathrm{\delta} = \frac{1}{3}$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax4.text(10,0.76, r'D=10000', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=======================================================================================
    # 坐标轴设置第一层
    ...
    ax5 = plt.gca()
    df_ni_Jz210 = get_data_ni(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=21.0,dim=10000)
    #
    L, =ax5.plot([0,50],[0.6667,0.6667],label=" ",ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=1.5, markeredgecolor="red", markerfacecolor='None')
    ni_layer1 = np.array(df_ni_Jz210['dy0'] /2 + df_ni_Jz210["dy1"] / 2)
    label = r"$\mu =1$"
    L210_mu1, =ax5.plot(df_ni_Jz210["rmean"].values,ni_layer1,label=label,ls="-",lw=1.5,color="red",
             marker='o',alpha=1,markersize=9,markeredgewidth=1.5, markeredgecolor="red", markerfacecolor='None')
    #
    ni_layer2 = np.array(df_ni_Jz210['dy2'] /2 + df_ni_Jz210["dy3"] / 2)
    label = r"$\mu =2$"
    L210_mu2, =ax5.plot(df_ni_Jz210["rmean"].values,ni_layer2,label=label,ls="-",lw=1.5,color="blue",
             marker='o',alpha=1,markersize=9,markeredgewidth=1.5, markeredgecolor="blue", markerfacecolor='None')
    #
    ni_layer3 = np.array(df_ni_Jz210['dy4'] /2 + df_ni_Jz210["dy5"] / 2)
    label = r"$\mu =3$"
    L210_mu3, =ax5.plot(df_ni_Jz210["rmean"].values,ni_layer3,label=label,ls="-",lw=1.5,color="magenta",
             marker='o',alpha=1,markersize=9,markeredgewidth=1.5, markeredgecolor="magenta", markerfacecolor='None')
    ####图例设置
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 16, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L210_mu1,L210_mu2,L210_mu3], loc = 4, bbox_to_anchor=(0.96, 0.01),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)    
    #legend2=plt.legend(handles=[L04g,L10g,L20g], loc = 4, bbox_to_anchor=(0.64, 0.02),
    #                   ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #plt.gca().add_artist(legend1)#####把图例legend1重新加载回来
    ...
    #=========================================================
    ax5.text(4,0.525,"(e)",fontsize = 20, color='black', rotation = 0)
    ax5.text(10,0.80, r'$\mathrm{J_{\bot}} = 21.0$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax5.text(25,0.80, r'$\mathrm{\delta} = \frac{1}{3}$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax5.text(10,0.76, r'D=10000', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=======================================================================================
    # 坐标轴设置第一层
    ...
    ax6 = plt.gca()
    df_ni_Jz240 = get_data_ni(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=24.0,dim=6000)
    #
    L, =ax6.plot([0,50],[0.6667,0.6667],label=" ",ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=1.5, markeredgecolor="red", markerfacecolor='None')
    ni_layer1 = np.array(df_ni_Jz240['dy0'] /2 + df_ni_Jz240["dy1"] / 2)
    label = r"$\mu =1$"
    L240_mu1, =ax6.plot(df_ni_Jz240["rmean"].values,ni_layer1,label=label,ls="-",lw=1.5,color="red",
             marker='o',alpha=1,markersize=9,markeredgewidth=1.5, markeredgecolor="red", markerfacecolor='None')
    #
    ni_layer2 = np.array(df_ni_Jz240['dy2'] /2 + df_ni_Jz240["dy3"] / 2)
    label = r"$\mu =2$"
    L240_mu2, =ax6.plot(df_ni_Jz240["rmean"].values,ni_layer2,label=label,ls="-",lw=1.5,color="blue",
             marker='o',alpha=1,markersize=9,markeredgewidth=1.5, markeredgecolor="blue", markerfacecolor='None')
    #
    ni_layer3 = np.array(df_ni_Jz240['dy4'] /2 + df_ni_Jz240["dy5"] / 2)
    label = r"$\mu =3$"
    L240_mu3, =ax6.plot(df_ni_Jz240["rmean"].values,ni_layer3,label=label,ls="-",lw=1.5,color="magenta",
             marker='o',alpha=1,markersize=9,markeredgewidth=1.5, markeredgecolor="magenta", markerfacecolor='None')
    ####图例设置
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 16, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    ...
    #=========================================================
    ax6.text(4,0.525,"(f)",fontsize = 20, color='black', rotation = 0)
    ax6.text(10,0.80, r'$\mathrm{J_{\bot}} = 24.0$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax6.text(25,0.80, r'$\mathrm{\delta} = \frac{1}{3}$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax6.text(10,0.76, r'D=6000', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=======================================================================================
    # 坐标轴设置第一层
