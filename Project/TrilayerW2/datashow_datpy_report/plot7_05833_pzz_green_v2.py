...
if __name__ =="__main__":
    ...
    #
    df_cicj_Jz90_mu1_10000 = get_data_cicj_layer1(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=9.0,dim=10000)
    df_cicj_Jz90_mu2_10000 = get_data_cicj_layer2(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=9.0,dim=10000)
    df_cicj_Jz90_mu3_10000 = get_data_cicj_layer3(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=9.0,dim=10000)
    #----------------- plot pzz^{12}-----------------------------------------------------------------------
    ...
    L90_pzzmu23_10000_, = ax1.plot(df_pzz_Jz90_mu23_10000["r"],df_pzz_Jz90_mu23_10000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #----------------- plot G(r)^{\mu=1} -------------------------------------------------------------------
    slope = df_cicj_Jz90_mu1_10000['slope_pow'].values[0]
    Ks = round(-slope,2)
    label = r"$G(r)^{\mu=1}$,$K_G^{\mu=1}$=%.2f"%(Ks,)
    L90_Gmu1_10000, = ax1.plot(df_cicj_Jz90_mu1_10000["r"],df_cicj_Jz90_mu1_10000["corre_abs"],label=label,ls="-",lw=1.5,color="blue",
             marker='^',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="blue", markerfacecolor='None')
    L90_Gmu1_10000_, = ax1.plot(df_cicj_Jz90_mu1_10000["r"],df_cicj_Jz90_mu1_10000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #----------------- plot G(r)^{\mu=3} -------------------------------------------------------------------
    slope = df_cicj_Jz90_mu3_10000['slope_pow'].values[0]
    Ks = round(-slope,2)
    label = r"$G(r)^{\mu=3}$,$K_G^{\mu=3}$=%.2f"%(Ks,)
    L90_Gmu3_10000, = ax1.plot(df_cicj_Jz90_mu3_10000["r"],df_cicj_Jz90_mu3_10000["corre_abs"],label=label,ls="-",lw=1.5,color="olive",
             marker='>',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="olive", markerfacecolor='None')
    L90_Gmu3_10000_, = ax1.plot(df_cicj_Jz90_mu3_10000["r"],df_cicj_Jz90_mu3_10000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #---------------------------------------------------------------------------------------------------------------------
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 14, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L90_pzzmu12_10000,L90_pzzmu23_10000,L90_Gmu1_10000,L90_Gmu3_10000,], 
    ...
    #=========================================================
    ax1.text(25,0.2,"(a)",fontsize = 20, color='black', rotation = 0)
    ax1.text(5,0.2, r'$\mathrm{\delta} = \frac{7}{12}$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax1.text(8,0.2, r'$J_{\bot}=9.0$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax1.text(8,0.1, r'D=10000', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
    ...
    Ks = round(-slope,2)
    label = r"$G(r)^{\mu=1}$,$K_G^{\mu=1}$=%.2f"%(Ks,)
    L120_Gmu1_10000, = ax2.plot(df_cicj_Jz120_mu1_10000["r"],df_cicj_Jz120_mu1_10000["corre_abs"],label=label,ls="-",lw=1.5,color="blue",
             marker='^',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="blue", markerfacecolor='None')
    L120_Gmu1_10000_, = ax2.plot(df_cicj_Jz120_mu1_10000["r"],df_cicj_Jz120_mu1_10000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #----------------- plot G(r)^{\mu=3} -------------------------------------------------------------------
    slope = df_cicj_Jz120_mu3_10000['slope_pow'].values[0]
    Ks = round(-slope,2)
    label = r"$G(r)^{\mu=3}$,$K_G^{\mu=3}$=%.2f"%(Ks,)
    L120_Gmu3_10000, = ax2.plot(df_cicj_Jz120_mu3_10000["r"],df_cicj_Jz120_mu3_10000["corre_abs"],label=label,ls="-",lw=1.5,color="olive",
             marker='>',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="olive", markerfacecolor='None')
    L120_Gmu3_10000_, = ax2.plot(df_cicj_Jz120_mu3_10000["r"],df_cicj_Jz120_mu3_10000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #---------------------------------------------------------------------------------------------------------------------
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 14, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L120_pzzmu12_10000,L120_pzzmu23_10000,L120_Gmu1_10000,L120_Gmu3_10000,], 
                       loc = 4, bbox_to_anchor=(0.55, -0.05),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #legend2=plt.legend(handles=[], loc = 4, bbox_to_anchor=(0.65, -0.04),
    #                   ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    ...
    #=========================================================
    ax2.text(25,0.2,"(b)",fontsize = 20, color='black', rotation = 0)
    ax2.text(5,0.2, r'$\mathrm{\delta} = \frac{7}{12}$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax2.text(8,0.2, r'$J_{\bot}=12.0$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax2.text(8,0.1, r'D=10000', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
    ...
    #
    df_cicj_Jz150_mu1_10000 = get_data_cicj_layer1(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=15.0,dim=10000)
    df_cicj_Jz150_mu2_10000 = get_data_cicj_layer2(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=15.0,dim=10000)
    df_cicj_Jz150_mu3_10000 = get_data_cicj_layer3(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=15.0,dim=10000)
    #----------------- plot pzz^{12}-----------------------------------------------------------------------
    ...
    L150_pzzmu23_10000_, = ax3.plot(df_pzz_Jz150_mu23_10000["r"],df_pzz_Jz150_mu23_10000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #----------------- plot G(r)^{\mu=1} -------------------------------------------------------------------
    slope = df_cicj_Jz150_mu1_10000['slope_pow'].values[0]
    Ks = round(-slope,2)
    label = r"$G(r)^{\mu=1}$,$K_G^{\mu=1}$=%.2f"%(Ks,)
    L150_Gmu1_10000, = ax3.plot(df_cicj_Jz150_mu1_10000["r"],df_cicj_Jz150_mu1_10000["corre_abs"],label=label,ls="-",lw=1.5,color="blue",
             marker='^',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="blue", markerfacecolor='None')
    L150_Gmu1_10000_, = ax3.plot(df_cicj_Jz150_mu1_10000["r"],df_cicj_Jz150_mu1_10000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #----------------- plot G(r)^{\mu=3} -------------------------------------------------------------------
    slope = df_cicj_Jz150_mu3_10000['slope_pow'].values[0]
    Ks = round(-slope,2)
    label = r"$G(r)^{\mu=3}$,$K_G^{\mu=3}$=%.2f"%(Ks,)
    L150_Gmu3_10000, = ax3.plot(df_cicj_Jz150_mu3_10000["r"],df_cicj_Jz150_mu3_10000["corre_abs"],label=label,ls="-",lw=1.5,color="olive",
             marker='>',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="olive", markerfacecolor='None')
    L150_Gmu3_10000_, = ax3.plot(df_cicj_Jz150_mu3_10000["r"],df_cicj_Jz150_mu3_10000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #---------------------------------------------------------------------------------------------------------------------
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 14, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L150_pzzmu12_10000,L150_pzzmu23_10000,L150_Gmu1_10000,L150_Gmu3_10000,], 
                       loc = 4, bbox_to_anchor=(0.55, -0.05),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #legend2=plt.legend(handles=[], loc = 4, bbox_to_anchor=(0.65, -0.04),
    #                   ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    ...
    #=========================================================
    ax3.text(25,0.2,"(c)",fontsize = 20, color='black', rotation = 0)
    ax3.text(5,0.2, r'$\mathrm{\delta} = \frac{7}{12}$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax3.text(8,0.2, r'$J_{\bot}=15.0$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax3.text(8,0.1, r'D=10000', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
    ...
    #
    df_cicj_Jz180_mu1_10000 = get_data_cicj_layer1(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=18.0,dim=10000)
    df_cicj_Jz180_mu2_10000 = get_data_cicj_layer2(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=18.0,dim=10000)
    df_cicj_Jz180_mu3_10000 = get_data_cicj_layer3(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=18.0,dim=10000)
    #----------------- plot pzz^{12}-----------------------------------------------------------------------
    ...
    L180_pzzmu23_10000_, = ax4.plot(df_pzz_Jz180_mu23_10000["r"],df_pzz_Jz180_mu23_10000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #----------------- plot G(r)^{\mu=1} -------------------------------------------------------------------
    slope = df_cicj_Jz180_mu1_10000['slope_pow'].values[0]
    Ks = round(-slope,2)
    label = r"$G(r)^{\mu=1}$,$K_G^{\mu=1}$=%.2f"%(Ks,)
    L180_Gmu1_10000, = ax4.plot(df_cicj_Jz180_mu1_10000["r"],df_cicj_Jz180_mu1_10000["corre_abs"],label=label,ls="-",lw=1.5,color="blue",
             marker='^',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="blue", markerfacecolor='None')
    L180_Gmu1_10000_, = ax4.plot(df_cicj_Jz180_mu1_10000["r"],df_cicj_Jz180_mu1_10000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #----------------- plot G(r)^{\mu=3} -------------------------------------------------------------------
    slope = df_cicj_Jz180_mu3_10000['slope_pow'].values[0]
    Ks = round(-slope,2)
    label = r"$G(r)^{\mu=3}$,$K_G^{\mu=3}$=%.2f"%(Ks,)
    L180_Gmu3_10000, = ax4.plot(df_cicj_Jz180_mu3_10000["r"],df_cicj_Jz180_mu3_10000["corre_abs"],label=label,ls="-",lw=1.5,color="olive",
             marker='>',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="olive", markerfacecolor='None')
    L180_Gmu3_10000_, = ax4.plot(df_cicj_Jz180_mu3_10000["r"],df_cicj_Jz180_mu3_10000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #---------------------------------------------------------------------------------------------------------------------
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 14, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L180_pzzmu12_10000,L180_pzzmu23_10000,L180_Gmu1_10000,L180_Gmu3_10000,], 
                       loc = 4, bbox_to_anchor=(0.55, -0.05),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #legend2=plt.legend(handles=[], loc = 4, bbox_to_anchor=(0.65, -0.04),
    #                   ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    ...
    #=========================================================
    ax4.text(25,0.2,"(d)",fontsize = 20, color='black', rotation = 0)
    ax4.text(5,0.2, r'$\mathrm{\delta} = \frac{7}{12}$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax4.text(8,0.2, r'$J_{\bot}=18.0$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax4.text(8,0.1, r'D=10000', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
    ...
    Ks = round(-slope,2)
    label = r"$G(r)^{\mu=1}$,$K_G^{\mu=1}$=%.2f"%(Ks,)
    L210_Gmu1_10000, = ax5.plot(df_cicj_Jz210_mu1_10000["r"],df_cicj_Jz210_mu1_10000["corre_abs"],label=label,ls="-",lw=1.5,color="blue",
             marker='^',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="blue", markerfacecolor='None')
    L210_Gmu1_10000_, = ax5.plot(df_cicj_Jz210_mu1_10000["r"],df_cicj_Jz210_mu1_10000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #----------------- plot G(r)^{\mu=3} -------------------------------------------------------------------
    slope = df_cicj_Jz210_mu3_10000['slope_pow'].values[0]
    Ks = round(-slope,2)
    label = r"$G(r)^{\mu=3}$,$K_G^{\mu=3}$=%.2f"%(Ks,)
    L210_Gmu3_10000, = ax5.plot(df_cicj_Jz210_mu3_10000["r"],df_cicj_Jz210_mu3_10000["corre_abs"],label=label,ls="-",lw=1.5,color="olive",
             marker='>',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="olive", markerfacecolor='None')
    L210_Gmu3_10000_, = ax5.plot(df_cicj_Jz210_mu3_10000["r"],df_cicj_Jz210_mu3_10000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #---------------------------------------------------------------------------------------------------------------------
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 14, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    ...
    #=========================================================
    ax5.text(25,0.1,"(e)",fontsize = 20, color='black', rotation = 0)
    ax5.text(5,0.1, r'$\mathrm{\delta} = \frac{7}{12}$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax5.text(8,0.1, r'$J_{\bot}=21.0$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax5.text(8,0.02, r'D=10000', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
    ...
    #
    df_cicj_Jz240_mu1_10000 = get_data_cicj_layer1(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=24.0,dim=10000)
    df_cicj_Jz240_mu2_10000 = get_data_cicj_layer2(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=24.0,dim=10000)
    df_cicj_Jz240_mu3_10000 = get_data_cicj_layer3(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=24.0,dim=10000)
    #----------------- plot pzz^{12}-----------------------------------------------------------------------
    ...
    L240_pzzmu23_10000_, = ax6.plot(df_pzz_Jz240_mu23_10000["r"],df_pzz_Jz240_mu23_10000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #----------------- plot G(r)^{\mu=1} -------------------------------------------------------------------
    slope = df_cicj_Jz240_mu1_10000['slope_pow'].values[0]
    Ks = round(-slope,2)
    label = r"$G(r)^{\mu=1}$,$K_G^{\mu=1}$=%.2f"%(Ks,)
    L240_Gmu1_10000, = ax6.plot(df_cicj_Jz240_mu1_10000["r"],df_cicj_Jz240_mu1_10000["corre_abs"],label=label,ls="-",lw=1.5,color="blue",
             marker='^',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="blue", markerfacecolor='None')
    L240_Gmu1_10000_, = ax6.plot(df_cicj_Jz240_mu1_10000["r"],df_cicj_Jz240_mu1_10000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #----------------- plot G(r)^{\mu=3} -------------------------------------------------------------------
    slope = df_cicj_Jz240_mu3_10000['slope_pow'].values[0]
    Ks = round(-slope,2)
    label = r"$G(r)^{\mu=3}$,$K_G^{\mu=3}$=%.2f"%(Ks,)
    L240_Gmu3_10000, = ax6.plot(df_cicj_Jz240_mu3_10000["r"],df_cicj_Jz240_mu3_10000["corre_abs"],label=label,ls="-",lw=1.5,color="olive",
             marker='>',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="olive", markerfacecolor='None')
    L240_Gmu3_10000_, = ax6.plot(df_cicj_Jz240_mu3_10000["r"],df_cicj_Jz240_mu3_10000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #---------------------------------------------------------------------------------------------------------------------
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 14, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L240_pzzmu12_10000,L240_pzzmu23_10000,L240_Gmu1_10000,L240_Gmu3_10000,], 
                       loc = 4, bbox_to_anchor=(0.55, -0.05),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #legend2=plt.legend(handles=[], loc = 4, bbox_to_anchor=(0.65, -0.04),
    #                   ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    ...
    #=========================================================
    ax6.text(25,0.1,"(f)",fontsize = 20, color='black', rotation = 0)
    ax6.text(5,0.1, r'$\mathrm{\delta} = \frac{7}{12}$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax6.text(8,0.1, r'$J_{\bot}=24.0$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax6.text(8,0.02, r'D=10000', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
