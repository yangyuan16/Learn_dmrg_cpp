...
if __name__ =="__main__":
    ...
    ax1.text(5,0.03, r'$\mathrm{\delta} = \frac{5}{12}$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ...
    ax2.text(5,0.03, r'$\mathrm{\delta} = \frac{5}{12}$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ...
    ax3.text(5,0.03, r'$\mathrm{\delta} = \frac{5}{12}$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ...
    ax4.text(5,0.03, r'$\mathrm{\delta} = \frac{5}{12}$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ...
    ax5.text(5,0.03, r'$\mathrm{\delta} = \frac{5}{12}$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ...
    ax6.text(5,0.03, r'$\mathrm{\delta} = \frac{5}{12}$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
