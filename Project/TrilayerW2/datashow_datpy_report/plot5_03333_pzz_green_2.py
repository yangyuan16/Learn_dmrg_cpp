...
if __name__ =="__main__":
    ...
    Ks = round(-slope,2)
    label = r"$G(r)^{\mu=1}$,$K_G^{\mu=1}$=%.2f"%(Ks,)
    L240_Gmu1_6000, = ax6.plot(df_cicj_Jz240_mu1_6000["r"],df_cicj_Jz240_mu1_6000["corre_abs"],label=label,ls="-",lw=1.5,color="blue",
             marker='^',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="blue", markerfacecolor='None')
    L240_Gmu1_6000_, = ax6.plot(df_cicj_Jz240_mu1_6000["r"],df_cicj_Jz240_mu1_6000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #----------------- plot G(r)^{\mu=3} -------------------------------------------------------------------
    slope = df_cicj_Jz240_mu3_6000['slope_pow'].values[0]
    Ks = round(-slope,2)
    label = r"$G(r)^{\mu=3}$,$K_G^{\mu=3}$=%.2f"%(Ks,)
    L240_Gmu3_6000, = ax6.plot(df_cicj_Jz240_mu3_6000["r"],df_cicj_Jz240_mu3_6000["corre_abs"],label=label,ls="-",lw=1.5,color="olive",
             marker='>',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="olive", markerfacecolor='None')
    L240_Gmu3_6000_, = ax6.plot(df_cicj_Jz240_mu3_6000["r"],df_cicj_Jz240_mu3_6000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #---------------------------------------------------------------------------------------------------------------------
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 14, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L240_pzzmu12_6000,L240_pzzmu23_6000,L240_Gmu1_6000,L240_Gmu3_6000,], 
                       loc = 4, bbox_to_anchor=(0.55, -0.05),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #legend2=plt.legend(handles=[], loc = 4, bbox_to_anchor=(0.65, -0.04),
    #                   ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
