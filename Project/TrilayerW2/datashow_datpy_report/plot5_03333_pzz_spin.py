...
if __name__ =="__main__":
    ...
    ax1.text(5,0.03, r'$\mathrm{\delta} = \frac{1}{3}$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ...
    ax2.text(5,0.03, r'$\mathrm{\delta} = \frac{1}{3}$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ...
    ax3.text(5,0.03, r'$\mathrm{\delta} = \frac{1}{3}$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ...
    ax4.text(5,0.03, r'$\mathrm{\delta} = \frac{1}{3}$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ...
    df_sisj_Jz240_mu2_6000 = get_data_sisj_layer2(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=24.0,dim=6000)
    df_sisj_Jz240_mu3_6000 = get_data_sisj_layer3(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=24.0,dim=6000)
    #----------------- plot pzz^{12}-----------------------------------------------------------------------
    ...
    Ks = round(-slope,2)
    label = r"$F(r)^{\mu=1}$,$K_F^{\mu=1}$=%.2f"%(Ks,)
    L240_Fmu1_6000, = ax6.plot(df_sisj_Jz240_mu1_6000["r"],df_sisj_Jz240_mu1_6000["corre_abs"],label=label,ls="-",lw=1.5,color="cyan",
             marker='s',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="cyan", markerfacecolor='None')
    L240_Fmu1_6000_, = ax6.plot(df_sisj_Jz240_mu1_6000["r"],df_sisj_Jz240_mu1_6000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #----------------- plot F(r)^{\mu=2} -------------------------------------------------------------------
    slope = df_sisj_Jz240_mu2_6000['slope_pow'].values[0]
    Ks = round(-slope,2)
    label = r"$F(r)^{\mu=2}$,$K_F^{\mu=3}$=%.2f"%(Ks,)
    L240_Fmu2_6000, = ax6.plot(df_sisj_Jz240_mu2_6000["r"],df_sisj_Jz240_mu2_6000["corre_abs"],label=label,ls="-",lw=1.5,color="olive",
             marker='>',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="olive", markerfacecolor='None')
    #L240_Fmu2_6000_, = ax6.plot(df_sisj_Jz240_mu2_6000["r"],df_sisj_Jz240_mu2_6000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
    #         marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #----------------- plot F(r)^{\mu=3} -------------------------------------------------------------------
    slope = df_sisj_Jz240_mu3_6000['slope_pow'].values[0]
    Ks = round(-slope,2)
    label = r"$F(r)^{\mu=3}$,$K_F^{\mu=3}$=%.2f"%(Ks,)
    L240_Fmu3_6000, = ax6.plot(df_sisj_Jz240_mu3_6000["r"],df_sisj_Jz240_mu3_6000["corre_abs"],label=label,ls="-",lw=1.5,color="green",
             marker='>',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="green", markerfacecolor='None')
    #L240_Fmu3_6000_, = ax6.plot(df_sisj_Jz240_mu3_6000["r"],df_sisj_Jz240_mu3_6000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
    #         marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w') 
    #---------------------------------------------------------------------------------------------------------------------
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 14, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L240_pzzmu12_6000,L240_pzzmu23_6000,L240_Fmu1_6000,L240_Fmu2_6000,L240_Fmu3_6000,], 
                       loc = 4, bbox_to_anchor=(0.55, -0.05),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #legend2=plt.legend(handles=[], loc = 4, bbox_to_anchor=(0.65, -0.04),
    #                   ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    ...
    ax6.text(5,0.03, r'$\mathrm{\delta} = \frac{1}{3}$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax6.text(8,0.03, r'$J_{\bot}=24.0$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax6.text(8,0.0001, r'D=6000', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
