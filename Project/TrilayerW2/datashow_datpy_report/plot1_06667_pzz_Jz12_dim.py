...
if __name__ =="__main__":
    ...
    ax1 = plt.gca()
    #
    df_pzz_Jz120_mu12_6000 = get_data_pzz_layer12(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=12.0,dim=6000)
    ...
    Ks = round(-slope,2)  
    label = r"$K_{P_{zz}}^{1,2}$=%.2f, D=%d"%(Ks,6000)
    L120_mu12_6000, = ax1.plot(df_pzz_Jz120_mu12_6000["r"],df_pzz_Jz120_mu12_6000["corre_abs"],label=label,ls="-",lw=1.5,color="red",
             marker='o',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="red", markerfacecolor='None')
    L120_mu12_6000_, = ax1.plot(df_pzz_Jz120_mu12_6000["r"],df_pzz_Jz120_mu12_6000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
    ...
    Ks = round(-slope,2)
    label = r"$K_{P_{zz}}^{1,2}$=%.2f,D=%d"%(Ks,12000)
    L120_mu12_12000, = ax1.plot(df_pzz_Jz120_mu12_12000["r"],df_pzz_Jz120_mu12_12000["corre_abs"],label=label,ls="-",lw=1.5,color="magenta",
             marker='o',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="magenta", markerfacecolor='None')
    L120_mu12_12000_, = ax1.plot(df_pzz_Jz120_mu12_12000["r"],df_pzz_Jz120_mu12_12000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    # 
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 14, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L120_mu12_6000,L120_mu12_12000,], loc = 4, bbox_to_anchor=(0.55, 0.18),
    ...
    ax1.text(8,0.01, r'$\mu^{1,2}$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
    ...
    ax2 = plt.gca()
    #
    df_pzz_Jz120_mu23_6000 = get_data_pzz_layer23(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=12.0,dim=6000)
    ...
    Ks = round(-slope,2)  
    label = r"$K_{P_{zz}}^{2,3}$=%.2f, D=%d"%(Ks,6000)
    L120_mu23_6000, = ax2.plot(df_pzz_Jz120_mu23_6000["r"],df_pzz_Jz120_mu23_6000["corre_abs"],label=label,ls="-",lw=1.5,color="red",
             marker='o',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="red", markerfacecolor='None')
    L120_mu23_6000_, = ax2.plot(df_pzz_Jz120_mu23_6000["r"],df_pzz_Jz120_mu23_6000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #--------- layer 12 dim = 12000
    slope = df_pzz_Jz120_mu23_12000['slope_pow'].values[0]
    Ks = round(-slope,2)
    label = r"$K_{P_{zz}}^{2,3}$=%.2f,D=%d"%(Ks,12000)
    L120_mu23_12000, = ax2.plot(df_pzz_Jz120_mu23_12000["r"],df_pzz_Jz120_mu23_12000["corre_abs"],label=label,ls="-",lw=1.5,color="magenta",
             marker='o',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="magenta", markerfacecolor='None')
    L120_mu23_12000_, = ax2.plot(df_pzz_Jz120_mu23_12000["r"],df_pzz_Jz120_mu23_12000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    # 
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 14, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L120_mu23_6000,L120_mu23_12000,], loc = 4, bbox_to_anchor=(0.55, 0.18),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #legend2=plt.legend(handles=[], loc = 4, bbox_to_anchor=(0.65, -0.04),
    #                   ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #plt.gca().add_artist(legend1)
    ...
    ax2.text(8,0.01, r'$\mu^{2,3}$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
