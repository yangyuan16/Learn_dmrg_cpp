...
if __name__ =="__main__":
    ...
    ax1 = plt.gca()
    df_pzz_Jz90_mu12_8000 = get_data_pzz_layer12(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=9.0,dim=8000)
    df_pzz_Jz90_mu23_8000 = get_data_pzz_layer23(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=9.0,dim=8000)
    #----------------- plot pzz^{12} 8000-----------------------------------------------------------------------
    slope = df_pzz_Jz90_mu12_8000["slope_pow"].values[0]
    Ks = round(-slope,2) 
    label = r"$P_{zz}^{1,2}$, $K_{P_{zz}}^{1,2}$=%.2f, D=8000"%(Ks)
    L90_pzzmu12_8000, = ax1.plot(df_pzz_Jz90_mu12_8000["r"],df_pzz_Jz90_mu12_8000["corre_abs"],label=label,ls="-",lw=1.5,color="red",
             marker='o',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="red", markerfacecolor='None')
    L90_pzzmu12_8000_, = ax1.plot(df_pzz_Jz90_mu12_8000["r"],df_pzz_Jz90_mu12_8000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #----------------- plot pzz^{23} 8000-----------------------------------------------------------------------
    slope = df_pzz_Jz90_mu23_8000["slope_pow"].values[0]
    Ks = round(-slope,2) 
    label = r"$P_{zz}^{2,3}$, $K_{P_{zz}}^{2,3}$=%.2f, D=8000"%(Ks)
    L90_pzzmu23_8000, = ax1.plot(df_pzz_Jz90_mu23_8000["r"],df_pzz_Jz90_mu23_8000["corre_abs"],label=label,ls="-",lw=1.5,color="magenta",
             marker='o',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="magenta", markerfacecolor='None')
    L90_pzzmu23_8000_, = ax1.plot(df_pzz_Jz90_mu23_8000["r"],df_pzz_Jz90_mu23_8000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #---------------------------------------------------------------------------------------------------------------------
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 14, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L90_pzzmu12_8000,L90_pzzmu23_8000,], 
    ...
    ax3 = plt.gca()
    #
    df_pzz_Jz150_mu12_8000 = get_data_pzz_layer12(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=15.0,dim=8000)
    df_pzz_Jz150_mu23_8000 = get_data_pzz_layer23(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=15.0,dim=8000)
    #----------------- plot pzz^{12} D=8000-----------------------------------------------------------------------
    slope = df_pzz_Jz150_mu12_8000["slope_pow"].values[0]
    Ks = round(-slope,2) 
    label = r"$P_{zz}^{1,2}$, $K_{P_{zz}}^{1,2}$=%.2f, D=8000"%(Ks)
    L150_pzzmu12_8000, = ax3.plot(df_pzz_Jz150_mu12_8000["r"],df_pzz_Jz150_mu12_8000["corre_abs"],label=label,ls="-",lw=1.5,color="red",
             marker='o',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="red", markerfacecolor='None')
    L150_pzzmu12_8000_, = ax3.plot(df_pzz_Jz150_mu12_8000["r"],df_pzz_Jz150_mu12_8000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #----------------- plot pzz^{23} D=8000-----------------------------------------------------------------------
    slope = df_pzz_Jz150_mu23_8000["slope_pow"].values[0]
    Ks = round(-slope,2) 
    label = r"$P_{zz}^{2,3}$, $K_{P_{zz}}^{2,3}$=%.2f, D=8000"%(Ks)
    L150_pzzmu23_8000, = ax3.plot(df_pzz_Jz150_mu23_8000["r"],df_pzz_Jz150_mu23_8000["corre_abs"],label=label,ls="-",lw=1.5,color="magenta",
             marker='o',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="magenta", markerfacecolor='None')
    L150_pzzmu23_8000_, = ax3.plot(df_pzz_Jz150_mu23_8000["r"],df_pzz_Jz150_mu23_8000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #---------------------------------------------------------------------------------------------------------------------
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 14, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L150_pzzmu12_8000,L150_pzzmu23_8000,], 
                       loc = 4, bbox_to_anchor=(0.65, -0.05),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #legend2=plt.legend(handles=[], loc = 4, bbox_to_anchor=(0.65, -0.04),
    #                   ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    ...
    ax5 = plt.gca()
    #
    df_pzz_Jz210_mu12_8000 = get_data_pzz_layer12(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=21.0,dim=8000)
    df_pzz_Jz210_mu23_8000 = get_data_pzz_layer23(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=21.0,dim=8000)
    #----------------- plot pzz^{12} D=8000-----------------------------------------------------------------------
    slope = df_pzz_Jz210_mu12_8000["slope_pow"].values[0]
    Ks = round(-slope,2) 
    label = r"$P_{zz}^{1,2}$, $K_{P_{zz}}^{1,2}$=%.2f, D=8000"%(Ks)
    L210_pzzmu12_8000, = ax5.plot(df_pzz_Jz210_mu12_8000["r"],df_pzz_Jz210_mu12_8000["corre_abs"],label=label,ls="-",lw=1.5,color="red",
             marker='o',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="red", markerfacecolor='None')
    L210_pzzmu12_8000_, = ax5.plot(df_pzz_Jz210_mu12_8000["r"],df_pzz_Jz210_mu12_8000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #----------------- plot pzz^{23} D=8000-----------------------------------------------------------------------
    slope = df_pzz_Jz210_mu23_8000["slope_pow"].values[0]
    Ks = round(-slope,2) 
    label = r"$P_{zz}^{2,3}$, $K_{P_{zz}}^{2,3}$=%.2f, D=8000"%(Ks)
    L210_pzzmu23_8000, = ax5.plot(df_pzz_Jz210_mu23_8000["r"],df_pzz_Jz210_mu23_8000["corre_abs"],label=label,ls="-",lw=1.5,color="magenta",
             marker='o',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="magenta", markerfacecolor='None')
    L210_pzzmu23_8000_, = ax5.plot(df_pzz_Jz210_mu23_8000["r"],df_pzz_Jz210_mu23_8000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #---------------------------------------------------------------------------------------------------------------------
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 14, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L210_pzzmu12_8000,L210_pzzmu23_8000,], 
                       loc = 4, bbox_to_anchor=(0.65, -0.05),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #legend2=plt.legend(handles=[], loc = 4, bbox_to_anchor=(0.65, -0.04),
    #                   ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
