...
if __name__ =="__main__":
    ...
    ax1 = plt.gca()
    #
    df_sisj_Jz10_mu1 = get_data_sisj_layer1(Lz=Lz,Ly=Ly,Lx=Lx,dop=108,t=t,J=J,Jz=0.50,dim=12000)
    df_sisj_Jz10_mu2 = get_data_sisj_layer2(Lz=Lz,Ly=Ly,Lx=Lx,dop=108,t=t,J=J,Jz=0.50,dim=12000)
    df_sisj_Jz10_mu3 = get_data_sisj_layer3(Lz=Lz,Ly=Ly,Lx=Lx,dop=108,t=t,J=J,Jz=0.50,dim=12000)
    ...
    ax1.text(3,1.8e-2, r'$\mathrm{\delta} = 0.375$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax1.text(8,1.8e-2, r'$J_{\bot}=0.5$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax1.text(8,0.4e-2, r'$D=12000$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
    ...
    ax2 = plt.gca()
    #
    df_sisj_Jz40_mu1 = get_data_sisj_layer1(Lz=Lz,Ly=Ly,Lx=Lx,dop=108,t=t,J=J,Jz=4.0,dim=12000)
    df_sisj_Jz40_mu2 = get_data_sisj_layer2(Lz=Lz,Ly=Ly,Lx=Lx,dop=108,t=t,J=J,Jz=4.0,dim=12000)
    df_sisj_Jz40_mu3 = get_data_sisj_layer3(Lz=Lz,Ly=Ly,Lx=Lx,dop=108,t=t,J=J,Jz=4.0,dim=12000)
    #--------- layer 1
    ...
    ax2.text(3,1.8e-2, r'$\mathrm{\delta} = 0.375$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax2.text(8,1.8e-2, r'$J_{\bot}=4.0$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax2.text(8,0.4e-2, r'$D=12000$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
    ...
    ax3 = plt.gca()
    #
    df_sisj_Jz80_mu1 = get_data_sisj_layer1(Lz=Lz,Ly=Ly,Lx=Lx,dop=108,t=t,J=J,Jz=8.0,dim=12000)
    df_sisj_Jz80_mu2 = get_data_sisj_layer2(Lz=Lz,Ly=Ly,Lx=Lx,dop=108,t=t,J=J,Jz=8.0,dim=12000)
    df_sisj_Jz80_mu3 = get_data_sisj_layer3(Lz=Lz,Ly=Ly,Lx=Lx,dop=108,t=t,J=J,Jz=8.0,dim=12000)
    #--------- layer 1
    ...
    ax3.text(3,1.8e-2, r'$\mathrm{\delta} = 0.375$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax3.text(8,1.8e-2, r'$J_{\bot}=8.0$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax3.text(8,0.3e-2, r'$D=12000$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
    ...
    ax4 = plt.gca()
    #
    df_sisj_Jz120_mu1 = get_data_sisj_layer1(Lz=Lz,Ly=Ly,Lx=Lx,dop=108,t=t,J=J,Jz=12.0,dim=14000)
    df_sisj_Jz120_mu2 = get_data_sisj_layer2(Lz=Lz,Ly=Ly,Lx=Lx,dop=108,t=t,J=J,Jz=12.0,dim=14000)
    df_sisj_Jz120_mu3 = get_data_sisj_layer3(Lz=Lz,Ly=Ly,Lx=Lx,dop=108,t=t,J=J,Jz=12.0,dim=14000)
    #--------- layer 1
    ...
    ax4.text(3,0.8e-2, r'$\mathrm{\delta} = 0.375$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax4.text(8,0.8e-2, r'$J_{\bot}=12.0$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax4.text(8,0.3e-2, r'$D=14000$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
    ...
    ax5 = plt.gca()
    #
    df_sisj_Jz240_mu1 = get_data_sisj_layer1(Lz=Lz,Ly=Ly,Lx=Lx,dop=108,t=t,J=J,Jz=24.0,dim=6000)
    df_sisj_Jz240_mu2 = get_data_sisj_layer2(Lz=Lz,Ly=Ly,Lx=Lx,dop=108,t=t,J=J,Jz=24.0,dim=6000)
    df_sisj_Jz240_mu3 = get_data_sisj_layer3(Lz=Lz,Ly=Ly,Lx=Lx,dop=108,t=t,J=J,Jz=24.0,dim=6000)
    #--------- layer 1
    ...
    #
    #=========================================================
    ax5.text(31,1e-8,"(e)",fontsize = 20, color='black', rotation = 0)
    ax5.text(1,1e-6, r'$\mathrm{\delta} = 0.375$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax5.text(1,0.3e-6, r'$J_{\bot}=24.0$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax5.text(1,1e-7, r'$D=6000$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
    ...
    #plt.savefig("E:\\WORK\\Work\\Project\\TrilayerW2-tj-Jz-openz\\datashow_datpy_report\\figs\\fig_03750_spin.eps",
