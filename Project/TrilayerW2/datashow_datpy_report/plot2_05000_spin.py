...
if __name__ =="__main__":
    ...
    ax1 = plt.gca()
    #
    df_sisj_Jz10_mu1 = get_data_sisj_layer1(Lz=Lz,Ly=Ly,Lx=Lx,dop=144,t=t,J=J,Jz=1.0,dim=6000)
    df_sisj_Jz10_mu2 = get_data_sisj_layer2(Lz=Lz,Ly=Ly,Lx=Lx,dop=144,t=t,J=J,Jz=1.0,dim=6000)
    df_sisj_Jz10_mu3 = get_data_sisj_layer3(Lz=Lz,Ly=Ly,Lx=Lx,dop=144,t=t,J=J,Jz=1.0,dim=6000)
    ...
    ax1.text(4, 5e-2, r'$\mathrm{\delta} = 0.5$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax1.text(8, 5e-2, r'$J_{\bot}=1.0$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax1.text(8, 2e-2, r'$D=6000$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
    ...
    ax2 = plt.gca()
    #
    df_sisj_Jz40_mu1 = get_data_sisj_layer1(Lz=Lz,Ly=Ly,Lx=Lx,dop=144,t=t,J=J,Jz=4.0,dim=6000)
    df_sisj_Jz40_mu2 = get_data_sisj_layer2(Lz=Lz,Ly=Ly,Lx=Lx,dop=144,t=t,J=J,Jz=4.0,dim=6000)
    df_sisj_Jz40_mu3 = get_data_sisj_layer3(Lz=Lz,Ly=Ly,Lx=Lx,dop=144,t=t,J=J,Jz=4.0,dim=6000)
    #--------- layer 1
    ...
    ax3 = plt.gca()
    #
    df_sisj_Jz80_mu1 = get_data_sisj_layer1(Lz=Lz,Ly=Ly,Lx=Lx,dop=144,t=t,J=J,Jz=8.0,dim=10000)
    df_sisj_Jz80_mu2 = get_data_sisj_layer2(Lz=Lz,Ly=Ly,Lx=Lx,dop=144,t=t,J=J,Jz=8.0,dim=10000)
    df_sisj_Jz80_mu3 = get_data_sisj_layer3(Lz=Lz,Ly=Ly,Lx=Lx,dop=144,t=t,J=J,Jz=8.0,dim=10000)
    #--------- layer 1
    ...
    ax3.text(4,2e-2, r'$\mathrm{\delta} = 0.5$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax3.text(8,2e-2, r'$J_{\bot}=8.0$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax3.text(8,0.3e-2, r'$D=10000$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
    ...
    ax4 = plt.gca()
    #
    df_sisj_Jz120_mu1 = get_data_sisj_layer1(Lz=Lz,Ly=Ly,Lx=Lx,dop=144,t=t,J=J,Jz=10.0,dim=8000)
    df_sisj_Jz120_mu2 = get_data_sisj_layer2(Lz=Lz,Ly=Ly,Lx=Lx,dop=144,t=t,J=J,Jz=10.0,dim=8000)
    df_sisj_Jz120_mu3 = get_data_sisj_layer3(Lz=Lz,Ly=Ly,Lx=Lx,dop=144,t=t,J=J,Jz=10.0,dim=8000)
    #--------- layer 1
    ...
    ax4.text(4,0.8e-2, r'$\mathrm{\delta} = 0.5$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax4.text(8,0.8e-2, r'$J_{\bot}=10.0$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax4.text(8,0.3e-2, r'$D=8000$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
    ...
    ax5 = plt.gca()
    #
    df_sisj_Jz240_mu1 = get_data_sisj_layer1(Lz=Lz,Ly=Ly,Lx=Lx,dop=144,t=t,J=J,Jz=12.0,dim=14000)
    df_sisj_Jz240_mu2 = get_data_sisj_layer2(Lz=Lz,Ly=Ly,Lx=Lx,dop=144,t=t,J=J,Jz=12.0,dim=14000)
    df_sisj_Jz240_mu3 = get_data_sisj_layer3(Lz=Lz,Ly=Ly,Lx=Lx,dop=144,t=t,J=J,Jz=12.0,dim=14000)
    #--------- layer 1
    ...
    #
    #=========================================================
    ax5.text(31,1e-7,"(e)",fontsize = 20, color='black', rotation = 0)
    ax5.text(1,0.1e-3, r'$\mathrm{\delta} = 0.5$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax5.text(1,0.1e-4, r'$J_{\bot}=12.0$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax5.text(1,0.1e-5, r'$D=14000$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
    ...
    ax6 = plt.gca()
    #
    df_sisj_Jz480_mu1 = get_data_sisj_layer1(Lz=Lz,Ly=Ly,Lx=Lx,dop=144,t=t,J=J,Jz=24.0,dim=6000)
    df_sisj_Jz480_mu2 = get_data_sisj_layer2(Lz=Lz,Ly=Ly,Lx=Lx,dop=144,t=t,J=J,Jz=24.0,dim=6000)
    df_sisj_Jz480_mu3 = get_data_sisj_layer3(Lz=Lz,Ly=Ly,Lx=Lx,dop=144,t=t,J=J,Jz=24.0,dim=6000)
    #--------- layer 1
    ...
    # 
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 14, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L480_mu1,L480_mu2,L480_mu3], loc = 4, bbox_to_anchor=(0.9, 0.5),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #legend2=plt.legend(handles=[], loc = 4, bbox_to_anchor=(0.65, -0.04),
    #                   ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #plt.gca().add_artist(legend1)
    ...
    #
    #=========================================================
    ax6.text(31,5e-3,"(f)",fontsize = 20, color='black', rotation = 0)
    ax6.text(11,5e-3, r'$\mathrm{\delta} = 0.5$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax6.text(18,5e-3, r'$J_{\bot} = 24.0$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax6.text(18,0.8e-3, r'$D = 6000$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
    ...
    #plt.savefig("E:\\WORK\\Work\\Project\\TrilayerW2-tj-Jz-openz\\datashow_datpy_report\\figs\\fig_05000_spin.eps",
