...
if __name__ =="__main__":
    ...
    #
    L, =ax1.plot([0,50],[0.3333,0.3333],label=" ",ls="--",lw=1.5,color="k",
    ...
    legend1=plt.legend(handles=[L10_mu1,L10_mu2,L10_mu3], loc = 4, bbox_to_anchor=(0.96, 0.11),
    ...
    #=========================================================
    ax1.text(4,0.36,"(a)",fontsize = 20, color='black', rotation = 0)
    ax1.text(10,0.355, r'$\mathrm{J_{\bot}} = 1.0$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax1.text(25,0.355, r'$\mathrm{\delta} = \frac{2}{3}$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=======================================================================================
    # 坐标轴设置第一层
    ...
    #
    L, =ax2.plot([0,50],[0.3333,0.3333],label=" ",ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=1.5, markeredgecolor="red", markerfacecolor='None')
    ...
    #=========================================================
    ax2.text(4,0.35,"(b)",fontsize = 20, color='black', rotation = 0)
    ax2.text(10,0.345, r'$\mathrm{J_{\bot}} = 4.0$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax2.text(25,0.345, r'$\mathrm{\delta} = \frac{2}{3}$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=======================================================================================
    # 坐标轴设置第一层
    ...
    ax3 = plt.gca()
    df_ni_Jz80 = get_data_ni(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=8.0,dim=dim)
    #
    L, =ax3.plot([0,50],[0.3333,0.3333],label=" ",ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=1.5, markeredgecolor="red", markerfacecolor='None')
    ...
    #=========================================================
    ax3.text(4,0.272,"(c)",fontsize = 20, color='black', rotation = 0)
    ax3.text(10,0.29, r'$\mathrm{J_{\bot}} = 8.0$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax3.text(25,0.29, r'$\mathrm{\delta} = \frac{2}{3}$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=======================================================================================
    # 坐标轴设置第一层
    ...
    ax4 = plt.gca()
    df_ni_Jz120 = get_data_ni(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=12.0,dim=dim)
    #
    L, =ax4.plot([0,50],[0.3333,0.3333],label=" ",ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=1.5, markeredgecolor="red", markerfacecolor='None')
    ...
    ####图例设置
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 16, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L120_mu1,L120_mu2,L120_mu3], loc = 4, bbox_to_anchor=(0.96, 0.06),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)    
    #legend2=plt.legend(handles=[L04g,L10g,L20g], loc = 4, bbox_to_anchor=(0.64, 0.02),
    #                   ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #plt.gca().add_artist(legend1)#####把图例legend1重新加载回来
    ...
    #=========================================================
    ax4.text(4,0.241,"(d)",fontsize = 20, color='black', rotation = 0)
    ax4.text(10,0.28, r'$\mathrm{J_{\bot}} = 12.0$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax4.text(25,0.28, r'$\mathrm{\delta} = \frac{2}{3}$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=======================================================================================
    # 坐标轴设置第一层
    ...
    ax5 = plt.gca()
    df_ni_Jz240 = get_data_ni(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=24.0,dim=dim)
    #
    L, =ax5.plot([0,50],[0.3333,0.3333],label=" ",ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=1.5, markeredgecolor="red", markerfacecolor='None')
    ...
    ####图例设置
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 16, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L240_mu1,L240_mu2,L240_mu3], loc = 4, bbox_to_anchor=(0.96, 0.01),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)    
    #legend2=plt.legend(handles=[L04g,L10g,L20g], loc = 4, bbox_to_anchor=(0.64, 0.02),
    #                   ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #plt.gca().add_artist(legend1)#####把图例legend1重新加载回来
    ...
    #=========================================================
    ax5.text(4,0.125,"(e)",fontsize = 20, color='black', rotation = 0)
    ax5.text(10,0.20, r'$\mathrm{J_{\bot}} = 24.0$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax5.text(25,0.20, r'$\mathrm{\delta} = \frac{2}{3}$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=======================================================================================
    # 坐标轴设置第一层
    ...
    ax6 = plt.gca()
    df_ni_Jz480 = get_data_ni(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=48.0,dim=dim)
    #
    L, =ax6.plot([0,50],[0.3333,0.3333],label=" ",ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=1.5, markeredgecolor="red", markerfacecolor='None')
    ...
    ####图例设置
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 16, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L480_mu1,L480_mu2,L480_mu3], loc = 4, bbox_to_anchor=(0.96, 0.4),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)    
    #legend2=plt.legend(handles=[L04g,L10g,L20g], loc = 4, bbox_to_anchor=(0.64, 0.02),
    #                   ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #plt.gca().add_artist(legend1)#####把图例legend1重新加载回来
    ...
    #=========================================================
    ax6.text(4,0.13,"(f)",fontsize = 20, color='black', rotation = 0)
    ax6.text(10,0.40, r'$\mathrm{J_{\bot}} = 48.0$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax6.text(25,0.40, r'$\mathrm{\delta} = \frac{2}{3}$', fontsize = 18, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=======================================================================================
    # 坐标轴设置第一层
    ...
    #plt.savefig("E:\\WORK\\Work\\Project\\TrilayerW2-tj-Jz-openz\\datashow_datpy_report\\figs\\fig_06667_ni.eps",
