...
if __name__ =="__main__":
    ...
    Ks = round(-slope,2)
    label = r"$\delta=0.375,K_{P_{zz}}^{2,3}$=%.2f,D=%d"%(Ks,14000)
    ...
    L0375_120_mu23_, = ax2.plot(df_pzz_0375_Jz120_mu23["r"],df_pzz_0375_Jz120_mu23["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #--------------------------------------------------------------------------------------
    ...
    Ks = round(-slope,2)
    label = r"$\delta=0.5,K_{P_{zz}}^{2,3}$=%.2f,D=%d"%(Ks,14000)
    ...
    L05_120_mu23_, = ax2.plot(df_pzz_05_Jz120_mu23["r"],df_pzz_05_Jz120_mu23["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='^',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #-------------------------------------------------------------------------------------------
    ...
    L0667_120_mu23_, = ax2.plot(df_pzz_0667_Jz120_mu23["r"],df_pzz_0667_Jz120_mu23["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='s',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #-------------------------------------------------------------------------------------------
    ####图例设置
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 15, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L0375_120_mu23,L05_120_mu23,L0667_120_mu23], 
