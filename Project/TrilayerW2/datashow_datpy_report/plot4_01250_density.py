...
if __name__ =="__main__":
    ...
    ax1 = plt.gca()
    #
    df_ninj_Jz10_mu1 = get_data_ninj_corre_layer1(Lz=Lz,Ly=Ly,Lx=Lx,dop=36,t=t,J=J,Jz=1.0,dim=10000)
    df_ninj_Jz10_mu2 = get_data_ninj_corre_layer2(Lz=Lz,Ly=Ly,Lx=Lx,dop=36,t=t,J=J,Jz=1.0,dim=10000)
    df_ninj_Jz10_mu3 = get_data_ninj_corre_layer3(Lz=Lz,Ly=Ly,Lx=Lx,dop=36,t=t,J=J,Jz=1.0,dim=10000)
    #--------- layer 1
    ...
    #
    #=========================================================
    ax1.text(25,0.08,"(a)",fontsize = 20, color='black', rotation = 0)
    ax1.text(3,0.08, r'$\mathrm{\delta} = 0.125$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax1.text(8,0.08, r'$J_{\bot}=1.0$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax1.text(8,0.02, r'$D=10000$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
    ...
    ax2 = plt.gca()
    #
    df_ninj_Jz40_mu1 = get_data_ninj_corre_layer1(Lz=Lz,Ly=Ly,Lx=Lx,dop=36,t=t,J=J,Jz=4.0,dim=8000)
    df_ninj_Jz40_mu2 = get_data_ninj_corre_layer2(Lz=Lz,Ly=Ly,Lx=Lx,dop=36,t=t,J=J,Jz=4.0,dim=8000)
    df_ninj_Jz40_mu3 = get_data_ninj_corre_layer3(Lz=Lz,Ly=Ly,Lx=Lx,dop=36,t=t,J=J,Jz=4.0,dim=8000)
    #--------- layer 1
    ...
    ax2.text(3,0.03, r'$\mathrm{\delta} = 0.125$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax2.text(8,0.03, r'$J_{\bot}=4.0$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax2.text(8,0.01, r'$D=8000$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
    ...
    ax3 = plt.gca()
    #
    df_ninj_Jz80_mu1 = get_data_ninj_corre_layer1(Lz=Lz,Ly=Ly,Lx=Lx,dop=36,t=t,J=J,Jz=8.0,dim=6000)
    df_ninj_Jz80_mu2 = get_data_ninj_corre_layer2(Lz=Lz,Ly=Ly,Lx=Lx,dop=36,t=t,J=J,Jz=8.0,dim=6000)
    df_ninj_Jz80_mu3 = get_data_ninj_corre_layer3(Lz=Lz,Ly=Ly,Lx=Lx,dop=36,t=t,J=J,Jz=8.0,dim=6000)
    #--------- layer 1
    ...
    #
    #=========================================================
    ax3.text(25,0.02,"(c)",fontsize = 20, color='black', rotation = 0)
    ax3.text(3,0.02, r'$\mathrm{\delta} = 0.125$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax3.text(8,0.02, r'$J_{\bot}=8.0$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ...
    ax4 = plt.gca()
    #
    df_ninj_Jz120_mu1 = get_data_ninj_corre_layer1(Lz=Lz,Ly=Ly,Lx=Lx,dop=36,t=t,J=J,Jz=12.0,dim=8000)
    df_ninj_Jz120_mu2 = get_data_ninj_corre_layer2(Lz=Lz,Ly=Ly,Lx=Lx,dop=36,t=t,J=J,Jz=12.0,dim=8000)
    df_ninj_Jz120_mu3 = get_data_ninj_corre_layer3(Lz=Lz,Ly=Ly,Lx=Lx,dop=36,t=t,J=J,Jz=12.0,dim=8000)
    #--------- layer 1
    ...
    ax4.text(3,0.03, r'$\mathrm{\delta} = 0.125$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ...
    ax5 = plt.gca()
    #
    df_ninj_Jz240_mu1 = get_data_ninj_corre_layer1(Lz=Lz,Ly=Ly,Lx=Lx,dop=36,t=t,J=J,Jz=24.0,dim=6000)
    df_ninj_Jz240_mu2 = get_data_ninj_corre_layer2(Lz=Lz,Ly=Ly,Lx=Lx,dop=36,t=t,J=J,Jz=24.0,dim=6000)
    df_ninj_Jz240_mu3 = get_data_ninj_corre_layer3(Lz=Lz,Ly=Ly,Lx=Lx,dop=36,t=t,J=J,Jz=24.0,dim=6000)
    #--------- layer 1
    ...
    #
    #=========================================================
    ax5.text(25,0.015,"(e)",fontsize = 20, color='black', rotation = 0)
    ax5.text(3,0.015, r'$\mathrm{\delta} = 0.125$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax5.text(8,0.015, r'$J_{\bot}=24.0$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax5.text(8,0.007, r'$D=6000$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
    ...
    #plt.savefig("E:\\WORK\\Work\\Project\\TrilayerW2-tj-Jz-openz\\datashow_datpy_report\\figs\\fig_01250_density.eps",
