...
if __name__ =="__main__":
    ...
    ax1 = plt.gca()
    #
    df_sisj_Jz10_mu1 = get_data_sisj_layer1(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=1.0,dim=dim)
    df_sisj_Jz10_mu2 = get_data_sisj_layer2(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=1.0,dim=dim)
    df_sisj_Jz10_mu3 = get_data_sisj_layer3(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=1.0,dim=dim)
    #df_sisj_Jz20 = get_data_sisj(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=2.0,dim=dim)
    #--------- layer 1
    slope = df_sisj_Jz10_mu1["slope_pow"].values[0]
    Ks = round(-slope,2)  
    ...
    L10_mu1_, = ax1.plot(df_sisj_Jz10_mu1["r"],df_sisj_Jz10_mu1["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #--------- layer 2
    slope = df_sisj_Jz10_mu2['slope_pow'].values[0]
    Ks = round(-slope,2)
    label = r"$\mu=2$"
    ...
    #L10_mu2_, = ax1.plot(df_sisj_Jz10_mu2["r"],df_sisj_Jz10_mu2["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
    #         marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #--------- layer 3
    slope = df_sisj_Jz10_mu3['slope_pow'].values[0]
    Ks = round(-slope,2)
    label = r"$\mu=3$"
    ...
    #L10_mu3_, = ax1.plot(df_sisj_Jz10_mu3["r"],df_sisj_Jz10_mu3["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
    #         marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    # 
    ...
    #
    #=========================================================
    ax1.text(25,0.02,"(a)",fontsize = 20, color='black', rotation = 0)
    ax1.text(4,0.8e-2, r'$\mathrm{\delta} = \frac{2}{3}$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax1.text(8,0.8e-2, r'$J_{\bot}=1.0$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax1.text(8,0.4e-2, r'$D=6000$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
    ...
    ax2 = plt.gca()
    #
    df_sisj_Jz40_mu1 = get_data_sisj_layer1(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=4.0,dim=dim)
    df_sisj_Jz40_mu2 = get_data_sisj_layer2(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=4.0,dim=dim)
    df_sisj_Jz40_mu3 = get_data_sisj_layer3(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=4.0,dim=dim)
    #--------- layer 1
    ...
    ax2.text(4,0.8e-2, r'$\mathrm{\delta} = \frac{2}{3}$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax2.text(8,0.8e-2, r'$J_{\bot}=4.0$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax2.text(8,0.4e-2, r'$D=6000$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
    ...
    ax3 = plt.gca()
    #
    df_sisj_Jz80_mu1 = get_data_sisj_layer1(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=8.0,dim=dim)
    df_sisj_Jz80_mu2 = get_data_sisj_layer2(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=8.0,dim=dim)
    df_sisj_Jz80_mu3 = get_data_sisj_layer3(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=8.0,dim=dim)
    #--------- layer 1
    ...
    # 
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 14, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L80_mu1,L80_mu2,L80_mu3], loc = 4, bbox_to_anchor=(0.5, 0.2),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #legend2=plt.legend(handles=[], loc = 4, bbox_to_anchor=(0.65, -0.04),
    #                   ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #plt.gca().add_artist(legend1)
    ...
    #
    #=========================================================
    ax3.text(25,0.008,"(c)",fontsize = 20, color='black', rotation = 0)
    ax3.text(4,0.8e-2, r'$\mathrm{\delta} = \frac{2}{3}$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax3.text(8,0.8e-2, r'$J_{\bot}=8.0$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax3.text(8,0.3e-2, r'$D=6000$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
    ...
    ax4 = plt.gca()
    #
    df_sisj_Jz120_mu1 = get_data_sisj_layer1(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=12.0,dim=dim)
    df_sisj_Jz120_mu2 = get_data_sisj_layer2(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=12.0,dim=dim)
    df_sisj_Jz120_mu3 = get_data_sisj_layer3(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=12.0,dim=dim)
    #--------- layer 1
    ...
    #
    #=========================================================
    ax4.text(25,0.008,"(d)",fontsize = 20, color='black', rotation = 0)
    ax4.text(4,0.8e-2, r'$\mathrm{\delta} = \frac{2}{3}$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax4.text(8,0.8e-2, r'$J_{\bot}=12.0$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax4.text(8,0.3e-2, r'$D=6000$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
    ...
    ax5 = plt.gca()
    #
    df_sisj_Jz240_mu1 = get_data_sisj_layer1(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=24.0,dim=dim)
    df_sisj_Jz240_mu2 = get_data_sisj_layer2(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=24.0,dim=dim)
    df_sisj_Jz240_mu3 = get_data_sisj_layer3(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=24.0,dim=dim)
    #--------- layer 1
    slope = df_sisj_Jz240_mu1["slope_exp"].values[0]
    Ks = round(-1/slope,2)  
    label = r"$\mu=1$, $\xi_F$=%.2f"%(Ks)
    L240_mu1, = ax5.plot(df_sisj_Jz240_mu1["r"],df_sisj_Jz240_mu1["corre_abs"],label=label,ls="-",lw=1.5,color="red",
             marker='o',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="red", markerfacecolor='None')
    L240_mu1_, = ax5.plot(df_sisj_Jz240_mu1["r"],df_sisj_Jz240_mu1["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #--------- layer 2
    slope = df_sisj_Jz240_mu2['slope_exp'].values[0]
    Ks = round(-1/slope,2)
    label = r"$\mu=2$"
    L240_mu2, = ax5.plot(df_sisj_Jz240_mu2["r"],df_sisj_Jz240_mu2["corre_abs"],label=label,ls="-",lw=1.5,color="blue",
             marker='o',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="blue", markerfacecolor='None')
    #L240_mu2_, = ax5.plot(df_sisj_Jz240_mu2["r"],df_sisj_Jz240_mu2["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
    #         marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #--------- layer 3
    slope = df_sisj_Jz240_mu3['slope_exp'].values[0]
    Ks = round(-1/slope,2)
    label = r"$\mu=3$"
    L240_mu3, = ax5.plot(df_sisj_Jz240_mu3["r"],df_sisj_Jz240_mu3["corre_abs"],label=label,ls="-",lw=1.5,color="magenta",
             marker='o',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="magenta", markerfacecolor='None')
    #L240_mu3_, = ax5.plot(df_sisj_Jz240_mu3["r"],df_sisj_Jz240_mu3["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
    #         marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    # 
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 14, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    ...
    #
    #=========================================================
    ax5.text(31,0.5e-7,"(e)",fontsize = 20, color='black', rotation = 0)
    ax5.text(1,0.1e-3, r'$\mathrm{\delta} = \frac{2}{3}$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax5.text(1,0.1e-4, r'$J_{\bot}=24.0$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax5.text(1,0.1e-5, r'$D=6000$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
    ...
    ax6 = plt.gca()
    #
    df_sisj_Jz480_mu1 = get_data_sisj_layer1(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=48.0,dim=dim)
    df_sisj_Jz480_mu2 = get_data_sisj_layer2(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=48.0,dim=dim)
    df_sisj_Jz480_mu3 = get_data_sisj_layer3(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=48.0,dim=dim)
    #--------- layer 1
    slope = df_sisj_Jz480_mu1["slope_exp"].values[0]
    Ks = round(-1/slope,2)  
    label = r"$\mu=1$, $\xi_F$=%.2f"%(Ks)
    L480_mu1, = ax6.plot(df_sisj_Jz480_mu1["r"],df_sisj_Jz480_mu1["corre_abs"],label=label,ls="-",lw=1.5,color="red",
             marker='o',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="red", markerfacecolor='None')
    L480_mu1_, = ax6.plot(df_sisj_Jz480_mu1["r"],df_sisj_Jz480_mu1["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #--------- layer 2
    slope = df_sisj_Jz480_mu2['slope_exp'].values[0]
    Ks = round(-1/slope,2)
    label = r"$\mu=2$"
    L480_mu2, = ax6.plot(df_sisj_Jz480_mu2["r"],df_sisj_Jz480_mu2["corre_abs"],label=label,ls="-",lw=1.5,color="blue",
             marker='o',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="blue", markerfacecolor='None')
    #L480_mu2_, = ax6.plot(df_sisj_Jz480_mu2["r"],df_sisj_Jz480_mu2["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
    #         marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #--------- layer 3
    slope = df_sisj_Jz480_mu3['slope_exp'].values[0]
    Ks = round(-1/slope,2)
    label = r"$\mu=3$"
    L480_mu3, = ax6.plot(df_sisj_Jz480_mu3["r"],df_sisj_Jz480_mu3["corre_abs"],label=label,ls="-",lw=1.5,color="magenta",
             marker='o',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="magenta", markerfacecolor='None')
    #L480_mu3_, = ax6.plot(df_sisj_Jz480_mu3["r"],df_sisj_Jz480_mu3["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
    #         marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    # 
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 14, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    ...
    #
    #=========================================================
    ax6.text(31,1e-7,"(f)",fontsize = 20, color='black', rotation = 0)
    ax6.text(11,1e-7, r'$\mathrm{\delta} = \frac{2}{3}$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax6.text(18,1e-7, r'$J_{\bot}=48.0$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax6.text(18,1e-10, r'$D=6000$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
    ...
    #------------------------------------------------------------------------------------------------
    # plot ax6_sub
    sign_matrix_480 = get_sign_value_matrix(df_layer1=df_sisj_Jz480_mu1,df_layer2=df_sisj_Jz480_mu2,df_layer3=df_sisj_Jz480_mu3)
    ...
    cbar.ax.tick_params(size=0, labelsize=14)  # no tick lines, set label font size=14
    ax6_sub.set_title("Sign of $F(r)$")
    #-------------------------------------------------------------------------------------------------
    #fig.tight_layout() # 自动调整 subplot 间的间隙参数
    #plt.savefig("E:\\WORK\\Work\\Project\\TrilayerW2-tj-Jz-openz\\datashow_datpy_report\\figs\\fig_06667_spin.eps",
