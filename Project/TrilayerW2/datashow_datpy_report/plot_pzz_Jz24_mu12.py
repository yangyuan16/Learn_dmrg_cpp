...
if __name__ =="__main__":
    ...
    #
    #--------- layer 12  J_\bot = 24.0, delta = 0.3750
    slope = df_pzz_0375_Jz240_mu12["slope_pow"].values[0]
    Ks = round(-slope,2)  
    label = r"$\delta=0.375,K_{P_{zz}}^{1,2}$=%.2f,D=%d"%(Ks,6000)
    L0375_240_mu12, = ax2.plot(df_pzz_0375_Jz240_mu12["r"],df_pzz_0375_Jz240_mu12["corre_abs"],label=label,ls="-",lw=1.5,color="red",
             marker='o',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="red", markerfacecolor='None')
    L0375_240_mu12_, = ax2.plot(df_pzz_0375_Jz240_mu12["r"],df_pzz_0375_Jz240_mu12["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
    ...
    #--------------------------------------------------------------------------------------
    #--------- layer 12  J_\bot = 24.0, delta = 0.50
    slope = df_pzz_05_Jz240_mu12["slope_pow"].values[0]
    Ks = round(-slope,2)  
    label = r"$\delta=0.5,K_{P_{zz}}^{1,2}$=%.2f,D=%d"%(Ks,6000)
    L05_240_mu12, = ax2.plot(df_pzz_05_Jz240_mu12["r"],df_pzz_05_Jz240_mu12["corre_abs"],label=label,ls="-",lw=1.5,color="blue",
             marker='^',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="blue", markerfacecolor='None')
    L05_240_mu12_, = ax2.plot(df_pzz_05_Jz240_mu12["r"],df_pzz_05_Jz240_mu12["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
    ...
    #-------------------------------------------------------------------------------------------
    #--------- layer 12  J_\bot = 24.0, delta = 0.6667
    slope = df_pzz_0667_Jz240_mu12["slope_pow"].values[0]
    Ks = round(-slope,2)  
    label = r"$\delta=0.6667,K_{P_{zz}}^{1,2}$=%.2f,D=%d"%(Ks,6000)
    L0667_240_mu12, = ax2.plot(df_pzz_0667_Jz240_mu12["r"],df_pzz_0667_Jz240_mu12["corre_abs"],label=label,ls="-",lw=1.5,color="green",
             marker='s',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="green", markerfacecolor='None')
    L0667_240_mu12_, = ax2.plot(df_pzz_0667_Jz240_mu12["r"],df_pzz_0667_Jz240_mu12["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
    ...
    legend1=plt.legend(handles=[L0375_240_mu12,L05_240_mu12,L0667_240_mu12], 
