...
if __name__ =="__main__":
    ...
    ax1 = plt.gca()
    df_pyy_Jz240_mu1_10000 = get_data_pyy_layer1(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=21.0,dim=10000)
    df_pyy_Jz240_mu2_10000 = get_data_pyy_layer2(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=21.0,dim=10000)
    df_pyy_Jz240_mu3_10000 = get_data_pyy_layer3(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=21.0,dim=10000)
    #----------------- plot pyy^{1} 10000-----------------------------------------------------------------------
