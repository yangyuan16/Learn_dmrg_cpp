...
if __name__ =="__main__":
    ...
    ax1 = plt.gca()
    df_pyy_Jz150_mu1_10000 = get_data_pyy_layer1(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=15.0,dim=10000)
    df_pyy_Jz150_mu2_10000 = get_data_pyy_layer2(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=15.0,dim=10000)
    df_pyy_Jz150_mu3_10000 = get_data_pyy_layer3(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=15.0,dim=10000)
    #----------------- plot pyy^{1} 10000-----------------------------------------------------------------------
    slope = df_pyy_Jz150_mu1_10000["slope_exp"].values[0]
    Ks = round(-1/slope,2) 
    label = r"$P_{yy}^{\mu=1}$, $\xi_{P_{yy}}^{\mu=1}$=%.2f, D=10000"%(Ks)
    L150_pyymu1_10000, = ax1.plot(df_pyy_Jz150_mu1_10000["r"],df_pyy_Jz150_mu1_10000["corre_abs"],label=label,ls="-",lw=1.5,color="red",
             marker='o',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="red", markerfacecolor='None')
    L150_pyymu1_10000_, = ax1.plot(df_pyy_Jz150_mu1_10000["r"],df_pyy_Jz150_mu1_10000["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #----------------- plot pyy^{2} 10000-----------------------------------------------------------------------
    slope = df_pyy_Jz150_mu2_10000["slope_exp"].values[0]
    Ks = round(-1/slope,2) 
    label = r"$P_{yy}^{\mu=2}$, $\xi_{P_{yy}}^{\mu=2}$=%.2f, D=10000"%(Ks)
    L150_pyymu2_10000, = ax1.plot(df_pyy_Jz150_mu2_10000["r"],df_pyy_Jz150_mu2_10000["corre_abs"],label=label,ls="-",lw=1.5,color="blue",
             marker='o',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="blue", markerfacecolor='None')
    L150_pyymu2_10000_, = ax1.plot(df_pyy_Jz150_mu2_10000["r"],df_pyy_Jz150_mu2_10000["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #------------------ plot pyy^{3} 10000-------------------------------------------------------------------------
    slope = df_pyy_Jz150_mu3_10000["slope_exp"].values[0]
    Ks = round(-1/slope,2) 
    label = r"$P_{yy}^{\mu=3}$, $\xi_{P_{yy}}^{\mu=3}$=%.2f, D=10000"%(Ks)
    L150_pyymu3_10000, = ax1.plot(df_pyy_Jz150_mu3_10000["r"],df_pyy_Jz150_mu3_10000["corre_abs"],label=label,ls="-",lw=1.5,color="magenta",
             marker='o',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="magenta", markerfacecolor='None')
    L150_pyymu3_10000_, = ax1.plot(df_pyy_Jz150_mu3_10000["r"],df_pyy_Jz150_mu3_10000["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #---------------------------------------------------------------------------------------------------------------------

    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 14, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L150_pyymu1_10000,L150_pyymu2_10000,L150_pyymu3_10000], 
    ...
    ax1.text(13,0.001, r'$J_{\bot}=15.0$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ...
    ax2 = plt.gca()
    df_pxx_Jz150_mu1_10000 = get_data_pxx_layer1(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=15.0,dim=10000)
    df_pxx_Jz150_mu2_10000 = get_data_pxx_layer2(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=15.0,dim=10000)
    df_pxx_Jz150_mu3_10000 = get_data_pxx_layer3(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=15.0,dim=10000)
    #----------------- plot pxx^{1} 10000-----------------------------------------------------------------------
    slope = df_pxx_Jz150_mu1_10000["slope_exp"].values[0]
    Ks = round(-1/slope,2) 
    label = r"$P_{xx}^{\mu=1}$, $\xi_{P_{xx}}^{\mu=1}$=%.2f, D=10000"%(Ks)
    L150_pxxmu1_10000, = ax2.plot(df_pxx_Jz150_mu1_10000["r"],df_pxx_Jz150_mu1_10000["corre_abs"],label=label,ls="-",lw=1.5,color="red",
             marker='o',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="red", markerfacecolor='None')
    L150_pxxmu1_10000_, = ax2.plot(df_pxx_Jz150_mu1_10000["r"],df_pxx_Jz150_mu1_10000["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #----------------- plot pxx^{2} 10000-----------------------------------------------------------------------
    slope = df_pxx_Jz150_mu2_10000["slope_exp"].values[0]
    Ks = round(-1/slope,2) 
    label = r"$P_{xx}^{\mu=2}$, $\xi_{P_{xx}}^{\mu=2}$=%.2f, D=10000"%(Ks)
    L150_pxxmu2_10000, = ax2.plot(df_pxx_Jz150_mu2_10000["r"],df_pxx_Jz150_mu2_10000["corre_abs"],label=label,ls="-",lw=1.5,color="blue",
             marker='o',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="blue", markerfacecolor='None')
    L150_pxxmu2_10000_, = ax2.plot(df_pxx_Jz150_mu2_10000["r"],df_pxx_Jz150_mu2_10000["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #------------------ plot pxx^{3} 10000-------------------------------------------------------------------------
    slope = df_pxx_Jz150_mu3_10000["slope_exp"].values[0]
    Ks = round(-1/slope,2) 
    label = r"$P_{xx}^{\mu=3}$, $\xi_{P_{xx}}^{\mu=3}$=%.2f, D=10000"%(Ks)
    L150_pxxmu3_10000, = ax2.plot(df_pxx_Jz150_mu3_10000["r"],df_pxx_Jz150_mu3_10000["corre_abs"],label=label,ls="-",lw=1.5,color="magenta",
             marker='o',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="magenta", markerfacecolor='None')
    L150_pxxmu3_10000_, = ax2.plot(df_pxx_Jz150_mu3_10000["r"],df_pxx_Jz150_mu3_10000["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #---------------------------------------------------------------------------------------------------------------------

    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 14, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L150_pxxmu1_10000,L150_pxxmu2_10000,L150_pxxmu3_10000], 
                       loc = 4, bbox_to_anchor=(0.65, -0.05),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #legend2=plt.legend(handles=[], loc = 4, bbox_to_anchor=(0.65, -0.04),
    #                   ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    ...
    ax2.text(13,0.001, r'$J_{\bot}=15.0$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ...
    ax3 = plt.gca()
    df_ninj_Jz150_mu1_10000 = get_data_ninj_corre_layer1(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=15.0,dim=10000)
    df_ninj_Jz150_mu2_10000 = get_data_ninj_corre_layer2(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=15.0,dim=10000)
    df_ninj_Jz150_mu3_10000 = get_data_ninj_corre_layer3(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=15.0,dim=10000)
    #----------------- plot D(r)^{1} 10000-----------------------------------------------------------------------
    slope = df_ninj_Jz150_mu1_10000["slope_pow"].values[0]
    Ks = round(-slope,2) 
    label = r"$D(x)^{\mu=1}$, $K_{D(x)}^{\mu=1}$=%.2f, D=10000"%(Ks)
    L150_ninjmu1_10000, = ax3.plot(df_ninj_Jz150_mu1_10000["r"],df_ninj_Jz150_mu1_10000["corre_abs"],label=label,ls="-",lw=1.5,color="red",
             marker='o',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="red", markerfacecolor='None')
    L150_ninjmu1_10000_, = ax3.plot(df_ninj_Jz150_mu1_10000["r"],df_ninj_Jz150_mu1_10000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #----------------- plot D(r)^{2} 10000-----------------------------------------------------------------------
    slope = df_ninj_Jz150_mu2_10000["slope_pow"].values[0]
    Ks = round(-slope,2) 
    label = r"$D(x)^{\mu=2}$, $K_{D(x)}^{\mu=2}$=%.2f, D=10000"%(Ks)
    L150_ninjmu2_10000, = ax3.plot(df_ninj_Jz150_mu2_10000["r"],df_ninj_Jz150_mu2_10000["corre_abs"],label=label,ls="-",lw=1.5,color="blue",
             marker='o',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="blue", markerfacecolor='None')
    L150_ninjmu2_10000_, = ax3.plot(df_ninj_Jz150_mu2_10000["r"],df_ninj_Jz150_mu2_10000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #------------------ plot D(r)^{3} 10000-------------------------------------------------------------------------
    slope = df_ninj_Jz150_mu3_10000["slope_pow"].values[0]
    Ks = round(-slope,2) 
    label = r"$D(x)^{\mu=3}$, $K_{D(x)}^{\mu=3}$=%.2f, D=10000"%(Ks)
    L150_ninjmu3_10000, = ax3.plot(df_ninj_Jz150_mu3_10000["r"],df_ninj_Jz150_mu3_10000["corre_abs"],label=label,ls="-",lw=1.5,color="magenta",
             marker='o',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="magenta", markerfacecolor='None')
    L150_ninjmu3_10000_, = ax3.plot(df_ninj_Jz150_mu3_10000["r"],df_ninj_Jz150_mu3_10000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #---------------------------------------------------------------------------------------------------------------------

    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 14, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L150_ninjmu1_10000,L150_ninjmu2_10000,L150_ninjmu3_10000], 
    ...
    ax3.text(13,0.01, r'$J_{\bot}=15.0$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
