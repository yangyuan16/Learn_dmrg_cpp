...
if __name__ =="__main__":
    ...
    L150_pzzmu12_10000, = ax1.plot(df_pzz_Jz150_mu12_10000["r"],df_pzz_Jz150_mu12_10000["corre_abs"],label=label,ls="-",lw=1.5,color="red",
             marker='o',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="red", markerfacecolor='None')
    L150_pzzmu12_10000_, = ax1.plot(df_pzz_Jz150_mu12_10000["r"],df_pzz_Jz150_mu12_10000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
    ...
    L150_pzzmu23_10000, = ax1.plot(df_pzz_Jz150_mu23_10000["r"],df_pzz_Jz150_mu23_10000["corre_abs"],label=label,ls="-",lw=1.5,color="magenta",
             marker='o',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="magenta", markerfacecolor='None')
    L150_pzzmu23_10000_, = ax1.plot(df_pzz_Jz150_mu23_10000["r"],df_pzz_Jz150_mu23_10000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #---------------------------------------------------------------------------------------------------------------------
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 14, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L150_pzzmu12_10000,L150_pzzmu23_10000,], 
    ...
    ax1.text(8,0.03, r'$J_{\bot}=15.0$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ...
    L150_Gmu1_10000, = ax2.plot(df_cicj_Jz150_mu1_10000["r"],df_cicj_Jz150_mu1_10000["corre_abs"],label=label,ls="-",lw=1.5,color="blue",
             marker='^',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="blue", markerfacecolor='None')
    L150_Gmu1_10000_, = ax2.plot(df_cicj_Jz150_mu1_10000["r"],df_cicj_Jz150_mu1_10000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #----------------- plot G(r)^{\mu=3} -------------------------------------------------------------------
    slope = df_cicj_Jz150_mu3_10000['slope_pow'].values[0]
    Ks = round(-slope,2)
    label = r"$G(r)^{\mu=3}$,$K_G^{\mu=3}$=%.2f"%(Ks,)
    L150_Gmu3_10000, = ax2.plot(df_cicj_Jz150_mu3_10000["r"],df_cicj_Jz150_mu3_10000["corre_abs"],label=label,ls="-",lw=1.5,color="olive",
             marker='>',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="olive", markerfacecolor='None')
    L150_Gmu3_10000_, = ax2.plot(df_cicj_Jz150_mu3_10000["r"],df_cicj_Jz150_mu3_10000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #---------------------------------------------------------------------------------------------------------------------
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 14, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L150_Gmu1_10000,L150_Gmu3_10000,], 
    ...
    ax2.text(8,0.03, r'$J_{\bot}=15.0$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ...
    L150_pzzmu12_10000, = ax3.plot(df_pzz_Jz150_mu12_10000["r"],df_pzz_Jz150_mu12_10000["corre_abs"]/delta,label=label,ls="-",lw=1.5,color="red",
             marker='o',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="red", markerfacecolor='None')
    L150_pzzmu12_10000_, = ax3.plot(df_pzz_Jz150_mu12_10000["r"],df_pzz_Jz150_mu12_10000["fitcorre_pow"]/delta,label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #----------------- plot pzz^{23}-----------------------------------------------------------------------
    slope = df_pzz_Jz150_mu23_10000["slope_pow"].values[0]
    Ks = round(-slope,2) 
    label = r"$P_{zz}^{2,3}/\delta$, $K_{P_{zz}}^{2,3}$=%.2f"%(Ks)
    L150_pzzmu23_10000, = ax3.plot(df_pzz_Jz150_mu23_10000["r"],df_pzz_Jz150_mu23_10000["corre_abs"]/delta,label=label,ls="-",lw=1.5,color="magenta",
             marker='o',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="magenta", markerfacecolor='None')
    L150_pzzmu23_10000_, = ax3.plot(df_pzz_Jz150_mu23_10000["r"],df_pzz_Jz150_mu23_10000["fitcorre_pow"]/delta,label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #----------------- plot G(r)^{\mu=1} -------------------------------------------------------------------
    slope = df_cicj_Jz150_mu1_10000['slope_pow'].values[0]
    Ks = round(-slope,2)
    ...
    Ks = round(-slope,2) 
    label = r"$P_{zz}^{1,2}/\delta$, $K_{P_{zz}}^{1,2}$=%.2f"%(Ks)
    L150_pzzmu12_10000, = ax4.plot(df_pzz_Jz150_mu12_10000["r"],df_pzz_Jz150_mu12_10000["corre_abs"]/delta,label=label,ls="-",lw=1.5,color="red",
             marker='o',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="red", markerfacecolor='None')
    L150_pzzmu12_10000_, = ax4.plot(df_pzz_Jz150_mu12_10000["r"],df_pzz_Jz150_mu12_10000["fitcorre_pow"]/delta,label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #----------------- plot pzz^{23}-----------------------------------------------------------------------
    slope = df_pzz_Jz150_mu23_10000["slope_pow"].values[0]
    Ks = round(-slope,2) 
    label = r"$P_{zz}^{2,3}/\delta$, $K_{P_{zz}}^{2,3}$=%.2f"%(Ks)
    L150_pzzmu23_10000, = ax4.plot(df_pzz_Jz150_mu23_10000["r"],df_pzz_Jz150_mu23_10000["corre_abs"]/delta,label=label,ls="-",lw=1.5,color="magenta",
             marker='o',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="magenta", markerfacecolor='None')
    L150_pzzmu23_10000_, = ax4.plot(df_pzz_Jz150_mu23_10000["r"],df_pzz_Jz150_mu23_10000["fitcorre_pow"]/delta,label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #----------------- plot G(r)^{\mu=2} -------------------------------------------------------------------
    slope = df_cicj_Jz150_mu2_10000['slope_pow'].values[0]
    Ks = round(-slope,2)
    label = r"$G(r)^{\mu=2}$,$K_G^{\mu=2}$=%.2f"%(Ks,)
    L150_Gmu2_10000, = ax4.plot(df_cicj_Jz150_mu2_10000["r"],df_cicj_Jz150_mu2_10000["corre_abs"],label=label,ls="-",lw=1.5,color="blue",
             marker='^',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="blue", markerfacecolor='None')
    L150_Gmu2_10000_, = ax4.plot(df_cicj_Jz150_mu2_10000["r"],df_cicj_Jz150_mu2_10000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #---------------------------------------------------------------------------------------------------------------------
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 14, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L150_pzzmu12_10000,L150_pzzmu23_10000,L150_Gmu2_10000,], 
                       loc = 4, bbox_to_anchor=(0.55, -0.05),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #legend2=plt.legend(handles=[], loc = 4, bbox_to_anchor=(0.65, -0.04),
    #                   ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    ...
    ax4.text(8,0.03, r'$J_{\bot}=15.0$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ...
    L150_pzzmu12_10000, = ax5.plot(df_pzz_Jz150_mu12_10000["r"],df_pzz_Jz150_mu12_10000["corre_abs"],label=label,ls="-",lw=1.5,color="red",
             marker='o',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="red", markerfacecolor='None')
    L150_pzzmu12_10000_, = ax5.plot(df_pzz_Jz150_mu12_10000["r"],df_pzz_Jz150_mu12_10000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #----------------- plot pzz^{23}-----------------------------------------------------------------------
    slope = df_pzz_Jz150_mu23_10000["slope_pow"].values[0]
    Ks = round(-slope,2) 
    label = r"$P_{zz}^{2,3}$, $K_{P_{zz}}^{2,3}$=%.2f"%(Ks)
    L150_pzzmu23_10000, = ax5.plot(df_pzz_Jz150_mu23_10000["r"],df_pzz_Jz150_mu23_10000["corre_abs"],label=label,ls="-",lw=1.5,color="magenta",
             marker='o',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="magenta", markerfacecolor='None')
    L150_pzzmu23_10000_, = ax5.plot(df_pzz_Jz150_mu23_10000["r"],df_pzz_Jz150_mu23_10000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #------------------ plot F(r)^{\mu=1}---------------------------------------------------------------------
    slope = df_sisj_Jz150_mu1_10000['slope_pow'].values[0]
    Ks = round(-slope,2)
    label = r"$F(r)^{\mu=1}$,$K_F^{\mu=1}$=%.2f"%(Ks,)
    L150_Fmu1_10000, = ax5.plot(df_sisj_Jz150_mu1_10000["r"],df_sisj_Jz150_mu1_10000["corre_abs"],label=label,ls="-",lw=1.5,color="cyan",
             marker='s',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="cyan", markerfacecolor='None')
    L150_Fmu1_10000_, = ax5.plot(df_sisj_Jz150_mu1_10000["r"],df_sisj_Jz150_mu1_10000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #----------------- plot F(r)^{\mu=2} -------------------------------------------------------------------
    slope = df_sisj_Jz150_mu2_10000['slope_pow'].values[0]
    Ks = round(-slope,2)
    label = r"$F(r)^{\mu=2}$,$K_F^{\mu=3}$=%.2f"%(Ks,)
    L150_Fmu2_10000, = ax5.plot(df_sisj_Jz150_mu2_10000["r"],df_sisj_Jz150_mu2_10000["corre_abs"],label=label,ls="-",lw=1.5,color="olive",
             marker='>',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="olive", markerfacecolor='None')
    #L150_Fmu2_10000_, = ax5.plot(df_sisj_Jz150_mu2_10000["r"],df_sisj_Jz150_mu2_10000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
    #         marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #----------------- plot F(r)^{\mu=3} -------------------------------------------------------------------
    slope = df_sisj_Jz150_mu3_10000['slope_pow'].values[0]
    Ks = round(-slope,2)
    label = r"$F(r)^{\mu=3}$,$K_F^{\mu=3}$=%.2f"%(Ks,)
    L150_Fmu3_10000, = ax5.plot(df_sisj_Jz150_mu3_10000["r"],df_sisj_Jz150_mu3_10000["corre_abs"],label=label,ls="-",lw=1.5,color="green",
             marker='>',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="green", markerfacecolor='None')
    #L150_Fmu3_10000_, = ax5.plot(df_sisj_Jz150_mu3_10000["r"],df_sisj_Jz150_mu3_10000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
    #         marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')    
    #---------------------------------------------------------------------------------------------------------------------
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 14, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    ...
    ax5.text(8,0.03, r'$J_{\bot}=15.0$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ...
    Ks = round(-slope,2)
    label = r"$F(r)^{\mu=1}$,$K_F^{\mu=1}$=%.2f"%(Ks,)
    L150_Fmu1_10000, = ax6.plot(df_sisj_Jz150_mu1_10000["r"],df_sisj_Jz150_mu1_10000["corre_abs"],label=label,ls="-",lw=1.5,color="cyan",
             marker='s',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="cyan", markerfacecolor='None')
    L150_Fmu1_10000_, = ax6.plot(df_sisj_Jz150_mu1_10000["r"],df_sisj_Jz150_mu1_10000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #----------------- plot F(r)^{\mu=2} -------------------------------------------------------------------
    slope = df_sisj_Jz150_mu2_10000['slope_pow'].values[0]
    Ks = round(-slope,2)
    label = r"$F(r)^{\mu=2}$,$K_F^{\mu=3}$=%.2f"%(Ks,)
    L150_Fmu2_10000, = ax6.plot(df_sisj_Jz150_mu2_10000["r"],df_sisj_Jz150_mu2_10000["corre_abs"],label=label,ls="-",lw=1.5,color="olive",
             marker='>',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="olive", markerfacecolor='None')
    #L150_Fmu2_10000_, = ax6.plot(df_sisj_Jz150_mu2_10000["r"],df_sisj_Jz150_mu2_10000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
    #         marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #----------------- plot F(r)^{\mu=3} -------------------------------------------------------------------
    slope = df_sisj_Jz150_mu3_10000['slope_pow'].values[0]
    Ks = round(-slope,2)
    label = r"$F(r)^{\mu=3}$,$K_F^{\mu=3}$=%.2f"%(Ks,)
    L150_Fmu3_10000, = ax6.plot(df_sisj_Jz150_mu3_10000["r"],df_sisj_Jz150_mu3_10000["corre_abs"],label=label,ls="-",lw=1.5,color="green",
             marker='>',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="green", markerfacecolor='None')
    #L150_Fmu3_10000_, = ax6.plot(df_sisj_Jz150_mu3_10000["r"],df_sisj_Jz150_mu3_10000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
    #         marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #----------------- plot G(r)^{\mu=1} -------------------------------------------------------------------
    slope = df_cicj_Jz150_mu1_10000['slope_pow'].values[0]
    Ks = round(-slope,2)
    label = r"$G(r)^{\mu=1}$,$K_G^{\mu=1}$=%.2f"%(Ks,)
    L150_Gmu1_10000, = ax6.plot(df_cicj_Jz150_mu1_10000["r"],df_cicj_Jz150_mu1_10000["corre_abs"],label=label,ls="-",lw=1.5,color="red",
             marker='^',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="red", markerfacecolor='None')
    L150_Gmu1_10000_, = ax6.plot(df_cicj_Jz150_mu1_10000["r"],df_cicj_Jz150_mu1_10000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #----------------- plot G(r)^{\mu=3} -------------------------------------------------------------------
    slope = df_cicj_Jz150_mu3_10000['slope_pow'].values[0]
    Ks = round(-slope,2)
    label = r"$G(r)^{\mu=3}$,$K_G^{\mu=3}$=%.2f"%(Ks,)
    L150_Gmu3_10000, = ax6.plot(df_cicj_Jz150_mu3_10000["r"],df_cicj_Jz150_mu3_10000["corre_abs"],label=label,ls="-",lw=1.5,color="magenta",
             marker='>',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="magenta", markerfacecolor='None')
    L150_Gmu3_10000_, = ax6.plot(df_cicj_Jz150_mu3_10000["r"],df_cicj_Jz150_mu3_10000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #----------------- plot G(r)^{\mu=2} -------------------------------------------------------------------
    slope = df_cicj_Jz150_mu2_10000['slope_pow'].values[0]
    Ks = round(-slope,2)
    label = r"$G(r)^{\mu=2}$,$K_G^{\mu=2}$=%.2f"%(Ks,)
    L150_Gmu2_10000, = ax6.plot(df_cicj_Jz150_mu2_10000["r"],df_cicj_Jz150_mu2_10000["corre_abs"],label=label,ls="-",lw=1.5,color="orange",
             marker='^',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="orange", markerfacecolor='None')
    L150_Gmu2_10000_, = ax6.plot(df_cicj_Jz150_mu2_10000["r"],df_cicj_Jz150_mu2_10000["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')

    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 14, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L150_Fmu1_10000,L150_Fmu2_10000,L150_Fmu3_10000,L150_Gmu1_10000,L150_Gmu2_10000,L150_Gmu3_10000], 
                       loc = 4, bbox_to_anchor=(0.55, -0.05),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #legend2=plt.legend(handles=[], loc = 4, bbox_to_anchor=(0.65, -0.04),
    #                   ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    ...
    ax6.text(8,0.03, r'$J_{\bot}=15.0$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
