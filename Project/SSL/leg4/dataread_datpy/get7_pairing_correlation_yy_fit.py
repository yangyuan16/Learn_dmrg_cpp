...
def plot_corre_sign(df):                                                                                                    
    ...
    plt.title("Sign of YY Pairing, tnnn=%.2f,Jnnn=%.2f"%(t1,J1), fontsize=25)                                                                
    plt.show()                                                                                                              
    return                                                                                                                  
#  
#
if __name__ == "__main__":
    ...
    print(len(df))
    #================选定某些数据点==========================
    df_cut_exp = df.loc[[6,10,18,23,26]] # exponential fit
    df_cut_pow = df.loc[[0,6,10,18]] # power law fit
