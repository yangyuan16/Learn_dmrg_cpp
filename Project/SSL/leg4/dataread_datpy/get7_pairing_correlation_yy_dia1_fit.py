...
def plot_corre_sign(df):                                                                                                    
    ...
    plt.title("Sign of NNN Pairing, tnnn=%.2f,Jnnn=%.2f"%(t1,J1), fontsize=25)                                                                
    plt.show()                                                                                                              
    return                                                                                                                  
#  
#
if __name__ == "__main__":
    ...
    print(len(df))
    #================选定某些数据点==========================
    df_cut_exp = df.loc[[4,8,12,16,20,24,28]] # exponential fit
    df_cut_pow = df.loc[[1,9,15,23]] # power law fit
