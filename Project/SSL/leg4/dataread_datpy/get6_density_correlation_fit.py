...
def plot_corre_sign(df):                                                                                                    
    ...
    plt.title("Sign of Density Corre. tnnn=%.2f,Jnnn=%.2f"%(t1,J1), fontsize=25)                                                             
    plt.show()                                                                                                              
    return
#
if __name__ == "__main__":
    ...
    print(len(df))
    #================选定某些数据点==========================
    df_cut_exp = df.loc[[3,7,10,15,18,23,25]] # for exponential fit 
    df_cut_pow = df.loc[[0,7,10,15,18]] # for power law fit
    #df_cut = df
