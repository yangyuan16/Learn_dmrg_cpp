...
def plot_expfit(df):
    ...
    plt.title("Lx=%d,dop=%.4f,tnnn=%.2f,Jnnn=%.2fDim=%d"%(Lx,dop/(Lz*Ly*Lx),t1,J1,dim), fontsize=25)
    plt.show()
    return
#
def plot_powfit(df):
...
def plot_corre_sign(df):                                                                                                    
    ...
    plt.title("Sign of YX Pairing, tnnn=%.2f,Jnnn=%.2f"%(t1,J1), fontsize=25)                                                                
    plt.show()                                                                                                              
    return                                                                                                                  
#  
#
if __name__ == "__main__":
    ...
    print(len(df))
    #================选定某些数据点==========================
    df_cut_exp = df.loc[[9,16,24,32]] # exponential fit
    df_cut_pow = df.loc[[0,8,16]] # power law fit
