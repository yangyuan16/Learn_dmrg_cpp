...
def plot_corre_sign(df):                                                                                                    
    ...
    plt.title("Sign of Green Fun. tnnn=%.2f,Jnnn=%.2f"%(t1,J1), fontsize=25)                                                                 
    plt.show()                                                                                                              
    return  
#
if __name__ == "__main__":
    ...
    print(len(df))
    #================选定某些数据点=============================
    df_cut_exp = df.loc[[3,6,9,17,23,29]] # for exponential fit 
    df_cut_pow = df.loc[[0,6,9,11,17]] # for power law fit
