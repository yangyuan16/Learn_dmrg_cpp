...
def plot_corre_sign(df):                                                                                                    
    ...
    plt.title("Sign of Density Corre. t=%.2f,J=%.2f,t2=%.2f,J2=%.2f"%(t,J,t1,J1), fontsize=20)                                                             
    plt.show()                                                                                                              
    return
#
if __name__ == "__main__":
    ...
    print(len(df))
    #================选定某些数据点==========================
    df_cut_exp = df.loc[[6,9,12,15,18,21,24]] # for exponential fit 
    df_cut_pow = df.loc[[1,6,9,12,15,18]] # for power law fit
    #df_cut = df
    ...
    Issave = True 
    if Issave:
        filepath4 = "\\measurement_density_correlation_fit.parquet" 
