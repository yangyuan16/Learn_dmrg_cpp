...
def plot_expfit(df):
    ...
    xi = -1/slope 
    label_data = "$<\Delta_i^{yy} \Delta_j^{yy}>$"
    ...
    plt.title("Lx=%d,dop=%.4f,t=%.2f,J=%.2f,t2=%.2f,J2=%.2fDim=%d"%(Lx,dop/(Lz*Ly*Lx),t,J,t1,J1,dim), fontsize=20)
    plt.show()
    return
#
def plot_powfit(df):
...
def plot_corre_sign(df):                                                                                                    
    ...
    plt.title("Sign of YY Pairing, t=%.2f,J=%.2f,t2=%.2f,J2=%.2f"%(t,J,t1,J1), fontsize=20)                                                                
    plt.show()                                                                                                              
    return                                                                                                                  
#  
#
if __name__ == "__main__":
    ...
    print(len(df))
    #================选定某些数据点==========================
    df_cut_exp = df.loc[[4,18,23,30]] # exponential fit
    df_cut_pow = df.loc[[0,4,12,18,23,29]] # power law fit
    ...
    Issave = True
    if Issave:
        filepath4 = "\\measurement_pairing_fit.parquet"
