...
def plot_expfit(df):
    ...
    xi = -1/slope 
    label_data = "$<\Delta_i^{xx} \Delta_j^{xx}>$"
...
def plot_corre_sign(df):                                                                                                    
    ...
    plt.title("Sign of XX Pairing, t=%.2f,J=%.2f,t2=%.2f,J2=%.2f"%(t,J,t1,J1), fontsize=20)                                                                
    plt.show()                                                                                                              
    return                                                                                                                  
#  
#
if __name__ == "__main__":
    ...
    print(len(df))
    #================选定某些数据点==========================
    df_cut_exp = df.loc[[2,5,8,11,14,17,20,23]] # exponential fit
    df_cut_pow = df.loc[[2,5,8,11,14,17]] # power law fit
    ...
    Issave = True
    if Issave:
        filepath4 = "\\measurement_pairing_xx_fit.parquet"
