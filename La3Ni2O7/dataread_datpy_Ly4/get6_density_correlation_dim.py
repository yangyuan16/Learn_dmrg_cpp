...
if __name__ == "__main__":
    ...
    #r_dim3000, corre_dim3000 = get_data(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=Jz,dim=3000)
    ...
    legend1=plt.legend(handles=[ L4000, L6000,L8000,L10000], loc = 4, bbox_to_anchor=(0.38, 0.02),
    ...
    plt.title("$<n_i n_j>-<n_i><n_j> $ Jz=%g"%Jz, fontsize=25)
