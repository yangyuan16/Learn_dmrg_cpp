...
if __name__ =="__main__":
    ...
    xi = round(-1/slope,2)  
    label = r"$J_{\bot}$=%.2f $\xi_{CDW}$=%.2f"%(0.25,xi)
    L025, = ax3.plot(df_ninj_Jz025["r"],df_ninj_Jz025["corre_abs"],label=label,ls="-",lw=1.5,color="r",
             marker='o',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="r", markerfacecolor='None')
    L025_, = ax3.plot(df_ninj_Jz025["r"],df_ninj_Jz025["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
    ...
    xi = round(-1/slope,2)  
    label = r"$J_{\bot}$=%.2f $\xi_{CDW}$=%.2f"%(0.75,xi)
    L075, = ax3.plot(df_ninj_Jz075["r"],df_ninj_Jz075["corre_abs"],label=label,ls="-",lw=1.5,color="green",
             marker='^',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="green", markerfacecolor='None')
    L075_, = ax3.plot(df_ninj_Jz075["r"],df_ninj_Jz075["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
             marker='^',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #-------- J_\bot = 1.75
    slope = df_ninj_Jz175["slope_exp"].values[0]
    xi = round(-1/slope,2)  
    label = r"$J_{\bot}$=%.2f $\xi_{CDW}$=%.2f"%(1.75,xi)
    L175, = ax3.plot(df_ninj_Jz175["r"],df_ninj_Jz175["corre_abs"],label=label,ls="-",lw=1.5,color="brown",
             marker='h',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="brown", markerfacecolor='None')
    L175_, = ax3.plot(df_ninj_Jz175["r"],df_ninj_Jz175["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
             marker='h',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #--------- J_\bot = 2.5
    slope = df_ninj_Jz25["slope_exp"].values[0]
    xi = round(-1/slope,2)  
    label = r"$J_{\bot}$=%.2f $\xi_{CDW}$=%.2f"%(2.5,xi)
    L25, = ax3.plot(df_ninj_Jz25["r"],df_ninj_Jz25["corre_abs"],label=label,ls="-",lw=1.5,color="blue",
             marker='^',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="blue", markerfacecolor='None')
    L25_, = ax3.plot(df_ninj_Jz25["r"],df_ninj_Jz25["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
             marker='^',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #-------- J_\bot = 3.0
    slope = df_ninj_Jz30["slope_exp"].values[0]
    xi = round(-1/slope,2)  
    label = r"$J_{\bot}$=%.2f $\xi_{CDW}$=%.2f"%(3.0,xi)
    L30, = ax3.plot(df_ninj_Jz30["r"],df_ninj_Jz30["corre_abs"],label=label,ls="-",lw=1.5,color="cyan",
             marker='+',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="cyan", markerfacecolor='None')
    L30_, = ax3.plot(df_ninj_Jz30["r"],df_ninj_Jz30["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
             marker='+',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #-------- J_\bot = 3.5
    slope = df_ninj_Jz35["slope_exp"].values[0]
    xi = round(-1/slope,2)  
    label = r"$J_{\bot}$=%.2f $\xi_{CDW}$=%.2f"%(3.5,xi)
    L35, = ax3.plot(df_ninj_Jz35["r"],df_ninj_Jz35["corre_abs"],label=label,ls="-",lw=1.5,color="magenta",
             marker='h',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="magenta", markerfacecolor='None')
    L35_, = ax3.plot(df_ninj_Jz35["r"],df_ninj_Jz35["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
             marker='h',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    ####图例设置
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 14, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    ...
    #=========================================================
    ax3.text(2,0.03,"(c)",fontsize = 20, color='black', rotation = 0)
    ax3.text(2,3e-6, r'$\mathrm{\delta} = 0.5$', fontsize = 20, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
    ...
    L025, = ax4.plot(df_pyy_Jz025["r"],df_pyy_Jz025["corre_abs"],label=label,ls="-",lw=1.5,color="r",
             marker='o',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="r", markerfacecolor='w')
    L025_, = ax4.plot(df_pyy_Jz025["r"],df_pyy_Jz025["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
    ...
    L075, = ax4.plot(df_pyy_Jz075["r"],df_pyy_Jz075["corre_abs"],label=label,ls="-",lw=1.5,color="green",
             marker='^',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="green", markerfacecolor='None')
    L075_, = ax4.plot(df_pyy_Jz075["r"],df_pyy_Jz075["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
             marker='^',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #-------- J_\bot = 1.75
    slope = df_pyy_Jz175["slope_exp"].values[0]
    xi = round(-1/slope,2)  
    label = r"$J_{\bot}$=%.2f $\xi_{SC}^{yy}$=%.2f"%(1.75,xi)
    L175, = ax4.plot(df_pyy_Jz175["r"],df_pyy_Jz175["corre_abs"],label=label,ls="-",lw=1.5,color="brown",
             marker='h',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="brown", markerfacecolor='None')
    L175_, = ax4.plot(df_pyy_Jz175["r"],df_pyy_Jz175["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
             marker='h',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #--------- J_\bot = 2.5
    slope = df_pyy_Jz25["slope_exp"].values[0]
    xi = round(-1/slope,2)  
    label = r"$J_{\bot}$=%.2f $\xi_{SC}^{yy}$=%.2f"%(2.5,xi)
    L25, = ax4.plot(df_pyy_Jz25["r"],df_pyy_Jz25["corre_abs"],label=label,ls="-",lw=1.5,color="blue",
             marker='^',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="blue", markerfacecolor='None')
    L25_, = ax4.plot(df_pyy_Jz25["r"],df_pyy_Jz25["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
             marker='^',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #-------- J_\bot = 3.0
    slope = df_pyy_Jz30["slope_exp"].values[0]
    xi = round(-1/slope,2)  
    label = r"$J_{\bot}$=%.2f $\xi_{SC}^{yy}$=%.2f"%(3.0,xi)
    L30, = ax4.plot(df_pyy_Jz30["r"],df_pyy_Jz30["corre_abs"],label=label,ls="-",lw=1.5,color="cyan",
             marker='+',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="cyan", markerfacecolor='None')
    L30_, = ax4.plot(df_pyy_Jz30["r"],df_pyy_Jz30["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
             marker='+',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #-------- J_\bot = 3.5
    slope = df_pyy_Jz35["slope_exp"].values[0]
    xi = round(-1/slope,2)  
    label = r"$J_{\bot}$=%.2f $\xi_{SC}^{yy}$=%.2f"%(3.5,xi)
    L35, = ax4.plot(df_pyy_Jz35["r"],df_pyy_Jz35["corre_abs"],label=label,ls="-",lw=1.5,color="magenta",
             marker='h',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="magenta", markerfacecolor='w')
    L35_, = ax4.plot(df_pyy_Jz35["r"],df_pyy_Jz35["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
             marker='h',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    ####图例设置
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 14, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    ...
    #=========================================================
    ax4.text(2,0.003,"(d)",fontsize = 20, color='black', rotation = 0)
    ax4.text(2,1e-6, r'$\mathrm{\delta} = 0.5$', fontsize = 20, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
    ...
    L025, = ax5.plot(df_pzz_Jz025["r"],df_pzz_Jz025["corre_abs"],label=label,ls="-",lw=1.5,color="r",
             marker='o',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="r", markerfacecolor='None')
    L025_, = ax5.plot(df_pzz_Jz025["r"],df_pzz_Jz025["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="r", markerfacecolor='w')
    #--------- J_\bot = 0.75
    slope = df_pzz_Jz075["slope_exp"].values[0]
    xi = round(-1/slope,2)  
    label = r"$J_{\bot}$=%.2f $\xi_{SC}^{zz}$=%.2f"%(0.75,xi)
    L075, = ax5.plot(df_pzz_Jz075["r"],df_pzz_Jz075["corre_abs"],label=label,ls="-",lw=1.5,color="green",
             marker='^',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="green", markerfacecolor='None')
    L075_, = ax5.plot(df_pzz_Jz075["r"],df_pzz_Jz075["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
             marker='^',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #-------- J_\bot = 1.75
    slope = df_pzz_Jz175["slope_exp"].values[0]
    xi = round(-1/slope,2)  
    label = r"$J_{\bot}$=%.2f $\xi_{SC}^{zz}$=%.2f"%(1.75,xi)
    L175, = ax5.plot(df_pzz_Jz175["r"],df_pzz_Jz175["corre_abs"],label=label,ls="-",lw=1.5,color="brown",
             marker='h',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="brown", markerfacecolor='None')
    L175_, = ax5.plot(df_pzz_Jz175["r"],df_pzz_Jz175["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
             marker='h',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #--------- J_\bot = 2.5
    slope = df_pzz_Jz25["slope_exp"].values[0]
    xi = round(-1/slope,2)  
    label = r"$J_{\bot}$=%.2f $\xi_{SC}^{zz}$=%.2f"%(2.5,xi)
    L25, = ax5.plot(df_pzz_Jz25["r"],df_pzz_Jz25["corre_abs"],label=label,ls="-",lw=1.5,color="blue",
             marker='^',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="blue", markerfacecolor='None')
    L25_, = ax5.plot(df_pzz_Jz25["r"],df_pzz_Jz25["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
             marker='^',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #-------- J_\bot = 3.0
    slope = df_pzz_Jz30["slope_exp"].values[0]
    xi = round(-1/slope,2)  
    label = r"$J_{\bot}$=%.2f $\xi_{SC}^{zz}$=%.2f"%(3.0,xi)
    L30, = ax5.plot(df_pzz_Jz30["r"],df_pzz_Jz30["corre_abs"],label=label,ls="-",lw=1.5,color="cyan",
             marker='+',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="cyan", markerfacecolor='None')
    L30_, = ax5.plot(df_pzz_Jz30["r"],df_pzz_Jz30["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
             marker='+',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #-------- J_\bot = 3.5
    slope = df_pzz_Jz35["slope_exp"].values[0]
    xi = round(-1/slope,2)  
    label = r"$J_{\bot}$=%.2f $\xi_{SC}^{zz}$=%.2f"%(3.5,xi)
    L35, = ax5.plot(df_pzz_Jz35["r"],df_pzz_Jz35["corre_abs"],label=label,ls="-",lw=1.5,color="magenta",
             marker='h',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="magenta", markerfacecolor='None')
    L35_, = ax5.plot(df_pzz_Jz35["r"],df_pzz_Jz35["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
             marker='h',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    ####图例设置
    ####图例设置
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 14, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    ...
    #=========================================================
    ax5.text(2,0.01,"(e)",fontsize = 20, color='black', rotation = 0)
    ax5.text(2,1e-6, r'$\mathrm{\delta} = 0.5$', fontsize = 20, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
    ...
    L025, = ax6.plot(df_pzz_Jz025["r"],df_pzz_Jz025["corre_abs"],label=label,ls="-",lw=1.5,color="r",
             marker='o',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="r", markerfacecolor='None')
    L025_, = ax6.plot(df_pzz_Jz025["r"],df_pzz_Jz025["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #--------- J_\bot = 0.75
    slope = df_pzz_Jz075["slope_pow"].values[0]
    K_F = round(-slope,2)  
    label = r"$J_{\bot}$=%.2f $K_{SC}^{zz}$=%.2f"%(0.75,K_F)
    L075, = ax6.plot(df_pzz_Jz075["r"],df_pzz_Jz075["corre_abs"],label=label,ls="-",lw=1.5,color="green",
             marker='^',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="green", markerfacecolor='None')
    L075_, = ax6.plot(df_pzz_Jz075["r"],df_pzz_Jz075["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='^',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #-------- J_\bot = 1.75
    slope = df_pzz_Jz175["slope_pow"].values[0]
    K_F = round(-slope,2)  
    label = r"$J_{\bot}$=%.2f $K_{SC}^{zz}$=%.2f"%(1.75,K_F)
    L175, = ax6.plot(df_pzz_Jz175["r"],df_pzz_Jz175["corre_abs"],label=label,ls="-",lw=1.5,color="brown",
    ...
    L25, = ax6.plot(df_pzz_Jz25["r"],df_pzz_Jz25["corre_abs"],label=label,ls="-",lw=1.5,color="blue",
             marker='^',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="blue", markerfacecolor='None')
    L25_, = ax6.plot(df_pzz_Jz25["r"],df_pzz_Jz25["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='^',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #-------- J_\bot = 3.0
    ...
    L35, = ax6.plot(df_pzz_Jz35["r"],df_pzz_Jz35["corre_abs"],label=label,ls="-",lw=1.5,color="magenta",
             marker='h',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="magenta", markerfacecolor='None')
    L35_, = ax6.plot(df_pzz_Jz35["r"],df_pzz_Jz35["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='h',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    ####图例设置
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 14, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    ...
    #=========================================================
    ax6.text(2,0.02,"(f)",fontsize = 20, color='black', rotation = 0)
    ax6.text(2,0.000005, r'$\mathrm{\delta} = 0.5$', fontsize = 20, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
    ...
    ax8.text(2,3.4,"(g)",fontsize = 20, color='black', rotation = 0)
    ...
    plt.savefig("E:\\WORK\\Work\\Project\\La3Ni2O7\\datashow_datpy_poster\\figs\\fig3.eps",
