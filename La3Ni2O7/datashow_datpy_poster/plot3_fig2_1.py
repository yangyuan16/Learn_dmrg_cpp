...
if __name__ =="__main__":
    ...
    legend1=plt.legend(handles=[L025,L175,L30,L35], loc = 4, bbox_to_anchor=(0.72, 0.02),
    ...
    #
    L01, = ax2.plot(df_ent_01['r'].values,df_ent_01["entropy"],label=r"$J_{\bot}$=%.1f"%(0.1),ls="-",lw=1.5,color='r',
             marker='o',alpha=1,markersize=6,markeredgewidth=1.5, markeredgecolor='r',
             markerfacecolor='None')
    L01_fit, = ax2.plot(df_ent_01['r'].values,S_res01,label="c=%.2f,g=%.2f"%(c_01,g_01),ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=1.5, markeredgecolor="k",
             markerfacecolor='None')
    #
    L40, = ax2.plot(df_ent_40['r'].values,df_ent_40["entropy"],label=r"$J_{\bot}$=%.2f"%(4.0),ls="-",lw=1.5,color='blue',
             marker='o',alpha=1,markersize=6,markeredgewidth=1.5, markeredgecolor='blue',
             markerfacecolor='None')
    L40_fit, = ax2.plot(df_ent_40['r'].values,S_res375,label="c=%.2f,g=%.2f"%(c_40,g_40),ls="--",lw=2.5,color="green",
             marker='o',alpha=1,markersize=0,markeredgewidth=1.5, markeredgecolor="k",
             markerfacecolor='None')
    #
    ...
    ax2.tick_params(labelsize = 16) # 设置坐标刻度对应数字的大小
    #ax2.set_xlim([0,8])
    #ax2.set_ylim([-0.1,1])
    #ax2.set_xticks([0,2,4,6,8])
    #ax2.set_yticks([-0.1,0,0.5,1])
    #ax2.text(0.3,-0.05, r'$\mathrm{(a)}$', fontsize=18)
    ax2.text(2,3.4,"(b)",fontsize = 20, color='black', rotation = 0)
    ...
    plt.savefig("E:\\WORK\\Work\\Project\\La3Ni2O7\\datashow_datpy_poster\\figs\\fig3_pp_1.eps",
