...
if __name__ == "__main__":
    ...
    r_dim16000, corre_dim16000 = get_data(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=Jz,dim=16000)    
    #------------------------------------------------------------------------------------
    ...
    L16000,= ax1.plot(r_dim16000,corre_dim16000,label="dim={}".format(16000),ls="-",lw=1.5,color="green",
             marker='s',alpha=1,markersize=6,markeredgewidth=1.5, markeredgecolor="green",
             markerfacecolor='None')
    #
    ####图例设置
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 16, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L10000, L16000], loc = 4, bbox_to_anchor=(0.38, 0.18),
