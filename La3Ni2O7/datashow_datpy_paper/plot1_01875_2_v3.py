...
if __name__ =="__main__":
    ...
    #
    df_ni_Jz01_64 = get_data_ni(Lz=2,Ly=Ly,Lx=64,dop=48,t=t,J=J,Jz=0.1,dim=dim) # double layer J_\bot = 0.1
    ...
    L_64, =ax1.plot(df_ni_64["rmean"].values[:32],df_ni_64["dymean"].values[:32],label=label,ls="-",lw=0.0,color="blue",
    ...
    #==================================
    # Double layer
    label = r"$J_\bot$=%.1f: Lx = 64, $K_c$=%.2f"%(0.1,df_ni_Jz01_64_fit['Kc'].values[0]) 
    L01_64, =ax1.plot(df_ni_Jz01_64["rmean"].values[:32],df_ni_Jz01_64["dy0"].values[:32],label=label,ls="-",lw=0.0,color="red",
    ...
    legend1=plt.legend(handles=[L_64,L01_64,], loc = 4, bbox_to_anchor=(0.95, 0.67),
    ...
    #=========================================================
    ax1.text(1.8,0.8887,"(a)",fontsize = 20, color='black', rotation = 0)
    ax1.text(8.0,0.886, r'$\mathrm{\delta} = 0.1875$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ...
    df_pyy = get_data_pyy_leg2(Lz=1,Ly=Ly,Lx=48,dop=18,t=t,J=J,Jz=0,dim=dim)
    # load YY pairing correlation data
    df_pyy_Jz01 = get_data_pyy(Lz=2,Ly=2,Lx=48,dop=36,t=t,J=J,Jz=0.1,dim=10000) #double layer
    ...
    Ksc = round(-slope,2)
    #label = r"$J_{\bot}$=%.1f: $K_{SC}^{yy}$=%.2f"%(0.1,Ksc)
    ...
    #                   ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    legend2=plt.legend(handles=[Lyy,Lyy01,], loc = 4, bbox_to_anchor=(0.78, 0.02),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    ...
    #
    #=========================================================
    ax2.text(25,0.005,"(b)",fontsize = 20, color='black', rotation = 0)
    ax2.text(4.15,0.005, r'$\mathrm{\delta} = 0.1875$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ...
    L18SL_2, = ax3.plot(df18_SL["logr"].values,2*df18_SL["entropy"].values,label=label_fitdata,ls="-",lw=1.5,color="blue",
             marker='D',alpha=1,markersize=8,markeredgewidth=1.0, markeredgecolor="blue",markerfacecolor='yellow')
    L18SL_fit_2, = ax3.plot(df18_SL["logr"].values[4:-1],2*df18_SL["fitentropy"].values[4:-1],label=label_fitdata,ls="--",lw=1.5,color="k",
             marker='D',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="red",
             markerfacecolor='w')
    #
    # J_\bot = 0.1  dim = 6000
    ...
    label_fitdata = r"$J_{\bot}$=%.1f: Dim=%d"%(0.1,6000)
    L36ent01_6000, = ax3.plot(df36_ent_01_6000["logr"].values,df36_ent_01_6000["entropy"].values,label=label_fitdata,ls="-",lw=1.5,color="red",
    ...
    label_fitdata = r"$J_{\bot}$=%.1f: Dim=%d"%(0.1,8000)
    ...
    label_fitdata = r"$J_{\bot}$=%.1f: Dim=%d"%(0.1,10000)
    ...
    legend1=plt.legend(handles=[L18SL_2,L36ent01_6000,L36ent01_8000,L36ent01_10000], loc = 4, bbox_to_anchor=(0.656, 0.63),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    ...
    ax3.set_xlabel(label_x, size= 15)
    ...
    #
    #=========================================================
    ax3.text(0.435,4.28,"(c)",fontsize = 20, color='black', rotation = 0)
    ax3.text(0.21,4.9, r'$\mathrm{\delta} = 0.1875$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ...
    plt.savefig("E:\\WORK\\Work\\Project\\La3Ni2O7\\datashow_datpy_paper\\figs\\fig_01875_2_v3.eps",
