...
if __name__ =="__main__":
    ...
    # 得到子图
    # 得到子图
    ax1 = plt.axes([0.08,0.56,0.40,0.415])
    ax2 = plt.axes([0.56,0.56,0.40,0.415])
    ax3 = plt.axes([0.08,0.08,0.40,0.415])
    ax4 = plt.axes([0.56,0.08,0.40,0.415])
    ...
    #Lf_, = ax1.plot(df_sisj["r"],df_sisj["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
    #         marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #---------|G(r)| delta = 0.375
    slope = df_cicj["slope_pow"].values[0]
    Kc = round(-slope,2)  
    #label = r"G(r)/$\delta$, $K_G$=%.2f"%(Kc)
    label = r"$|G(r)| / \delta$"
    Lg, = ax1.plot(df_cicj["r"],df_cicj["corre_abs"]/0.375,label=label,ls="-",lw=1.5,color="blue",
             marker='s',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="blue", markerfacecolor='None')
    #Lg_, = ax1.plot(df_cicj["r"],df_cicj["fitcorre_pow"]/0.375,label=label,ls="--",lw=1.5,color="k",
    ...
    Kc = round(-slope,2)  
    label = r"$-D(r)/\delta^2$, $K_D$=%.2f"%(Kc)
    Ld, = ax1.plot(df_ninj_corre["r"],df_ninj_corre["corre_abs"]/(0.375*0.375),label=label,ls="-",lw=1.5,color="green",
             marker='^',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="green", markerfacecolor='None')
    Ld_, = ax1.plot(df_ninj_corre["r"],df_ninj_corre["fitcorre_pow"]/(0.375*0.375),label=label,ls="--",lw=1.5,color="k",
             marker='^',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #---------|P(r)| delta = 0.375
    slope = df_pyy["slope_pow"].values[0]
    Kc = round(-slope,2)  
    label = r"$P^{yy}(r)/\delta^2$, $K_{SC}^{yy}$=%.2f"%(Kc)
    Lp, = ax1.plot(df_pyy["r"],df_pyy["corre_abs"]/(0.375*0.375),label=label,ls="-",lw=1.5,color="magenta",
             marker='v',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="magenta", markerfacecolor='None')
    Lp_, = ax1.plot(df_pyy["r"],df_pyy["fitcorre_pow"]/(0.375*0.375),label=label,ls="--",lw=1.5,color="k",
    ...
    legend2=plt.legend(handles=[Lf,Lg,Ld,Lp], loc = 4, bbox_to_anchor=(0.60, -0.02),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    ...
    #=========================================================
    ax1.text(27,0.38,"(a)",fontsize = 20, color='black', rotation = 0)
    ax1.text(5,0.2, r'$\mathrm{\delta} = 0.375$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax1.text(5,1e-7, r'$L_y = 3$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax1.text(9,1e-7, r'$L_x = 48$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax1.text(9,1e-8, 'LEL', fontsize = 16, fontdict={'family' : 'Arial'},color='olive', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
    ...
    Kc = round(-slope,2)  
    label = r"$|G(r)|/\delta$, $K_G$=%.2f"%(Kc)
    Lg, = ax2.plot(df_cicj["r"],df_cicj["corre_abs"]/(0.5),label=label,ls="-",lw=1.5,color="blue",
             marker='s',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="blue", markerfacecolor='None')
    Lg_, = ax2.plot(df_cicj["r"],df_cicj["fitcorre_pow"]/(0.5),label=label,ls="--",lw=1.5,color="k",
             marker='s',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #---------|D(r)| delta = 0.5
    slope = df_ninj_corre["slope_pow"].values[0]
    Kc = round(-slope,2)  
    label = r"$-D(r)/\delta^2$, $K_D$=%.2f"%(Kc)
    Ld, = ax2.plot(df_ninj_corre["r"],df_ninj_corre["corre_abs"]/(0.5*0.5),label=label,ls="-",lw=1.5,color="green",
             marker='^',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="green", markerfacecolor='None')
    Ld_, = ax2.plot(df_ninj_corre["r"],df_ninj_corre["fitcorre_pow"]/(0.5*0.5),label=label,ls="--",lw=1.5,color="k",
             marker='^',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #---------|P(r)| delta = 0.5
    slope = df_pyy["slope_pow"].values[0]
    Kc = round(-slope,2)  
    label = r"$P^{yy}(r)/\delta^2$, $K_{SC}^{yy}$=%.2f"%(Kc)
    Lp, = ax2.plot(df_pyy["r"],df_pyy["corre_abs"]/(0.5*0.5),label=label,ls="-",lw=1.5,color="magenta",
             marker='v',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="magenta", markerfacecolor='None')
    Lp_, = ax2.plot(df_pyy["r"],df_pyy["fitcorre_pow"]/(0.5*0.5),label=label,ls="--",lw=1.5,color="k",
             marker='v',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    ####图例设置
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 15, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    #legend1=plt.legend(handles=[], loc = 4, bbox_to_anchor=(0.99, 0.778),
    ...
    #=========================================================
    ax2.text(26.5,0.3,"(b)",fontsize = 20, color='black', rotation = 0)
    ax2.text(5,0.2, r'$\mathrm{\delta} = 0.5$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax2.text(10,0.5e-6, r'$L_y = 3$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax2.text(10,1.3e-7, r'$L_x = 48$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax2.text(10,1.3e-6, "TLL", fontsize = 16, fontdict={'family' : 'Arial'},color='olive', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
    ...
    Lbf, = ax3.plot(dfb_sisj["r"],dfb_sisj["corre_abs"],label=label,ls="-",lw=1.5,color="red",
             marker='o',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="red", markerfacecolor='None')
    #Lbf_, = ax3.plot(dfb_sisj["r"],dfb_sisj["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
    #         marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #---------|G(r)| delta = 0.375
    ...
    label = r"$|G(r)|/\delta$"
    Lbg, = ax3.plot(dfb_cicj["r"],dfb_cicj["corre_abs"]/(0.375),label=label,ls="-",lw=1.5,color="blue",
             marker='s',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="blue", markerfacecolor='None')
    #Lbg_, = ax3.plot(dfb_cicj["r"],dfb_cicj["fitcorre_pow"]/(0.375),label=label,ls="--",lw=1.5,color="k",
    #         marker='s',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #---------|D(r)| delta = 0.375
    slope = dfb_ninj_corre["slope_pow"].values[0]
    Kc = round(-slope,2)  
    label = r"$-D(r)/\delta^2$, $K_D$=%.2f"%(Kc)
    Lbd, = ax3.plot(dfb_ninj_corre["r"],dfb_ninj_corre["corre_abs"]/(0.375*0.375),label=label,ls="-",lw=1.5,color="green",
             marker='^',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="green", markerfacecolor='None')
    Lbd_, = ax3.plot(dfb_ninj_corre["r"],dfb_ninj_corre["fitcorre_pow"]/(0.375*0.375),label=label,ls="--",lw=1.5,color="k",
             marker='^',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #---------|P(r)| delta = 0.375
    slope = dfb_pyy["slope_pow"].values[0]
    Kc = round(-slope,2)  
    label = r"$P^{yy}(r)/\delta^2$"
    Lbp, = ax3.plot(dfb_pyy["r"],dfb_pyy["corre_abs"]/(0.375*0.375),label=label,ls="-",lw=1.5,color="magenta",
             marker='v',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="magenta", markerfacecolor='None')
    #Lbp_, = ax3.plot(dfb_pyy["r"],dfb_pyy["fitcorre_pow"]/(0.375*0.375),label=label,ls="--",lw=1.5,color="k",
    #         marker='v',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #---------|P(r)| delta = 0.375
    slope = dfb_pzz["slope_pow"].values[0]
    Kc = round(-1/slope,2)  
    label = r"$P^{zz}(r)/\delta^2$, $K_{SC}^{zz}$=%.2f"%(Kc)
    Lbpz, = ax3.plot(dfb_pzz["r"],dfb_pzz["corre_abs"]/(0.375*0.375),label=label,ls="-",lw=1.5,color="cyan",
             marker='v',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="cyan", markerfacecolor='None')
    Lbpz_, = ax3.plot(dfb_pzz["r"],dfb_pzz["fitcorre_pow"]/(0.375*0.375),label=label,ls="--",lw=1.5,color="k",
             marker='v',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    ####图例设置
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 15, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    #legend1=plt.legend(handles=[], loc = 4, bbox_to_anchor=(0.99, 0.778),
    #                   ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    legend2=plt.legend(handles=[Lbf,Lbg,Lbd,Lbp,Lbpz], loc = 4, bbox_to_anchor=(0.60, -0.02),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    #plt.gca().add_artist(legend1)#####把图例legend1重新加载回来
    label_x = r"r"
    label_y = "Correlation"
    ...
    #=========================================================
    ax3.text(28,0.32,"(c)",fontsize = 20, color='black', rotation = 0)
    ax3.text(9,0.3e-17, r'$\mathrm{\delta} = 0.375$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax3.text(9,0.3e-18, r'$J_{\bot} = 4.0$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax3.text(5,1.0e-12, r'$L_z = 2$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax3.text(5,1.0e-13, r'$L_y = 3$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax3.text(5,1.0e-14, r'$L_x = 48$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax3.text(5,1.0e-15, r'ZZ-SC', fontsize = 16, fontdict={'family' : 'Arial'},color='olive', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
    ...
    dfb_pyy = get_data_pyy(Lz=2,Ly=3,Lx=48,dop=144,t=t,J=J,Jz=4.0,dim=6000)
    dfb_pzz = get_data_pzz(Lz=2,Ly=3,Lx=48,dop=144,t=t,J=J,Jz=4.0,dim=6000)
    #---------|F(r)| delta = 0.5
    slope = dfb_sisj["slope_pow"].values[0]
    Kc = round(-slope,2)  
    #label = r"F(r) $K_F$=%.2f"%(Kc)
    ...
    Kc = round(-slope,2)  
    label = r"$|G(r)|/\delta$"
    Lbg, = ax4.plot(dfb_cicj["r"],dfb_cicj["corre_abs"]/(0.5),label=label,ls="-",lw=1.5,color="blue",
             marker='s',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="blue", markerfacecolor='None')
    #Lbg_, = ax4.plot(dfb_cicj["r"],dfb_cicj["fitcorre_pow"]/(0.5),label=label,ls="--",lw=1.5,color="k",
    #         marker='s',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #---------|D(r)| delta = 0.5
    slope = dfb_ninj_corre["slope_pow"].values[0]
    Kc = round(-slope,2)  
    label = r"$-D(r)/\delta^2$, $K_D$=%.2f"%(Kc)
    Lbd, = ax4.plot(dfb_ninj_corre["r"],dfb_ninj_corre["corre_abs"]/(0.5*0.5),label=label,ls="-",lw=1.5,color="green",
             marker='^',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="green", markerfacecolor='None')
    Lbd_, = ax4.plot(dfb_ninj_corre["r"],dfb_ninj_corre["fitcorre_pow"]/(0.5*0.5),label=label,ls="--",lw=1.5,color="k",
             marker='^',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #---------|P(r)| delta = 0.5
    slope = dfb_pyy["slope_pow"].values[0]
    Kc = round(-slope,2)  
    #label = r"$P^{yy}(r)/\delta^2$, $K_{SC}^{yy}$=%.2f"%(Kc)
    label = r"$P^{yy}(r)/\delta^2$"
    Lbp, = ax4.plot(dfb_pyy["r"],dfb_pyy["corre_abs"]/(0.5*0.5),label=label,ls="-",lw=1.5,color="magenta",
             marker='v',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="magenta", markerfacecolor='None')
    #Lbp_, = ax4.plot(dfb_pyy["r"],dfb_pyy["fitcorre_pow"]/(0.5*0.5),label=label,ls="--",lw=1.5,color="k",
    #         marker='v',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #---------|P(r)| delta = 0.5
    slope = dfb_pzz["slope_pow"].values[0]
    Kc = round(-1/slope,2)  
    label = r"$P^{zz}(r)/\delta^2$, $K_{SC}^{zz}$=%.2f"%(Kc)
    Lbpz, = ax4.plot(dfb_pzz["r"],dfb_pzz["corre_abs"]/(0.5*0.5),label=label,ls="-",lw=1.5,color="cyan",
             marker='v',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="cyan", markerfacecolor='None')
    Lbpz_, = ax4.plot(dfb_pzz["r"],dfb_pzz["fitcorre_pow"]/(0.5*0.5),label=label,ls="--",lw=1.5,color="k",
             marker='v',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    ####图例设置
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 15, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    #legend1=plt.legend(handles=[], loc = 4, bbox_to_anchor=(0.99, 0.778),
    ...
    #=========================================================
    ax4.text(26.5,0.3,"(d)",fontsize = 20, color='black', rotation = 0)
    ax4.text(10,1.0e-12, r'$\mathrm{\delta} = 0.5$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax4.text(10,1.0e-13, r'$J_{\bot} = 4.0$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax4.text(5,1.0e-6, r'$L_z = 2$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax4.text(5,1.0e-7, r'$L_y = 3$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax4.text(5,1.0e-8, r'$L_x = 48$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax4.text(5,1.0e-9, r'ZZ-SC', fontsize = 16, fontdict={'family' : 'Arial'},color='olive', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
    ...
    plt.savefig("E:\\WORK\\Work\\Project\\La3Ni2O7\\datashow_datpy_paper\\figs\\fig_Ly3_1_v2.eps",
