...
if __name__ =="__main__":
    ...
    ax1 = plt.axes([0.1,0.12,0.38,0.8])
    ax2 = plt.axes([0.55,0.12,0.38,0.8])
    #
    # 选择子图 ax1 进行绘图
    ...
    ax1.text(2,4.35,"(a)",fontsize = 20, color='black', rotation = 0)
    ax1.text(15,3.7,r"$\delta$=0.4583",fontsize = 16, color='black', rotation = 0)
    ax1.text(15,3.5,r"$J_{\bot}$=1.0",fontsize = 16, color='black', rotation = 0)
    ax1.text(15,3.3,r"$L_{x}$=48",fontsize = 16, color='black', rotation = 0)
    #
    #=======================================================================================
    # 坐标轴设置第一层
    ...
    dflog_ent_10_14000 = get_entropy_Lz2(Lz=2,Ly=2,Lx=48,dop=88,t=3,J=1,Jz= 1.0,dim=14000)
    #
    ...
    label_fitdata = r"Dim=%d, c = %.2f"%(6000,slope,)
    Lent10_6000, = ax2.plot(dflog_ent_10_6000["logr"].values[6:-1],dflog_ent_10_6000["entropy"].values[6:-1],label=label_fitdata,ls="-",lw=1.5,color="r",
             marker='o',alpha=1,markersize=8,markeredgewidth=1.0, markeredgecolor="r", markerfacecolor='None')
    #Lent10_fit_6000, = ax2.plot(dflog_ent_10_6000["logr"].values[3:-1],dflog_ent_10_6000["fitentropy"].values[3:-1], label=label_fitdata,ls="--",lw=1.5,color="k",
    ...
    label_fitdata = r"Dim=%d, c = %.2f"%(8000,slope,)
    Lent10_8000, = ax2.plot(dflog_ent_10_8000["logr"].values[6:-1],dflog_ent_10_8000["entropy"].values[6:-1],label=label_fitdata,ls="-",lw=1.5,color="blue",
             marker='s',alpha=1,markersize=8,markeredgewidth=1.0, markeredgecolor="blue", markerfacecolor='None')
    #Lent10_fit_8000, = ax2.plot(dflog_ent_10_8000["logr"].values[3:-1],dflog_ent_10_8000["fitentropy"].values[3:-1], label=label_fitdata,ls="--",lw=1.5,color="k",
    ...
    label_fitdata = r"Dim=%d, c = %.2f"%(10000,slope,)
    Lent10_10000, = ax2.plot(dflog_ent_10_10000["logr"].values[6:-1],dflog_ent_10_10000["entropy"].values[6:-1],label=label_fitdata,ls="-",lw=1.5,color="g",
             marker='^',alpha=1,markersize=8,markeredgewidth=1.0, markeredgecolor="g", markerfacecolor='None')
    #Lent10_fit_10000, = ax2.plot(dflog_ent_10_10000["logr"].values[3:-1],dflog_ent_10_10000["fitentropy"].values[3:-1], label=label_fitdata,ls="--",lw=1.5,color="k",
    ...
    label_fitdata = r"Dim=%d, c = %.2f"%(12000,slope,)
    Lent10_12000, = ax2.plot(dflog_ent_10_12000["logr"].values[6:-1],dflog_ent_10_12000["entropy"].values[6:-1],label=label_fitdata,ls="-",lw=1.5,color="magenta",
             marker='v',alpha=1,markersize=8,markeredgewidth=1.0, markeredgecolor="magenta", markerfacecolor='None')
    #Lent10_fit_12000, = ax2.plot(dflog_ent_10_12000["logr"].values[3:-1],dflog_ent_10_12000["fitentropy"].values[3:-1], label=label_fitdata,ls="--",lw=1.5,color="k",
    #         marker='v',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k",markerfacecolor='None')
    #
    slope = dflog_ent_10_14000["slope"].values[0]
    intercept = dflog_ent_10_14000["intercept"].values[0]
    #label_fitdata = r"Dim=%d c = %.2f g= %.2f"%(12000,slope,intercept)
    label_fitdata = r"Dim=%d, c = %.2f"%(14000,slope,)
    Lent10_14000, = ax2.plot(dflog_ent_10_14000["logr"].values[6:-1],dflog_ent_10_14000["entropy"].values[6:-1],label=label_fitdata,ls="-",lw=1.5,color="cyan",
             marker='>',alpha=1,markersize=8,markeredgewidth=1.0, markeredgecolor="cyan", markerfacecolor='None')
    Lent10_fit_14000, = ax2.plot(dflog_ent_10_14000["logr"].values[6:-1],dflog_ent_10_14000["fitentropy"].values[6:-1], label=label_fitdata,ls="--",lw=1.5,color="k",
             marker='>',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k",markerfacecolor='None')
    ####图例设置
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 14, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[Lent10_6000,Lent10_8000,Lent10_10000,Lent10_12000,Lent10_14000], loc = 4, bbox_to_anchor=(0.64, 0.59),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    ...
    ax2.set_yticks([4.10,4.20,4.30,4.40])
    #
    #=========================================================
    ax2.text(0.447,4.025,"(b)",fontsize = 20, color='black', rotation = 0)
    ax2.text(0.42,4.125, r'$\mathrm{\delta} = 0.4583$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax2.text(0.42,4.09, r'$J_{\bot} = 1.0$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax2.text(0.42,4.055, r'$L_{x} = 48$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
