...
if __name__ =="__main__":
    ...
    L025, = ax1.plot(df_sisj_Jz025["r"],df_sisj_Jz025["corre_abs"],label=label,ls="-",lw=1.5,color="r",
             marker='o',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="r", markerfacecolor='None')
    L025_, = ax1.plot(df_sisj_Jz025["r"],df_sisj_Jz025["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
    ...
    L075, = ax1.plot(df_sisj_Jz075["r"],df_sisj_Jz075["corre_abs"],label=label,ls="-",lw=1.5,color="green",
             marker='^',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="green", markerfacecolor='None')
    L075_, = ax1.plot(df_sisj_Jz075["r"],df_sisj_Jz075["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
    ...
    L175, = ax1.plot(df_sisj_Jz175["r"],df_sisj_Jz175["corre_abs"],label=label,ls="-",lw=1.5,color="brown",
             marker='h',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="brown", markerfacecolor='None')
    L175_, = ax1.plot(df_sisj_Jz175["r"],df_sisj_Jz175["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='h',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #--------- J_\bot = 2.5
    slope = df_sisj_Jz25["slope_pow"].values[0]
    K_F = round(-slope,2)  
    label = r"$J_{\bot}$=%.2f $K_F$=%.2f"%(2.5,K_F)
    L25, = ax1.plot(df_sisj_Jz25["r"],df_sisj_Jz25["corre_abs"],label=label,ls="-",lw=1.5,color="blue",
             marker='^',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="blue", markerfacecolor='None')
    L25_, = ax1.plot(df_sisj_Jz25["r"],df_sisj_Jz25["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='^',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #-------- J_\bot = 3.0
    slope = df_sisj_Jz30["slope_pow"].values[0]
    K_F = round(-slope,2)  
    label = r"$J_{\bot}$=%.2f $K_F$=%.2f"%(3.0,K_F)
    L30, = ax1.plot(df_sisj_Jz30["r"],df_sisj_Jz30["corre_abs"],label=label,ls="-",lw=1.5,color="cyan",
             marker='+',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="cyan", markerfacecolor='None')
    L30_, = ax1.plot(df_sisj_Jz30["r"],df_sisj_Jz30["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='+',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #-------- J_\bot = 3.5
    slope = df_sisj_Jz35["slope_pow"].values[0]
    K_F = round(-slope,2)  
    label = r"$J_{\bot}$=%.2f $K_F$=%.2f"%(3.5,K_F)
    L35, = ax1.plot(df_sisj_Jz35["r"],df_sisj_Jz35["corre_abs"],label=label,ls="-",lw=1.5,color="magenta",
             marker='h',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="magenta", markerfacecolor='None')
    L35_, = ax1.plot(df_sisj_Jz35["r"],df_sisj_Jz35["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='h',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #
    ####图例设置
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 14, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L025,L075,L175,L25,L30,L35], loc = 4, bbox_to_anchor=(0.72, 0.02),
    ...
    ax1.text(1,0.0005, r'$\mathrm{\delta} = 0.5$', fontsize = 20, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
    ...
    #--------- J_\bot = 0.25
    slope = df_cicj_Jz025["slope_pow"].values[0]
    K_F = round(-slope,2)  
    label = r"$J_{\bot}$=%.2f $K_G$=%.2f"%(0.25,K_F)
    L025, = ax2.plot(df_cicj_Jz025["r"],df_cicj_Jz025["corre_abs"],label=label,ls="-",lw=1.5,color="r",
             marker='o',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="r", markerfacecolor='None')
    L025_, = ax2.plot(df_cicj_Jz025["r"],df_cicj_Jz025["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #--------- J_\bot = 0.75
    slope = df_cicj_Jz075["slope_pow"].values[0]
    K_F = round(-slope,2)  
    label = r"$J_{\bot}$=%.2f $K_G$=%.2f"%(0.75,K_F)
    L075, = ax2.plot(df_cicj_Jz075["r"],df_cicj_Jz075["corre_abs"],label=label,ls="-",lw=1.5,color="green",
             marker='^',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="green", markerfacecolor='None')
    L075_, = ax2.plot(df_cicj_Jz075["r"],df_cicj_Jz075["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='^',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #-------- J_\bot = 1.75
    slope = df_cicj_Jz175["slope_pow"].values[0]
    K_F = round(-slope,2)  
    label = r"$J_{\bot}$=%.2f $K_G$=%.2f"%(1.75,K_F)
    L175, = ax2.plot(df_cicj_Jz175["r"],df_cicj_Jz175["corre_abs"],label=label,ls="-",lw=1.5,color="brown",
             marker='h',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="brown", markerfacecolor='None')
    ...
    K_F = round(-slope,2)  
    label = r"$J_{\bot}$=%.2f $K_G$=%.2f"%(2.5,K_F)
    L25, = ax2.plot(df_cicj_Jz25["r"],df_cicj_Jz25["corre_abs"],label=label,ls="-",lw=1.5,color="blue",
             marker='^',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="blue", markerfacecolor='None')
    L25_, = ax2.plot(df_cicj_Jz25["r"],df_cicj_Jz25["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='^',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #-------- J_\bot = 3.0
    slope = df_cicj_Jz30["slope_pow"].values[0]
    K_F = round(-slope,2)  
    label = r"$J_{\bot}$=%.2f $K_G$=%.2f"%(3.0,K_F)
    L30, = ax2.plot(df_cicj_Jz30["r"],df_cicj_Jz30["corre_abs"],label=label,ls="-",lw=1.5,color="cyan",
             marker='+',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="cyan", markerfacecolor='None')
    L30_, = ax2.plot(df_cicj_Jz30["r"],df_cicj_Jz30["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='+',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #-------- J_\bot = 3.5
    slope = df_cicj_Jz35["slope_pow"].values[0]
    K_F = round(-slope,2)  
    label = r"$J_{\bot}$=%.2f $K_G$=%.2f"%(3.5,K_F)
    L35, = ax2.plot(df_cicj_Jz35["r"],df_cicj_Jz35["corre_abs"],label=label,ls="-",lw=1.5,color="magenta",
             marker='h',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="magenta", markerfacecolor='None')
    L35_, = ax2.plot(df_cicj_Jz35["r"],df_cicj_Jz35["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='h',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    ####图例设置
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 14, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L025,L075,L175,L25,L30,L35], loc = 4, bbox_to_anchor=(0.74, -0.05),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    ...
    ax2.text(1,0.0005, r'$\mathrm{\delta} = 0.5$', fontsize = 20, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
    ...
    L025, = ax5.plot(df_ninj_Jz025["r"],df_ninj_Jz025["corre_abs"],label=label,ls="-",lw=1.5,color="r",
             marker='o',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="r", markerfacecolor='None')
    L025_, = ax5.plot(df_ninj_Jz025["r"],df_ninj_Jz025["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
    ...
    L075, = ax5.plot(df_ninj_Jz075["r"],df_ninj_Jz075["corre_abs"],label=label,ls="-",lw=1.5,color="green",
             marker='^',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="green", markerfacecolor='None')
    L075_, = ax5.plot(df_ninj_Jz075["r"],df_ninj_Jz075["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
             marker='^',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #-------- J_\bot = 1.75
    slope = df_ninj_Jz175["slope_exp"].values[0]
    xi = round(-1/slope,2)  
    label = r"$J_{\bot}$=%.2f $\xi_{D}$=%.2f"%(1.75,xi)
    L175, = ax5.plot(df_ninj_Jz175["r"],df_ninj_Jz175["corre_abs"],label=label,ls="-",lw=1.5,color="brown",
             marker='h',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="brown", markerfacecolor='None')
    L175_, = ax5.plot(df_ninj_Jz175["r"],df_ninj_Jz175["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
             marker='h',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #--------- J_\bot = 2.5
    slope = df_ninj_Jz25["slope_exp"].values[0]
    xi = round(-1/slope,2)  
    label = r"$J_{\bot}$=%.2f $\xi_{D}$=%.2f"%(2.5,xi)
    L25, = ax5.plot(df_ninj_Jz25["r"],df_ninj_Jz25["corre_abs"],label=label,ls="-",lw=1.5,color="blue",
             marker='^',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="blue", markerfacecolor='None')
    L25_, = ax5.plot(df_ninj_Jz25["r"],df_ninj_Jz25["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
             marker='^',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #-------- J_\bot = 3.0
    slope = df_ninj_Jz30["slope_exp"].values[0]
    xi = round(-1/slope,2)  
    label = r"$J_{\bot}$=%.2f $\xi_{D}$=%.2f"%(3.0,xi)
    L30, = ax5.plot(df_ninj_Jz30["r"],df_ninj_Jz30["corre_abs"],label=label,ls="-",lw=1.5,color="cyan",
             marker='+',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="cyan", markerfacecolor='None')
    L30_, = ax5.plot(df_ninj_Jz30["r"],df_ninj_Jz30["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
             marker='+',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #-------- J_\bot = 3.5
    slope = df_ninj_Jz35["slope_exp"].values[0]
    xi = round(-1/slope,2)  
    label = r"$J_{\bot}$=%.2f $\xi_{D}$=%.2f"%(3.5,xi)
    L35, = ax5.plot(df_ninj_Jz35["r"],df_ninj_Jz35["corre_abs"],label=label,ls="-",lw=1.5,color="magenta",
             marker='h',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="magenta", markerfacecolor='None')
    L35_, = ax5.plot(df_ninj_Jz35["r"],df_ninj_Jz35["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
             marker='h',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    ####图例设置
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 14, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L025,L075,L175,L25,L30,], loc = 4, bbox_to_anchor=(1.05, 0.58),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    ...
    #=========================================================
    ax5.text(2,0.03,"(c)",fontsize = 20, color='black', rotation = 0)
    ax5.text(2,3e-6, r'$\mathrm{\delta} = 0.5$', fontsize = 20, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
    ...
    L025, = ax6.plot(df_pyy_Jz025["r"],df_pyy_Jz025["corre_abs"],label=label,ls="-",lw=1.5,color="r",
             marker='o',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="r", markerfacecolor='w')
    L025_, = ax6.plot(df_pyy_Jz025["r"],df_pyy_Jz025["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
    ...
    L075, = ax6.plot(df_pyy_Jz075["r"],df_pyy_Jz075["corre_abs"],label=label,ls="-",lw=1.5,color="green",
             marker='^',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="green", markerfacecolor='None')
    L075_, = ax6.plot(df_pyy_Jz075["r"],df_pyy_Jz075["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
             marker='^',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #-------- J_\bot = 1.75
    slope = df_pyy_Jz175["slope_exp"].values[0]
    xi = round(-1/slope,2)  
    label = r"$J_{\bot}$=%.2f $\xi_{SC}^{yy}$=%.2f"%(1.75,xi)
    L175, = ax6.plot(df_pyy_Jz175["r"],df_pyy_Jz175["corre_abs"],label=label,ls="-",lw=1.5,color="brown",
             marker='h',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="brown", markerfacecolor='None')
    L175_, = ax6.plot(df_pyy_Jz175["r"],df_pyy_Jz175["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
             marker='h',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #--------- J_\bot = 2.5
    slope = df_pyy_Jz25["slope_exp"].values[0]
    xi = round(-1/slope,2)  
    label = r"$J_{\bot}$=%.2f $\xi_{SC}^{yy}$=%.2f"%(2.5,xi)
    L25, = ax6.plot(df_pyy_Jz25["r"],df_pyy_Jz25["corre_abs"],label=label,ls="-",lw=1.5,color="blue",
             marker='^',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="blue", markerfacecolor='None')
    L25_, = ax6.plot(df_pyy_Jz25["r"],df_pyy_Jz25["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
             marker='^',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #-------- J_\bot = 3.0
    slope = df_pyy_Jz30["slope_exp"].values[0]
    xi = round(-1/slope,2)  
    label = r"$J_{\bot}$=%.2f $\xi_{SC}^{yy}$=%.2f"%(3.0,xi)
    L30, = ax6.plot(df_pyy_Jz30["r"],df_pyy_Jz30["corre_abs"],label=label,ls="-",lw=1.5,color="cyan",
             marker='+',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="cyan", markerfacecolor='None')
    L30_, = ax6.plot(df_pyy_Jz30["r"],df_pyy_Jz30["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
             marker='+',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #-------- J_\bot = 3.5
    slope = df_pyy_Jz35["slope_exp"].values[0]
    xi = round(-1/slope,2)  
    label = r"$J_{\bot}$=%.2f $\xi_{SC}^{yy}$=%.2f"%(3.5,xi)
    L35, = ax6.plot(df_pyy_Jz35["r"],df_pyy_Jz35["corre_abs"],label=label,ls="-",lw=1.5,color="magenta",
             marker='h',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="magenta", markerfacecolor='w')
    L35_, = ax6.plot(df_pyy_Jz35["r"],df_pyy_Jz35["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
             marker='h',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    ####图例设置
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 14, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L025,L075,L175,], loc = 4, bbox_to_anchor=(1.05, 0.70),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    legend2=plt.legend(handles=[L25,L30,L35], loc = 4, bbox_to_anchor=(0.78, -0.02),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    plt.gca().add_artist(legend1)
    label_x = r"r"
    label_y = "$\Phi^{yy}$"
    ...
    #=========================================================
    ax6.text(2,0.003,"(d)",fontsize = 20, color='black', rotation = 0)
    ax6.text(2,1e-6, r'$\mathrm{\delta} = 0.5$', fontsize = 20, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
    ...
    L025, = ax3.plot(df_pzz_Jz025["r"],df_pzz_Jz025["corre_abs"],label=label,ls="-",lw=1.5,color="r",
             marker='o',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="r", markerfacecolor='None')
    L025_, = ax3.plot(df_pzz_Jz025["r"],df_pzz_Jz025["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="r", markerfacecolor='w')
    #--------- J_\bot = 0.75
    slope = df_pzz_Jz075["slope_exp"].values[0]
    xi = round(-1/slope,2)  
    label = r"$J_{\bot}$=%.2f $\xi_{SC}^{zz}$=%.2f"%(0.75,xi)
    L075, = ax3.plot(df_pzz_Jz075["r"],df_pzz_Jz075["corre_abs"],label=label,ls="-",lw=1.5,color="green",
             marker='^',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="green", markerfacecolor='None')
    L075_, = ax3.plot(df_pzz_Jz075["r"],df_pzz_Jz075["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
             marker='^',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #-------- J_\bot = 1.75
    slope = df_pzz_Jz175["slope_exp"].values[0]
    xi = round(-1/slope,2)  
    label = r"$J_{\bot}$=%.2f $\xi_{SC}^{zz}$=%.2f"%(1.75,xi)
    L175, = ax3.plot(df_pzz_Jz175["r"],df_pzz_Jz175["corre_abs"],label=label,ls="-",lw=1.5,color="brown",
             marker='h',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="brown", markerfacecolor='None')
    L175_, = ax3.plot(df_pzz_Jz175["r"],df_pzz_Jz175["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
             marker='h',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #--------- J_\bot = 2.5
    slope = df_pzz_Jz25["slope_exp"].values[0]
    xi = round(-1/slope,2)  
    label = r"$J_{\bot}$=%.2f $\xi_{SC}^{zz}$=%.2f"%(2.5,xi)
    L25, = ax3.plot(df_pzz_Jz25["r"],df_pzz_Jz25["corre_abs"],label=label,ls="-",lw=1.5,color="blue",
             marker='^',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="blue", markerfacecolor='None')
    L25_, = ax3.plot(df_pzz_Jz25["r"],df_pzz_Jz25["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
             marker='^',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #-------- J_\bot = 3.0
    slope = df_pzz_Jz30["slope_exp"].values[0]
    xi = round(-1/slope,2)  
    label = r"$J_{\bot}$=%.2f $\xi_{SC}^{zz}$=%.2f"%(3.0,xi)
    L30, = ax3.plot(df_pzz_Jz30["r"],df_pzz_Jz30["corre_abs"],label=label,ls="-",lw=1.5,color="cyan",
             marker='+',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="cyan", markerfacecolor='None')
    L30_, = ax3.plot(df_pzz_Jz30["r"],df_pzz_Jz30["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
             marker='+',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #-------- J_\bot = 3.5
    slope = df_pzz_Jz35["slope_exp"].values[0]
    xi = round(-1/slope,2)  
    label = r"$J_{\bot}$=%.2f $\xi_{SC}^{zz}$=%.2f"%(3.5,xi)
    L35, = ax3.plot(df_pzz_Jz35["r"],df_pzz_Jz35["corre_abs"],label=label,ls="-",lw=1.5,color="magenta",
             marker='h',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="magenta", markerfacecolor='None')
    L35_, = ax3.plot(df_pzz_Jz35["r"],df_pzz_Jz35["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
             marker='h',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    ####图例设置
    ####图例设置
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 14, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    ...
    #=========================================================
    ax3.text(2,0.01,"(e)",fontsize = 20, color='black', rotation = 0)
    ax3.text(2,1e-6, r'$\mathrm{\delta} = 0.5$', fontsize = 20, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
    ...
    #----------------------------------------------------------------------------
    # 选择子图 ax6 进行绘图
    plt.sca(ax4) ## 选择对 ax6 进行绘图
    ax4 = plt.gca()
    #--------- J_\bot = 0.25
    slope = df_pzz_Jz025["slope_pow"].values[0]
    K_F = round(-slope,2)  
    label = r"$J_{\bot}$=%.2f $K_{SC}^{zz}$=%.2f"%(0.25,K_F)
    L025, = ax4.plot(df_pzz_Jz025["r"],df_pzz_Jz025["corre_abs"],label=label,ls="-",lw=1.5,color="r",
             marker='o',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="r", markerfacecolor='None')
    L025_, = ax4.plot(df_pzz_Jz025["r"],df_pzz_Jz025["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #--------- J_\bot = 0.75
    slope = df_pzz_Jz075["slope_pow"].values[0]
    K_F = round(-slope,2)  
    label = r"$J_{\bot}$=%.2f $K_{SC}^{zz}$=%.2f"%(0.75,K_F)
    L075, = ax4.plot(df_pzz_Jz075["r"],df_pzz_Jz075["corre_abs"],label=label,ls="-",lw=1.5,color="green",
             marker='^',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="green", markerfacecolor='None')
    L075_, = ax4.plot(df_pzz_Jz075["r"],df_pzz_Jz075["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='^',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #-------- J_\bot = 1.75
    slope = df_pzz_Jz175["slope_pow"].values[0]
    K_F = round(-slope,2)  
    label = r"$J_{\bot}$=%.2f $K_{SC}^{zz}$=%.2f"%(1.75,K_F)
    L175, = ax4.plot(df_pzz_Jz175["r"],df_pzz_Jz175["corre_abs"],label=label,ls="-",lw=1.5,color="brown",
             marker='h',alpha=1,markersize=6,markeredgewidth=1, markeredgecolor="brown", markerfacecolor='None')
    L175_, = ax4.plot(df_pzz_Jz175["r"],df_pzz_Jz175["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='h',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    ...
    L25, = ax4.plot(df_pzz_Jz25["r"],df_pzz_Jz25["corre_abs"],label=label,ls="-",lw=1.5,color="blue",
             marker='^',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="blue", markerfacecolor='None')
    L25_, = ax4.plot(df_pzz_Jz25["r"],df_pzz_Jz25["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='^',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #-------- J_\bot = 3.0
    slope = df_pzz_Jz30["slope_pow"].values[0]
    K_F = round(-slope,2)  
    label = r"$J_{\bot}$=%.2f $K_{SC}^{zz}$=%.2f"%(3.0,K_F)
    L30, = ax4.plot(df_pzz_Jz30["r"],df_pzz_Jz30["corre_abs"],label=label,ls="-",lw=1.5,color="cyan",
             marker='+',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="cyan", markerfacecolor='w')
    L30_, = ax4.plot(df_pzz_Jz30["r"],df_pzz_Jz30["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='+',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #-------- J_\bot = 3.5
    slope = df_pzz_Jz35["slope_pow"].values[0]
    K_F = round(-slope,2)  
    label = r"$J_{\bot}$=%.2f $K_{SC}^{zz}$=%.2f"%(3.5,K_F)
    L35, = ax4.plot(df_pzz_Jz35["r"],df_pzz_Jz35["corre_abs"],label=label,ls="-",lw=1.5,color="magenta",
             marker='h',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="magenta", markerfacecolor='None')
    L35_, = ax4.plot(df_pzz_Jz35["r"],df_pzz_Jz35["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='h',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    ####图例设置
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 14, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L025,], loc = 4, bbox_to_anchor=(1.05, 0.88),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    legend2=plt.legend(handles=[L075,L175,L25,L30,L35], loc = 4, bbox_to_anchor=(0.78, -0.03),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    plt.gca().add_artist(legend1)
    ...
    ax4.text(2,0.000005, r'$\mathrm{\delta} = 0.5$', fontsize = 20, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
    ...
    label = r"$J_{\bot}$=0.5"
    L05, =ax7.plot(df_ni_Jz05["rmean"].values,df_ni_Jz05["dymean"].values,label=label,ls="--",lw=1.5,color="red",
             marker='o',alpha=1,markersize=9,markeredgewidth=1.5, markeredgecolor="red", markerfacecolor='None')
    label = r"$J_{\bot}$=1.5"
    L15, =ax7.plot(df_ni_Jz15["rmean"].values,df_ni_Jz15["dymean"].values,label=label,ls="--",lw=1.5,color="blue",
             marker='^',alpha=1,markersize=9,markeredgewidth=1.5, markeredgecolor="blue", markerfacecolor='None')
    label = r"$J_{\bot}$=2.5"
    L25, =ax7.plot(df_ni_Jz25["rmean"].values,df_ni_Jz25["dymean"].values,label=label,ls="--",lw=1.5,color="green",
    ...
    legend1=plt.legend(handles=[L05,L15,L25,], loc = 4, bbox_to_anchor=(0.88, 0.01),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)    
    #
    label_x = r"x"
    label_y = "n(x)"
    ...
    ax7.tick_params(labelsize = 15) # 设置坐标刻度对应数字的大小
    ax7.set_xlim([0,48])
    ax7.set_xticks([0,10,20,30,40,48])
    #ax7.set_yticks([-1,-0.5,0,0.5,1]) 
    #=========================================================
    ax7.text(8,0.5025,"(g)",fontsize = 20, color='black', rotation = 0)
    ax7.text(20,0.5025, r'$\mathrm{\delta} = 0.5$', fontsize = 20, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=======================================================================================
    # 坐标轴设置第一层
    ...
    S_res375 = entropy(Lx=Lx,x=df_ent_40["r"].values,c=c_40,g=g_40)
    #
    L01, = ax8.plot(df_ent_01['r'].values,df_ent_01["entropy"],label=r"$J_{\bot}$=%.1f"%(0.1),ls="-",lw=1.5,color='r',
             marker='o',alpha=1,markersize=6,markeredgewidth=1.5, markeredgecolor='r',
             markerfacecolor='None')
    L01_fit, = ax8.plot(df_ent_01['r'].values,S_res01,label="c=%.2f,g=%.2f"%(c_01,g_01),ls="--",lw=1.5,color="k",
    ...
    L40, = ax8.plot(df_ent_40['r'].values,df_ent_40["entropy"],label=r"$J_{\bot}$=%.2f"%(4.0),ls="-",lw=1.5,color='blue',
             ...
             markerfacecolor='None')
    L40_fit, = ax8.plot(df_ent_40['r'].values,S_res375,label="c=%.2f,g=%.2f"%(c_40,g_40),ls="--",lw=2.5,color="green",
             marker='o',alpha=1,markersize=0,markeredgewidth=1.5, markeredgecolor="k",
             markerfacecolor='None')
    #
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 16, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    legend1=plt.legend(handles=[L01,L01_fit], loc = 4, bbox_to_anchor=(0.86, 0.45),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    legend2=plt.legend(handles=[L40,L40_fit], loc = 4, bbox_to_anchor=(0.86, 0.10),
                       ncol = 1,prop=legfont,markerscale=1,fancybox=None,shadow=None,frameon=False)
    ...
    plt.savefig("E:\\WORK\\Work\\Project\\La3Ni2O7\\datashow_datpy_paper\\figs\\fig_05_1.eps",
