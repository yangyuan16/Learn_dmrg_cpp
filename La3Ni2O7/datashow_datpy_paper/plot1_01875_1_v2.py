...
if __name__ =="__main__":
    ...
    #
    L, =ax1.plot([0,50],[0.8125,0.8125],label=" ",ls="--",lw=1.5,color="k",
    ...
    label = r"$J_{\bot}$=0.6"
    L06, =ax1.plot(df_ni_Jz06["rmean"].values,df_ni_Jz06["dymean"].values,label=label,ls="--",lw=1.5,color="magenta",
    ...
    legend1=plt.legend(handles=[L01,L04,L06,L08,L10], loc = 4, bbox_to_anchor=(0.96, 0.51),
    ...
    df_pyy = get_data_pyy_leg2(Lz=1,Ly=Ly,Lx=Lx,dop=18,t=t,J=J,Jz=0,dim=dim)
    ...
    #Lyy02, = ax2.plot(df_pyy_Jz02["r"],df_pyy_Jz02["corre_abs"],label=label,ls="-",lw=1.5,color="blue",
    #         marker='s',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="blue", markerfacecolor='None')
    #Lyy02_, = ax2.plot(df_pyy_Jz02["r"],df_pyy_Jz02["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
    ...
    #Lyy12, = ax2.plot(df_pyy_Jz12["r"],df_pyy_Jz12["corre_abs"],label=label,ls="-",lw=1.5,color="olive",
    #         marker='h',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="olive", markerfacecolor='None')
    #Lyy12_, = ax2.plot(df_pyy_Jz12["r"],df_pyy_Jz12["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
    ...
    #Lpzz02, = ax3.plot(df_pzz_Jz02["r"],df_pzz_Jz02["corre_abs"],label=label,ls="-",lw=1.5,color="blue",
    #         marker='s',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="blue", markerfacecolor='None')
    #Lpzz02_, = ax3.plot(df_pzz_Jz02["r"],df_pzz_Jz02["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
    #         marker='s',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='None')
    #--------- J_\bot = 0.4
    ...
    #Lpzz12, = ax3.plot(df_pzz_Jz12["r"],df_pzz_Jz12["corre_abs"],label=label,ls="-",lw=1.5,color="olive",
    #         marker='h',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="olive", markerfacecolor='None')
    #Lpzz12_, = ax3.plot(df_pzz_Jz12["r"],df_pzz_Jz12["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
    #         marker='h',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='None')
    #
    ####图例设置
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 12, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    ...
    ax3.text(4,0.8e-2, r'$\mathrm{\delta} = 0.1875$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ...
    L01, = ax4.plot(df_sisj_Jz01["r"],df_sisj_Jz01["corre_abs"],label=label,ls="-",lw=1.5,color="red",
             marker='o',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="red", markerfacecolor='None')
    L01_, = ax4.plot(df_sisj_Jz01["r"],df_sisj_Jz01["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
    ...
    #L02, = ax4.plot(df_sisj_Jz02["r"],df_sisj_Jz02["corre_abs"],label=label,ls="-",lw=1.5,color="blue",
    #         marker='s',alpha=1,markersize=6,markeredgewidth=1, markeredgecolor="blue", markerfacecolor='None')
    #L02_, = ax4.plot(df_sisj_Jz02["r"],df_sisj_Jz02["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
    ...
    L04, = ax4.plot(df_sisj_Jz04["r"],df_sisj_Jz04["corre_abs"],label=label,ls="-",lw=1.5,color="green",
             marker='^',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="green", markerfacecolor='None')
    L04_, = ax4.plot(df_sisj_Jz04["r"],df_sisj_Jz04["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
    ...
    L06, = ax4.plot(df_sisj_Jz06["r"],df_sisj_Jz06["corre_abs"],label=label,ls="-",lw=1.5,color="magenta",
             marker='v',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="magenta", markerfacecolor='None')
    L06_, = ax4.plot(df_sisj_Jz06["r"],df_sisj_Jz06["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
    ...
    L08, = ax4.plot(df_sisj_Jz08["r"],df_sisj_Jz08["corre_abs"],label=label,ls="-",lw=1.5,color="cyan",
             marker='<',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="cyan", markerfacecolor='None')
    L08_, = ax4.plot(df_sisj_Jz08["r"],df_sisj_Jz08["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
             marker='<',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #-------- J_\bot = 1.0
    slope = df_sisj_Jz10["slope_exp"].values[0]
    xi = round(-1/slope,2)  
    label = r"$J_{\bot}$=%.1f $\xi_F$=%.2f"%(1.0,xi)
    L10, = ax4.plot(df_sisj_Jz10["r"],df_sisj_Jz10["corre_abs"],label=label,ls="-",lw=1.5,color="brown",
             marker='>',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="brown", markerfacecolor='None')
    L10_, = ax4.plot(df_sisj_Jz10["r"],df_sisj_Jz10["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
             marker='>',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #-------- J_\bot = 1.2
    #slope = df_sisj_Jz12["slope_exp"].values[0]
    #xi = round(-1/slope,2)  
    #label = r"$J_{\bot}$=%.1f $\xi_F$=%.2f"%(1.2,xi)
    #L12, = ax4.plot(df_sisj_Jz12["r"],df_sisj_Jz12["corre_abs"],label=label,ls="-",lw=1.5,color="olive",
    #         marker='h',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="olive", markerfacecolor='None')
    #L12_, = ax4.plot(df_sisj_Jz12["r"],df_sisj_Jz12["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
    ...
    L01, = ax5.plot(df_cicj_Jz01["r"],df_cicj_Jz01["corre_abs"],label=label,ls="-",lw=1.5,color="red",
             marker='o',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="red", markerfacecolor='None')
    L01_, = ax5.plot(df_cicj_Jz01["r"],df_cicj_Jz01["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #--------- J_\bot = 0.2
    #slope = df_cicj_Jz02["slope_exp"].values[0]
    #xi = round(-1/slope,2)  
    #label = r"$J_{\bot}$=%.1f $\xi_G$=%.2f"%(0.2,xi)
    #L02, = ax5.plot(df_cicj_Jz02["r"],df_cicj_Jz02["corre_abs"],label=label,ls="-",lw=1.5,color="blue",
    #         marker='s',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="blue", markerfacecolor='None')
    #L02_, = ax5.plot(df_cicj_Jz02["r"],df_cicj_Jz02["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
    #         marker='s',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #--------- J_\bot = 0.4
    slope = df_cicj_Jz04["slope_exp"].values[0]
    xi = round(-1/slope,2)  
    label = r"$J_{\bot}$=%.1f $\xi_G$=%.2f"%(0.4,xi)
    L04, = ax5.plot(df_cicj_Jz04["r"],df_cicj_Jz04["corre_abs"],label=label,ls="-",lw=1.5,color="green",
             marker='^',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="green", markerfacecolor='None')
    L04_, = ax5.plot(df_cicj_Jz04["r"],df_cicj_Jz04["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
             marker='^',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #--------- J_\bot = 0.6
    slope = df_cicj_Jz06["slope_exp"].values[0]
    xi = round(-1/slope,2)  
    label = r"$J_{\bot}$=%.1f $\xi_G$=%.2f"%(0.6,xi)
    L06, = ax5.plot(df_cicj_Jz06["r"],df_cicj_Jz06["corre_abs"],label=label,ls="-",lw=1.5,color="magenta",
             marker='v',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="magenta", markerfacecolor='None')
    L06_, = ax5.plot(df_cicj_Jz06["r"],df_cicj_Jz06["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
             marker='v',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #-------- J_\bot = 0.8
    slope = df_cicj_Jz08["slope_exp"].values[0]
    xi = round(-1/slope,2)  
    label = r"$J_{\bot}$=%.1f $\xi_G$=%.2f"%(0.8,xi)
    L08, = ax5.plot(df_cicj_Jz08["r"],df_cicj_Jz08["corre_abs"],label=label,ls="-",lw=1.5,color="cyan",
             marker='<',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="cyan", markerfacecolor='None')
    L08_, = ax5.plot(df_cicj_Jz08["r"],df_cicj_Jz08["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
             marker='<',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #-------- J_\bot = 1.0
    slope = df_cicj_Jz10["slope_exp"].values[0]
    xi = round(-1/slope,2)  
    label = r"$J_{\bot}$=%.1f $\xi_G$=%.2f"%(1.0,xi)
    L10, = ax5.plot(df_cicj_Jz10["r"],df_cicj_Jz10["corre_abs"],label=label,ls="-",lw=1.5,color="brown",
             marker='>',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="brown", markerfacecolor='None')
    L10_, = ax5.plot(df_cicj_Jz10["r"],df_cicj_Jz10["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
             marker='>',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #-------- J_\bot = 1.2
    #slope = df_cicj_Jz12["slope_exp"].values[0]
    #xi = round(-1/slope,2)  
    #label = r"$J_{\bot}$=%.1f $\xi_G$=%.2f"%(1.2,xi)
    #L12, = ax5.plot(df_cicj_Jz12["r"],df_cicj_Jz12["corre_abs"],label=label,ls="-",lw=1.5,color="olive",
    #         marker='h',alpha=1,markersize=8,markeredgewidth=1, markeredgecolor="olive", markerfacecolor='None')
    #L12_, = ax5.plot(df_cicj_Jz12["r"],df_cicj_Jz12["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
    #         marker='h',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #--------
    ####图例设置
    legfont = {'family' : 'Times New Roman','weight' : 'normal','size': 12, }###图例字体的大小###ncol 设置列的数量，使显示扁平化，当要表示的线段特别多的时候会有用
    ...
    #Lent02, = ax6.plot(df_ent_02["logr"].values,df_ent_02["entropy"].values,label=label_fitdata,ls="-",lw=1.5,color="blue",
    #         marker='s',alpha=1,markersize=8,markeredgewidth=1.0, markeredgecolor="blue", markerfacecolor='None')
    #Lent02_fit, = ax6.plot(df_ent_02["logr"].values[6:-1],df_ent_02["fitentropy"].values[6:-1], label=label_fitdata,ls="--",lw=1.5,color="k",
    #         marker='s',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k",markerfacecolor='None')
    # J_\bot = 0.4
    ...
    #Lent08, = ax6.plot(df_ent_08["logr"].values,df_ent_08["entropy"].values,label=label_fitdata,ls="-",lw=1.5,color="cyan",
    #         marker='<',alpha=1,markersize=8,markeredgewidth=1.0, markeredgecolor="cyan", markerfacecolor='None')
    #Lent08_fit, = ax6.plot(df_ent_08["logr"].values[6:-1],df_ent_08["fitentropy"].values[6:-1], label=label_fitdata,ls="--",lw=1.5,color="k",
    #         marker='<',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k",markerfacecolor='None')
    # J_\bot = 1.0
    ...
    ax6.xaxis.set_major_formatter(FormatStrFormatter('%1.2f'))###设置X轴标签文本格式
    ...
    plt.savefig("E:\\WORK\\Work\\Project\\La3Ni2O7\\datashow_datpy_paper\\figs\\fig_01875_1_v2.eps",
