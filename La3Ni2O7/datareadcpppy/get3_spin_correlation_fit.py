...
if __name__ == "__main__":
    ...
    filepath3 = "\\measurement_spin_correlation_ref%d.dat" % (rs)
    ...
    print(len(df))
    #================选定某些数据点==========================
    df_cut_exp = df.loc[[0,2,4,6,8]] # exponential fit
    df_cut_pow = df.loc[[0,2,4,6,8]] # power law fit
    ...
    Issave = True
    if Issave:
        filepath4 = "\\measurement_spin_correlation_ref%d_fit.parquet" % (rs)
