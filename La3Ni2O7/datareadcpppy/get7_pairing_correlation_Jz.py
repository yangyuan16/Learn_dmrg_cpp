...
def get_data(Lz, Ly, Lx, dop, t, J, Jz, dim, bonds):
    ...
    filepath3 = "\\measurement_pairing_"+bonds+"_ref74.dat"
...
if __name__ == "__main__":
    ...
    J = 1
    dim = 6000 # dim cutoff
    bonds = "yy" # zz or yy 方向的pairing
    #load data
    r_Jz01, corre_Jz01 = get_data(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=0.1,dim=dim,bonds=bonds)
    r_Jz025, corre_Jz025 = get_data(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=0.25,dim=dim,bonds=bonds)
    r_Jz05, corre_Jz05 = get_data(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=0.5,dim=dim,bonds=bonds)
    r_Jz075, corre_Jz075 = get_data(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=0.75,dim=dim,bonds=bonds)
    r_Jz1, corre_Jz1 = get_data(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=1,dim=dim,bonds=bonds)
    r_Jz2, corre_Jz2 = get_data(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=2,dim=dim,bonds=bonds)
    r_Jz4, corre_Jz4 = get_data(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=4,dim=dim,bonds=bonds)
    r_Jz6, corre_Jz6 = get_data(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=6,dim=dim,bonds=bonds)
    r_Jz8, corre_Jz8 = get_data(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=8,dim=dim,bonds=bonds)
