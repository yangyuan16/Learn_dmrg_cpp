...
if __name__ =="__main__":
    ...
    df_pyy_Jz40 = get_data_pyy(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=4.0,dim=dim)
    ...
    L02, = ax1.plot(df_pyy_Jz02["r"],df_pyy_Jz02["corre_abs"],label=label,ls="-",lw=1,color="r",
             marker='o',alpha=1,markersize=4,markeredgewidth=1, markeredgecolor="k", markerfacecolor='w')
    L02_, = ax1.plot(df_pyy_Jz02["r"],df_pyy_Jz02["fitcorre_exp"],label=label,ls="--",lw=1,color="k",
    ...
    L04, = ax1.plot(df_pyy_Jz04["r"],df_pyy_Jz04["corre_abs"],label=label,ls="-",lw=1,color="blue",
             marker='s',alpha=1,markersize=4,markeredgewidth=1, markeredgecolor="k", markerfacecolor='w')
    L04_, = ax1.plot(df_pyy_Jz04["r"],df_pyy_Jz04["fitcorre_exp"],label=label,ls="--",lw=1,color="k",
    ...
    L06, = ax1.plot(df_pyy_Jz06["r"],df_pyy_Jz06["corre_abs"],label=label,ls="-",lw=1,color="green",
             marker='^',alpha=1,markersize=4,markeredgewidth=1, markeredgecolor="k", markerfacecolor='w')
    L06_, = ax1.plot(df_pyy_Jz06["r"],df_pyy_Jz06["fitcorre_exp"],label=label,ls="--",lw=1,color="k",
    ...
    L08, = ax1.plot(df_pyy_Jz08["r"],df_pyy_Jz08["corre_abs"],label=label,ls="-",lw=1,color="magenta",
             marker='v',alpha=1,markersize=4,markeredgewidth=1, markeredgecolor="k", markerfacecolor='w')
    L08_, = ax1.plot(df_pyy_Jz08["r"],df_pyy_Jz08["fitcorre_exp"],label=label,ls="--",lw=1,color="k",
    ...
    L10, = ax1.plot(df_pyy_Jz10["r"],df_pyy_Jz10["corre_abs"],label=label,ls="-",lw=1,color="cyan",
             marker='+',alpha=1,markersize=4,markeredgewidth=1, markeredgecolor="k", markerfacecolor='w')
    L10_, = ax1.plot(df_pyy_Jz10["r"],df_pyy_Jz10["fitcorre_exp"],label=label,ls="--",lw=1,color="k",
             marker='+',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #-------- J_\bot = 2.0
    slope = df_pyy_Jz20["slope_exp"].values[0]
    xi = round(-1/slope,2)  
    label = r"$J_{\bot}$=%.1f $\xi_{SC}^{yy}$=%.2f"%(2.0,xi)
    L20, = ax1.plot(df_pyy_Jz20["r"],df_pyy_Jz20["corre_abs"],label=label,ls="-",lw=1,color="pink",
             marker='*',alpha=1,markersize=4,markeredgewidth=1, markeredgecolor="k", markerfacecolor='w')
    L20_, = ax1.plot(df_pyy_Jz20["r"],df_pyy_Jz20["fitcorre_exp"],label=label,ls="--",lw=1,color="k",
             marker='*',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #-------- J_\bot = 4.0
    slope = df_pyy_Jz40["slope_exp"].values[0]
    xi = round(-1/slope,2)  
    label = r"$J_{\bot}$=%.1f $\xi_{SC}^{yy}$=%.2f"%(4.0,xi)
    L40, = ax1.plot(df_pyy_Jz40["r"],df_pyy_Jz40["corre_abs"],label=label,ls="-",lw=1,color="brown",
             marker='h',alpha=1,markersize=4,markeredgewidth=1, markeredgecolor="k", markerfacecolor='w')
    L40_, = ax1.plot(df_pyy_Jz40["r"],df_pyy_Jz40["fitcorre_exp"],label=label,ls="--",lw=1,color="k",
    ...
    L02, = ax2.plot(df_pzz_Jz02["r"],df_pzz_Jz02["corre_abs"],label=label,ls="-",lw=1,color="r",
             marker='o',alpha=1,markersize=4,markeredgewidth=1, markeredgecolor="k", markerfacecolor='w')
    L02_, = ax2.plot(df_pzz_Jz02["r"],df_pzz_Jz02["fitcorre_exp"],label=label,ls="--",lw=1,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #--------- J_\bot = 0.4
    slope = df_pzz_Jz04["slope_exp"].values[0]
    xi = round(-1/slope,2)  
    label = r"$J_{\bot}$=%.1f $\xi_{SC}^{zz}$=%.2f"%(0.4,xi)
    L04, = ax2.plot(df_pzz_Jz04["r"],df_pzz_Jz04["corre_abs"],label=label,ls="-",lw=1,color="blue",
             marker='s',alpha=1,markersize=4,markeredgewidth=1, markeredgecolor="k", markerfacecolor='w')
    L04_, = ax2.plot(df_pzz_Jz04["r"],df_pzz_Jz04["fitcorre_exp"],label=label,ls="--",lw=1,color="k",
             marker='s',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #--------- J_\bot = 0.6
    slope = df_pzz_Jz06["slope_exp"].values[0]
    xi = round(-1/slope,2)  
    label = r"$J_{\bot}$=%.1f $\xi_{SC}^{zz}$=%.2f"%(0.6,xi)
    L06, = ax2.plot(df_pzz_Jz06["r"],df_pzz_Jz06["corre_abs"],label=label,ls="-",lw=1,color="green",
             marker='^',alpha=1,markersize=4,markeredgewidth=1, markeredgecolor="k", markerfacecolor='w')
    L06_, = ax2.plot(df_pzz_Jz06["r"],df_pzz_Jz06["fitcorre_exp"],label=label,ls="--",lw=1,color="k",
             marker='^',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #--------- J_\bot = 0.8
    slope = df_pzz_Jz08["slope_exp"].values[0]
    xi = round(-1/slope,2)  
    label = r"$J_{\bot}$=%.1f $\xi_{SC}^{zz}$=%.2f"%(0.8,xi)
    L08, = ax2.plot(df_pzz_Jz08["r"],df_pzz_Jz08["corre_abs"],label=label,ls="-",lw=1,color="magenta",
             marker='v',alpha=1,markersize=4,markeredgewidth=1, markeredgecolor="k", markerfacecolor='w')
    L08_, = ax2.plot(df_pzz_Jz08["r"],df_pzz_Jz08["fitcorre_exp"],label=label,ls="--",lw=1,color="k",
             marker='v',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #-------- J_\bot = 1.0
    slope = df_pzz_Jz10["slope_exp"].values[0]
    xi = round(-1/slope,2)  
    label = r"$J_{\bot}$=%.1f $\xi_{SC}^{zz}$=%.2f"%(1.0,xi)
    L10, = ax2.plot(df_pzz_Jz10["r"],df_pzz_Jz10["corre_abs"],label=label,ls="-",lw=1,color="cyan",
             marker='+',alpha=1,markersize=4,markeredgewidth=1, markeredgecolor="k", markerfacecolor='w')
    L10_, = ax2.plot(df_pzz_Jz10["r"],df_pzz_Jz10["fitcorre_exp"],label=label,ls="--",lw=1,color="k",
             marker='+',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #-------- J_\bot = 2.0
    slope = df_pzz_Jz20["slope_exp"].values[0]
    xi = round(-1/slope,2)  
    label = r"$J_{\bot}$=%.1f $\xi_{SC}^{zz}$=%.2f"%(2.0,xi)
    L20, = ax2.plot(df_pzz_Jz20["r"],df_pzz_Jz20["corre_abs"],label=label,ls="-",lw=1,color="pink",
             marker='*',alpha=1,markersize=4,markeredgewidth=1, markeredgecolor="k", markerfacecolor='w')
    L20_, = ax2.plot(df_pzz_Jz20["r"],df_pzz_Jz20["fitcorre_exp"],label=label,ls="--",lw=1,color="k",
             marker='*',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #-------- J_\bot = 4.0
    slope = df_pzz_Jz40["slope_exp"].values[0]
    xi = round(-1/slope,2)  
    label = r"$J_{\bot}$=%.1f $\xi_{SC}^{zz}$=%.2f"%(4.0,xi)
    L40, = ax2.plot(df_pzz_Jz40["r"],df_pzz_Jz40["corre_abs"],label=label,ls="-",lw=1,color="brown",
             marker='h',alpha=1,markersize=4,markeredgewidth=1, markeredgecolor="k", markerfacecolor='w')
    L40_, = ax2.plot(df_pzz_Jz40["r"],df_pzz_Jz40["fitcorre_exp"],label=label,ls="--",lw=1,color="k",
             marker='h',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    ...
    #=========================================================
    ax2.text(36,0.02,"(b)",fontsize = 16, color='black', rotation = 0)
    ax2.text(17.5,0.02, r'$\mathrm{\delta} = \frac{3}{8}$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
    ...
    ax3 = plt.gca()
    #--------- J_\bot = 0.2
    slope = df_pyy_Jz02["slope_pow"].values[0]
    K_F = round(-slope,2)  
    label = r"$J_{\bot}$=%.1f $K_{SC}^{yy}$=%.2f"%(0.2,K_F)
    L02, = ax3.plot(df_pyy_Jz02["r"],df_pyy_Jz02["corre_abs"],label=label,ls="-",lw=1,color="r",
             marker='o',alpha=1,markersize=4,markeredgewidth=1, markeredgecolor="k", markerfacecolor='w')
    L02_, = ax3.plot(df_pyy_Jz02["r"],df_pyy_Jz02["fitcorre_pow"],label=label,ls="--",lw=1,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #--------- J_\bot = 0.4
    slope = df_pyy_Jz04["slope_pow"].values[0]
    K_F = round(-slope,2)  
    label = r"$J_{\bot}$=%.1f $K_{SC}^{yy}$=%.2f"%(0.4,K_F)
    L04, = ax3.plot(df_pyy_Jz04["r"],df_pyy_Jz04["corre_abs"],label=label,ls="-",lw=1,color="blue",
             marker='s',alpha=1,markersize=4,markeredgewidth=1, markeredgecolor="k", markerfacecolor='w')
    L04_, = ax3.plot(df_pyy_Jz04["r"],df_pyy_Jz04["fitcorre_pow"],label=label,ls="--",lw=1,color="k",
             marker='s',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #--------- J_\bot = 0.6
    slope = df_pyy_Jz06["slope_pow"].values[0]
    K_F = round(-slope,2)  
    label = r"$J_{\bot}$=%.1f $K_{SC}^{yy}$=%.2f"%(0.6,K_F)
    L06, = ax3.plot(df_pyy_Jz06["r"],df_pyy_Jz06["corre_abs"],label=label,ls="-",lw=1,color="green",
             marker='^',alpha=1,markersize=4,markeredgewidth=1, markeredgecolor="k", markerfacecolor='w')
    L06_, = ax3.plot(df_pyy_Jz06["r"],df_pyy_Jz06["fitcorre_pow"],label=label,ls="--",lw=1,color="k",
             marker='^',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #--------- J_\bot = 0.8
    slope = df_pyy_Jz08["slope_pow"].values[0]
    K_F = round(-slope,2)  
    label = r"$J_{\bot}$=%.1f $K_{SC}^{yy}$=%.2f"%(0.8,K_F)
    L08, = ax3.plot(df_pyy_Jz08["r"],df_pyy_Jz08["corre_abs"],label=label,ls="-",lw=1,color="magenta",
             marker='v',alpha=1,markersize=4,markeredgewidth=1, markeredgecolor="k", markerfacecolor='w')
    L08_, = ax3.plot(df_pyy_Jz08["r"],df_pyy_Jz08["fitcorre_pow"],label=label,ls="--",lw=1,color="k",
             marker='v',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #-------- J_\bot = 1.0
    slope = df_pyy_Jz10["slope_pow"].values[0]
    K_F = round(-slope,2)  
    label = r"$J_{\bot}$=%.1f $K_{SC}^{yy}$=%.2f"%(1.0,K_F)
    L10, = ax3.plot(df_pyy_Jz10["r"],df_pyy_Jz10["corre_abs"],label=label,ls="-",lw=1,color="cyan",
             marker='+',alpha=1,markersize=4,markeredgewidth=1, markeredgecolor="k", markerfacecolor='w')
    L10_, = ax3.plot(df_pyy_Jz10["r"],df_pyy_Jz10["fitcorre_pow"],label=label,ls="--",lw=1,color="k",
             marker='+',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #-------- J_\bot = 2.0
    slope = df_pyy_Jz20["slope_pow"].values[0]
    K_F = round(-slope,2)  
    label = r"$J_{\bot}$=%.1f $K_{SC}^{yy}$=%.2f"%(2.0,K_F)
    L20, = ax3.plot(df_pyy_Jz20["r"],df_pyy_Jz20["corre_abs"],label=label,ls="-",lw=1,color="pink",
             marker='*',alpha=1,markersize=4,markeredgewidth=1, markeredgecolor="k", markerfacecolor='w')
    L20_, = ax3.plot(df_pyy_Jz20["r"],df_pyy_Jz20["fitcorre_pow"],label=label,ls="--",lw=1,color="k",
             marker='*',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #-------- J_\bot = 4.0
    slope = df_pyy_Jz40["slope_pow"].values[0]
    K_F = round(-slope,2)  
    label = r"$J_{\bot}$=%.1f $K_{SC}^{yy}$=%.2f"%(4.0,K_F)
    L40, = ax3.plot(df_pyy_Jz40["r"],df_pyy_Jz40["corre_abs"],label=label,ls="-",lw=1,color="brown",
             marker='h',alpha=1,markersize=4,markeredgewidth=1, markeredgecolor="k", markerfacecolor='w')
    L40_, = ax3.plot(df_pyy_Jz40["r"],df_pyy_Jz40["fitcorre_pow"],label=label,ls="--",lw=1,color="k",
             marker='h',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    ...
    K_G = round(-slope,2)  
    label = r"$J_{\bot}$=%.1f $K_{SC}^{zz}$=%.2f"%(0.2,K_G)
    L02, = ax4.plot(df_pzz_Jz02["r"],df_pzz_Jz02["corre_abs"],label=label,ls="-",lw=1,color="r",
             marker='o',alpha=1,markersize=4,markeredgewidth=1, markeredgecolor="k", markerfacecolor='w')
    L02_, = ax4.plot(df_pzz_Jz02["r"],df_pzz_Jz02["fitcorre_pow"],label=label,ls="--",lw=1,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #--------- J_\bot = 0.4
    slope = df_pzz_Jz04["slope_pow"].values[0]
    K_G = round(-slope,2)  
    label = r"$J_{\bot}$=%.1f $K_{SC}^{zz}$=%.2f"%(0.4,K_G)
    L04, = ax4.plot(df_pzz_Jz04["r"],df_pzz_Jz04["corre_abs"],label=label,ls="-",lw=1,color="blue",
             marker='s',alpha=1,markersize=4,markeredgewidth=1, markeredgecolor="k", markerfacecolor='w')
    L04_, = ax4.plot(df_pzz_Jz04["r"],df_pzz_Jz04["fitcorre_pow"],label=label,ls="--",lw=1,color="k",
             marker='s',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #--------- J_\bot = 0.6
    slope = df_pzz_Jz06["slope_pow"].values[0]
    K_G = round(-slope,2)  
    label = r"$J_{\bot}$=%.1f $K_{SC}^{zz}$=%.2f"%(0.6,K_G)
    L06, = ax4.plot(df_pzz_Jz06["r"],df_pzz_Jz06["corre_abs"],label=label,ls="-",lw=1,color="green",
             marker='^',alpha=1,markersize=4,markeredgewidth=1, markeredgecolor="k", markerfacecolor='w')
    L06_, = ax4.plot(df_pzz_Jz06["r"],df_pzz_Jz06["fitcorre_pow"],label=label,ls="--",lw=1,color="k",
             marker='^',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #--------- J_\bot = 0.8
    slope = df_pzz_Jz08["slope_pow"].values[0]
    K_G = round(-slope,2)  
    label = r"$J_{\bot}$=%.1f $K_{SC}^{zz}$=%.2f"%(0.8,K_G)
    L08, = ax4.plot(df_pzz_Jz08["r"],df_pzz_Jz08["corre_abs"],label=label,ls="-",lw=1,color="magenta",
             marker='v',alpha=1,markersize=4,markeredgewidth=1, markeredgecolor="k", markerfacecolor='w')
    L08_, = ax4.plot(df_pzz_Jz08["r"],df_pzz_Jz08["fitcorre_pow"],label=label,ls="--",lw=1,color="k",
             marker='v',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #-------- J_\bot = 1.0
    slope = df_pzz_Jz10["slope_pow"].values[0]
    K_G = round(-slope,2)  
    label = r"$J_{\bot}$=%.1f $K_{SC}^{zz}$=%.2f"%(1.0,K_G)
    L10, = ax4.plot(df_pzz_Jz10["r"],df_pzz_Jz10["corre_abs"],label=label,ls="-",lw=1,color="cyan",
             marker='+',alpha=1,markersize=4,markeredgewidth=1, markeredgecolor="k", markerfacecolor='w')
    L10_, = ax4.plot(df_pzz_Jz10["r"],df_pzz_Jz10["fitcorre_pow"],label=label,ls="--",lw=1,color="k",
             marker='+',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #-------- J_\bot = 2.0
    slope = df_pzz_Jz20["slope_pow"].values[0]
    K_G = round(-slope,2)  
    label = r"$J_{\bot}$=%.1f $K_{SC}^{zz}$=%.2f"%(2.0,K_G)
    L20, = ax4.plot(df_pzz_Jz20["r"],df_pzz_Jz20["corre_abs"],label=label,ls="-",lw=1,color="pink",
             marker='*',alpha=1,markersize=4,markeredgewidth=1, markeredgecolor="k", markerfacecolor='w')
    L20_, = ax4.plot(df_pzz_Jz20["r"],df_pzz_Jz20["fitcorre_pow"],label=label,ls="--",lw=1,color="k",
             marker='*',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #-------- J_\bot = 4.0
    slope = df_pzz_Jz40["slope_pow"].values[0]
    K_G = round(-slope,2)  
    label = r"$J_{\bot}$=%.1f $K_{SC}^{zz}$=%.2f"%(4.0,K_G)
    L40, = ax4.plot(df_pzz_Jz40["r"],df_pzz_Jz40["corre_abs"],label=label,ls="-",lw=1,color="brown",
             marker='h',alpha=1,markersize=4,markeredgewidth=1, markeredgecolor="k", markerfacecolor='w')
    L40_, = ax4.plot(df_pzz_Jz40["r"],df_pzz_Jz40["fitcorre_pow"],label=label,ls="--",lw=1,color="k",
             marker='h',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    ...
    #=========================================================
    ax4.text(28,0.12,"(d)",fontsize = 16, color='black', rotation = 0)
    ax4.text(7,0.12, r'$\mathrm{\delta} = \frac{3}{8}$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=========================================================
    # 坐标轴设置第一层
