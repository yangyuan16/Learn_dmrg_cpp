...
if __name__ =="__main__":
    ...
    #=========================================================
    ax1.text(10,0.558,"(a)",fontsize = 20, color='black', rotation = 0)
    ax1.text(10,0.517, r'$\mathrm{\delta} = \frac{11}{24}$', fontsize = 20, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax1.text(20,0.517, r'$J_{\bot}=0.5$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=======================================================================================
    # 坐标轴设置第一层
    ...
    #ax1.set_yticks([-1,-0.5,0,0.5,1]) 
    #=========================================================
    ax2.text(10,0.558,"(b)",fontsize = 20, color='black', rotation = 0)
    ax2.text(10,0.517, r'$\mathrm{\delta} = \frac{11}{24}$', fontsize = 20, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax2.text(20,0.517, r'$J_{\bot}=1.75$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=======================================================================================
    # 坐标轴设置第一层
    ...
    #ax1.set_yticks([-1,-0.5,0,0.5,1]) 
    #=========================================================
    ax3.text(10,0.558,"(c)",fontsize = 20, color='black', rotation = 0)
    ax3.text(10,0.517, r'$\mathrm{\delta} = \frac{11}{24}$', fontsize = 20, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax3.text(20,0.517, r'$J_{\bot}=2.0$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=======================================================================================
    # 坐标轴设置第一层
    ...
    #ax1.set_yticks([-1,-0.5,0,0.5,1]) 
    #=========================================================
    ax4.text(10,0.550,"(d)",fontsize = 20, color='black', rotation = 0)
    ax4.text(10,0.519, r'$\mathrm{\delta} = \frac{11}{24}$', fontsize = 20, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    ax4.text(20,0.519, r'$J_{\bot}=2.75$', fontsize = 16, fontdict={'family' : 'Times New Roman'},color='black', rotation = 0)
    #=======================================================================================
    # 坐标轴设置第一层
