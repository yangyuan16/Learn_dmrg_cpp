...
if __name__ =="__main__":
    ...
    df_sisj_Jz125 = get_data_sisj(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=1.25,dim=dim)
    ...
    df_sisj_Jz225 = get_data_sisj(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=2.25,dim=dim)
    df_sisj_Jz25 = get_data_sisj(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=2.5,dim=dim)
    df_sisj_Jz275 = get_data_sisj(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=2.75,dim=dim)
    df_sisj_Jz30 = get_data_sisj(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=3.0,dim=dim)
    df_sisj_Jz325 = get_data_sisj(Lz=Lz,Ly=Ly,Lx=Lx,dop=dop,t=t,J=J,Jz=3.25,dim=dim)
    ...
    ax1 = plt.gca()
    #--------- J_\bot = 0.25
    slope = df_sisj_Jz025["slope_exp"].values[0]
    xi = round(-1/slope,2)  
    label = r"$J_{\bot}$=%.2f $\xi_F$=%.2f"%(0.25,xi)
    L025, = ax1.plot(df_sisj_Jz025["r"],df_sisj_Jz025["corre_abs"],label=label,ls="-",lw=2,color="r",
             marker='o',alpha=1,markersize=6,markeredgewidth=1, markeredgecolor="r", markerfacecolor='w')
    L025_, = ax1.plot(df_sisj_Jz025["r"],df_sisj_Jz025["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="r", markerfacecolor='w')
    #--------- J_\bot = 0.50
    slope = df_sisj_Jz05["slope_exp"].values[0]
    xi = round(-1/slope,2)  
    label = r"$J_{\bot}$=%.2f $\xi_F$=%.2f"%(0.5,xi)
    L05, = ax1.plot(df_sisj_Jz05["r"],df_sisj_Jz05["corre_abs"],label=label,ls="-",lw=2,color="blue",
             marker='s',alpha=1,markersize=6,markeredgewidth=1, markeredgecolor="blue", markerfacecolor='w')
    L05_, = ax1.plot(df_sisj_Jz05["r"],df_sisj_Jz05["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
             marker='s',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #--------- J_\bot = 0.75
    slope = df_sisj_Jz075["slope_exp"].values[0]
    xi = round(-1/slope,2)  
    label = r"$J_{\bot}$=%.2f $\xi_F$=%.2f"%(0.75,xi)
    L075, = ax1.plot(df_sisj_Jz075["r"],df_sisj_Jz075["corre_abs"],label=label,ls="-",lw=2,color="green",
             marker='^',alpha=1,markersize=6,markeredgewidth=1, markeredgecolor="green", markerfacecolor='w')
    L075_, = ax1.plot(df_sisj_Jz075["r"],df_sisj_Jz075["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
             marker='^',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #--------- J_\bot = 1.0
    slope = df_sisj_Jz10["slope_exp"].values[0]
    xi = round(-1/slope,2)  
    label = r"$J_{\bot}$=%.2f $\xi_F$=%.2f"%(1.0,xi)
    L10, = ax1.plot(df_sisj_Jz10["r"],df_sisj_Jz10["corre_abs"],label=label,ls="-",lw=2,color="magenta",
    ...
    #-------- J_\bot = 1.25
    slope = df_sisj_Jz125["slope_exp"].values[0]
    xi = round(-1/slope,2)  
    label = r"$J_{\bot}$=%.2f $\xi_F$=%.2f"%(1.25,xi)
    L125, = ax1.plot(df_sisj_Jz125["r"],df_sisj_Jz125["corre_abs"],label=label,ls="-",lw=2,color="cyan",
             marker='+',alpha=1,markersize=6,markeredgewidth=1, markeredgecolor="cyan", markerfacecolor='w')
    L125_, = ax1.plot(df_sisj_Jz125["r"],df_sisj_Jz125["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
             marker='+',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #-------- J_\bot = 1.5
    slope = df_sisj_Jz15["slope_exp"].values[0]
    xi = round(-1/slope,2)  
    label = r"$J_{\bot}$=%.2f $\xi_F$=%.2f"%(1.5,xi)
    L15, = ax1.plot(df_sisj_Jz15["r"],df_sisj_Jz15["corre_abs"],label=label,ls="-",lw=2,color="pink",
    ...
    L175, = ax1.plot(df_sisj_Jz175["r"],df_sisj_Jz175["corre_abs"],label=label,ls="-",lw=2,color="brown",
    ...
    xi = round(-1/slope,2)  
    label = r"$J_{\bot}$=%.2f $\xi_F$=%.2f"%(2.0,xi)
    L20, = ax2.plot(df_sisj_Jz20["r"],df_sisj_Jz20["corre_abs"],label=label,ls="-",lw=2,color="r",
             marker='o',alpha=1,markersize=6,markeredgewidth=1, markeredgecolor="r", markerfacecolor='w')
    L20_, = ax2.plot(df_sisj_Jz20["r"],df_sisj_Jz20["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
    ...
    L225, = ax2.plot(df_sisj_Jz225["r"],df_sisj_Jz225["corre_abs"],label=label,ls="-",lw=2,color="blue",
             marker='s',alpha=1,markersize=6,markeredgewidth=1, markeredgecolor="blue", markerfacecolor='w')
    L225_, = ax2.plot(df_sisj_Jz225["r"],df_sisj_Jz225["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
             marker='s',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #--------- J_\bot = 2.5
    slope = df_sisj_Jz25["slope_exp"].values[0]
    xi = round(-1/slope,2)  
    label = r"$J_{\bot}$=%.2f $\xi_F$=%.2f"%(2.5,xi)
    L25, = ax2.plot(df_sisj_Jz25["r"],df_sisj_Jz25["corre_abs"],label=label,ls="-",lw=2,color="green",
             marker='^',alpha=1,markersize=6,markeredgewidth=1, markeredgecolor="green", markerfacecolor='w')
    L25_, = ax2.plot(df_sisj_Jz25["r"],df_sisj_Jz25["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
             marker='^',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #--------- J_\bot = 2.75
    slope = df_sisj_Jz275["slope_exp"].values[0]
    xi = round(-1/slope,2)  
    label = r"$J_{\bot}$=%.2f $\xi_F$=%.2f"%(2.75,xi)
    L275, = ax2.plot(df_sisj_Jz275["r"],df_sisj_Jz275["corre_abs"],label=label,ls="-",lw=2,color="magenta",
             marker='v',alpha=1,markersize=6,markeredgewidth=1, markeredgecolor="magenta", markerfacecolor='w')
    L275_, = ax2.plot(df_sisj_Jz275["r"],df_sisj_Jz275["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
             marker='v',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #-------- J_\bot = 3.0
    slope = df_sisj_Jz30["slope_exp"].values[0]
    xi = round(-1/slope,2)  
    label = r"$J_{\bot}$=%.2f $\xi_F$=%.2f"%(3.0,xi)
    L30, = ax2.plot(df_sisj_Jz30["r"],df_sisj_Jz30["corre_abs"],label=label,ls="-",lw=2,color="cyan",
             marker='+',alpha=1,markersize=6,markeredgewidth=1, markeredgecolor="cyan", markerfacecolor='w')
    L30_, = ax2.plot(df_sisj_Jz30["r"],df_sisj_Jz30["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
             marker='+',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #-------- J_\bot = 3.25
    slope = df_sisj_Jz325["slope_exp"].values[0]
    xi = round(-1/slope,2)  
    label = r"$J_{\bot}$=%.2f $\xi_F$=%.2f"%(3.25,xi)
    L325, = ax2.plot(df_sisj_Jz325["r"],df_sisj_Jz325["corre_abs"],label=label,ls="-",lw=2,color="pink",
             marker='*',alpha=1,markersize=6,markeredgewidth=1, markeredgecolor="pink", markerfacecolor='w')
    L325_, = ax2.plot(df_sisj_Jz325["r"],df_sisj_Jz325["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
             marker='*',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #-------- J_\bot = 3.5
    slope = df_sisj_Jz35["slope_exp"].values[0]
    xi = round(-1/slope,2)  
    label = r"$J_{\bot}$=%.2f $\xi_F$=%.2f"%(3.5,xi)
    L35, = ax2.plot(df_sisj_Jz35["r"],df_sisj_Jz35["corre_abs"],label=label,ls="-",lw=2,color="brown",
             marker='h',alpha=1,markersize=6,markeredgewidth=1, markeredgecolor="brown", markerfacecolor='w')
    L35_, = ax2.plot(df_sisj_Jz35["r"],df_sisj_Jz35["fitcorre_exp"],label=label,ls="--",lw=1.5,color="k",
             marker='h',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    ...
    L025, = ax3.plot(df_sisj_Jz025["r"],df_sisj_Jz025["corre_abs"],label=label,ls="-",lw=2,color="r",
             marker='o',alpha=1,markersize=6,markeredgewidth=1, markeredgecolor="r", markerfacecolor='w')
    L025_, = ax3.plot(df_sisj_Jz025["r"],df_sisj_Jz025["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #--------- J_\bot = 0.50
    slope = df_sisj_Jz05["slope_pow"].values[0]
    K_F = round(-slope,2)  
    label = r"$J_{\bot}$=%.2f $K_F$=%.2f"%(0.5,K_F)
    L05, = ax3.plot(df_sisj_Jz05["r"],df_sisj_Jz05["corre_abs"],label=label,ls="-",lw=2,color="blue",
             marker='s',alpha=1,markersize=6,markeredgewidth=1, markeredgecolor="blue", markerfacecolor='w')
    L05_, = ax3.plot(df_sisj_Jz05["r"],df_sisj_Jz05["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='s',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #--------- J_\bot = 0.75
    slope = df_sisj_Jz075["slope_pow"].values[0]
    K_F = round(-slope,2)  
    label = r"$J_{\bot}$=%.2f $K_F$=%.2f"%(0.75,K_F)
    L075, = ax3.plot(df_sisj_Jz075["r"],df_sisj_Jz075["corre_abs"],label=label,ls="-",lw=2,color="green",
             marker='^',alpha=1,markersize=6,markeredgewidth=1, markeredgecolor="green", markerfacecolor='w')
    L075_, = ax3.plot(df_sisj_Jz075["r"],df_sisj_Jz075["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='^',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #--------- J_\bot = 1.0
    slope = df_sisj_Jz10["slope_pow"].values[0]
    K_F = round(-slope,2)  
    label = r"$J_{\bot}$=%.2f $K_F$=%.2f"%(1.0,K_F)
    L10, = ax3.plot(df_sisj_Jz10["r"],df_sisj_Jz10["corre_abs"],label=label,ls="-",lw=2,color="magenta",
             marker='v',alpha=1,markersize=6,markeredgewidth=1, markeredgecolor="magenta", markerfacecolor='w')
    L10_, = ax3.plot(df_sisj_Jz10["r"],df_sisj_Jz10["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='v',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #-------- J_\bot = 1.25
    slope = df_sisj_Jz125["slope_pow"].values[0]
    K_F = round(-slope,2)  
    label = r"$J_{\bot}$=%.2f $K_F$=%.2f"%(1.25,K_F)
    L125, = ax3.plot(df_sisj_Jz125["r"],df_sisj_Jz125["corre_abs"],label=label,ls="-",lw=2,color="cyan",
             marker='+',alpha=1,markersize=6,markeredgewidth=1, markeredgecolor="cyan", markerfacecolor='w')
    L125_, = ax3.plot(df_sisj_Jz125["r"],df_sisj_Jz125["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='+',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #-------- J_\bot = 1.5
    slope = df_sisj_Jz15["slope_pow"].values[0]
    K_F = round(-slope,2)  
    label = r"$J_{\bot}$=%.2f $K_F$=%.2f"%(1.5,K_F)
    L15, = ax3.plot(df_sisj_Jz15["r"],df_sisj_Jz15["corre_abs"],label=label,ls="-",lw=2,color="pink",
             marker='*',alpha=1,markersize=6,markeredgewidth=1, markeredgecolor="pink", markerfacecolor='w')
    ...
    K_F = round(-slope,2)  
    label = r"$J_{\bot}$=%.2f $\xi_F$=%.2f"%(1.75,K_F)
    L175, = ax3.plot(df_sisj_Jz175["r"],df_sisj_Jz175["corre_abs"],label=label,ls="-",lw=2,color="brown",
             marker='h',alpha=1,markersize=6,markeredgewidth=1, markeredgecolor="brown", markerfacecolor='w')
    ...
    K_F = round(-slope,2)  
    label = r"$J_{\bot}$=%.2f $K_F$=%.2f"%(2.0,K_F)
    L20, = ax4.plot(df_sisj_Jz20["r"],df_sisj_Jz20["corre_abs"],label=label,ls="-",lw=2,color="r",
             marker='o',alpha=1,markersize=6,markeredgewidth=1, markeredgecolor="r", markerfacecolor='w')
    L20_, = ax4.plot(df_sisj_Jz20["r"],df_sisj_Jz20["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='o',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #--------- J_\bot = 2.25
    slope = df_sisj_Jz225["slope_pow"].values[0]
    K_F = round(-slope,2)  
    label = r"$J_{\bot}$=%.2f $K_F$=%.2f"%(2.25,K_F)
    L225, = ax4.plot(df_sisj_Jz225["r"],df_sisj_Jz225["corre_abs"],label=label,ls="-",lw=2,color="blue",
             marker='s',alpha=1,markersize=6,markeredgewidth=1, markeredgecolor="blue", markerfacecolor='w')
    L225_, = ax4.plot(df_sisj_Jz225["r"],df_sisj_Jz225["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='s',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #--------- J_\bot = 2.5
    slope = df_sisj_Jz25["slope_pow"].values[0]
    K_F = round(-slope,2)  
    label = r"$J_{\bot}$=%.2f $K_F$=%.2f"%(2.5,K_F)
    L25, = ax4.plot(df_sisj_Jz25["r"],df_sisj_Jz25["corre_abs"],label=label,ls="-",lw=2,color="green",
             marker='^',alpha=1,markersize=6,markeredgewidth=1, markeredgecolor="green", markerfacecolor='w')
    L25_, = ax4.plot(df_sisj_Jz25["r"],df_sisj_Jz25["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='^',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #--------- J_\bot = 2.75
    slope = df_sisj_Jz275["slope_pow"].values[0]
    K_F = round(-slope,2)  
    label = r"$J_{\bot}$=%.2f $K_F$=%.2f"%(2.75,K_F)
    L275, = ax4.plot(df_sisj_Jz275["r"],df_sisj_Jz275["corre_abs"],label=label,ls="-",lw=2,color="magenta",
             marker='v',alpha=1,markersize=6,markeredgewidth=1, markeredgecolor="magenta", markerfacecolor='w')
    L275_, = ax4.plot(df_sisj_Jz275["r"],df_sisj_Jz275["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='v',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #-------- J_\bot = 3.0
    slope = df_sisj_Jz30["slope_pow"].values[0]
    K_F = round(-slope,2)  
    label = r"$J_{\bot}$=%.2f $K_F$=%.2f"%(3.0,K_F)
    L30, = ax4.plot(df_sisj_Jz30["r"],df_sisj_Jz30["corre_abs"],label=label,ls="-",lw=2,color="cyan",
             marker='+',alpha=1,markersize=6,markeredgewidth=1, markeredgecolor="cyan", markerfacecolor='w')
    L30_, = ax4.plot(df_sisj_Jz30["r"],df_sisj_Jz30["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='+',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #-------- J_\bot = 3.25
    slope = df_sisj_Jz325["slope_pow"].values[0]
    K_F = round(-slope,2)  
    label = r"$J_{\bot}$=%.2f $K_F$=%.2f"%(3.25,K_F)
    L325, = ax4.plot(df_sisj_Jz325["r"],df_sisj_Jz325["corre_abs"],label=label,ls="-",lw=2,color="pink",
             marker='*',alpha=1,markersize=6,markeredgewidth=1, markeredgecolor="pink", markerfacecolor='w')
    L325_, = ax4.plot(df_sisj_Jz325["r"],df_sisj_Jz325["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='*',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
    #-------- J_\bot = 3.5
    slope = df_sisj_Jz35["slope_pow"].values[0]
    K_F = round(-slope,2)  
    label = r"$J_{\bot}$=%.2f $\xi_F$=%.2f"%(3.5,K_F)
    L35, = ax4.plot(df_sisj_Jz35["r"],df_sisj_Jz35["corre_abs"],label=label,ls="-",lw=2,color="brown",
             marker='h',alpha=1,markersize=6,markeredgewidth=1, markeredgecolor="brown", markerfacecolor='w')
    L35_, = ax4.plot(df_sisj_Jz35["r"],df_sisj_Jz35["fitcorre_pow"],label=label,ls="--",lw=1.5,color="k",
             marker='h',alpha=1,markersize=0,markeredgewidth=0, markeredgecolor="k", markerfacecolor='w')
