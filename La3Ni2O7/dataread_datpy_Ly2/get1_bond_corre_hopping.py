...
# 
def plot_bond_hopping_curve(df_dict_hopping, Jz):
    #------- fig yy1
    fig = plt.figure(figsize=(10,3)) 
    ax1 = plt.subplot(1,1,1)
    plt.sca(ax1)  ##选择对ax1进行绘图
    ax1=plt.gca() #获得坐标轴的句柄
    r = range(len(df_dict_hopping['yy1']['bond_corre']))
    ax1.plot(r,df_dict_hopping['yy1']['bond_corre'],label=r"G",ls="-",lw=1.5,color="g",
             marker='o',alpha=1,markersize=6,markeredgewidth=1.5, markeredgecolor="g",
             markerfacecolor='None')
    label_x = r"i"
    label_y = "bond hopping YY 1"
    ...
    plt.sca(ax1)  ##选择对ax1进行绘图
    ax1=plt.gca() #获得坐标轴的句柄
    r = range(len(df_dict_hopping['yy2']['bond_corre']))
    ax1.plot(r,df_dict_hopping['yy2']['bond_corre'],label=r"G",ls="-",lw=1.5,color="g",
             marker='o',alpha=1,markersize=6,markeredgewidth=1.5, markeredgecolor="g",
             markerfacecolor='None')
    label_x = r"i"
    label_y = "bond hopping YY 2"
    ax1.set_xlabel(label_x, size= 25)
    ax1.set_ylabel(label_y, size= 25)
    #
    ax1.tick_params(labelsize = 25) # 设置坐标刻度对应数字的大小
    ...
    plt.sca(ax1)  ##选择对ax1进行绘图
    ax1=plt.gca() #获得坐标轴的句柄
    r = range(len(df_dict_hopping['xx1']['bond_corre']))
    ax1.plot(r,df_dict_hopping['xx1']['bond_corre'],label=r"G",ls="-",lw=1.5,color="g",
             marker='o',alpha=1,markersize=6,markeredgewidth=1.5, markeredgecolor="g",
             markerfacecolor='None')
    label_x = r"i"
    label_y = "bond hopping XX 1"
    ax1.set_xlabel(label_x, size= 25)
    ax1.set_ylabel(label_y, size= 25)
    #
    ax1.tick_params(labelsize = 25) # 设置坐标刻度对应数字的大小
    ...
    plt.sca(ax1)  ##选择对ax1进行绘图
    ax1=plt.gca() #获得坐标轴的句柄
    r = range(len(df_dict_hopping['xx2']['bond_corre']))
    ax1.plot(r,df_dict_hopping['xx2']['bond_corre'],label=r"G",ls="-",lw=1.5,color="g",
             marker='o',alpha=1,markersize=6,markeredgewidth=1.5, markeredgecolor="g",
             markerfacecolor='None')
    label_x = r"i"
    label_y = "bond hopping XX 2"
    ax1.set_xlabel(label_x, size= 25)
    ax1.set_ylabel(label_y, size= 25)
    #
    ax1.tick_params(labelsize = 25) # 设置坐标刻度对应数字的大小
    ...
    plt.sca(ax1)  ##选择对ax1进行绘图
    ax1=plt.gca() #获得坐标轴的句柄
    r = range(len(df_dict_hopping['xx3']['bond_corre']))
    ax1.plot(r,df_dict_hopping['xx3']['bond_corre'],label=r"G",ls="-",lw=1.5,color="g",
             marker='o',alpha=1,markersize=6,markeredgewidth=1.5, markeredgecolor="g",
             markerfacecolor='None')
    label_x = r"i"
    label_y = "bond hopping XX 3"
    ax1.set_xlabel(label_x, size= 25)
    ax1.set_ylabel(label_y, size= 25)
    #
    ax1.tick_params(labelsize = 25) # 设置坐标刻度对应数字的大小
    ...
    plt.sca(ax1)  ##选择对ax1进行绘图
    ax1=plt.gca() #获得坐标轴的句柄
    r = range(len(df_dict_hopping['xx4']['bond_corre']))
    ax1.plot(r,df_dict_hopping['xx4']['bond_corre'],label=r"G",ls="-",lw=1.5,color="g",
             marker='o',alpha=1,markersize=6,markeredgewidth=1.5, markeredgecolor="g",
             markerfacecolor='None')
    label_x = r"i"
    label_y = "bond hopping XX 4"
    ax1.set_xlabel(label_x, size= 25)
    ax1.set_ylabel(label_y, size= 25)
    #
    ax1.tick_params(labelsize = 25) # 设置坐标刻度对应数字的大小
    ...
    plt.sca(ax1)  ##选择对ax1进行绘图
    ax1=plt.gca() #获得坐标轴的句柄
    r = range(len(df_dict_hopping['zz1']['bond_corre']))
    ax1.plot(r,df_dict_hopping['zz1']['bond_corre'],label=r"G",ls="-",lw=1.5,color="g",
             marker='o',alpha=1,markersize=6,markeredgewidth=1.5, markeredgecolor="g",
             markerfacecolor='None')
    label_x = r"i"
    label_y = "bond hopping ZZ 1"
    ax1.set_xlabel(label_x, size= 25)
    ax1.set_ylabel(label_y, size= 25)
    #
    ax1.tick_params(labelsize = 25) # 设置坐标刻度对应数字的大小
    ...
    plt.sca(ax1)  ##选择对ax1进行绘图
    ax1=plt.gca() #获得坐标轴的句柄
    r = range(len(df_dict_hopping['zz2']['bond_corre']))
    ax1.plot(r,df_dict_hopping['zz2']['bond_corre'],label=r"G",ls="-",lw=1.5,color="g",
             marker='o',alpha=1,markersize=6,markeredgewidth=1.5, markeredgecolor="g",
             markerfacecolor='None')
    label_x = r"i"
    label_y = "bond hopping ZZ 2"
    ax1.set_xlabel(label_x, size= 25)
    ax1.set_ylabel(label_y, size= 25)
    #
    ax1.tick_params(labelsize = 25) # 设置坐标刻度对应数字的大小
...
if __name__ == "__main__":
    ...
    for it in range(len(Jz_list)):
        ...
        print('-----bond hopping data-----')
        df_dict_hopping = get_bond_corre(Lz=Lz,Lx=Lx,Ly=Ly, df=df_hopping)
        #
        #
        #------ plot bond hopping
        plot_bond_hopping_curve(df_dict_hopping=df_dict_hopping,Jz=Jz)