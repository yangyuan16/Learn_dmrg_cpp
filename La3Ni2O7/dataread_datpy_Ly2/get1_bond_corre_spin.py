...
# 
def plot_bond_spin_curve(df_dict_spin, Jz):
    #------- fig yy1
    fig = plt.figure(figsize=(10,3)) 
    ax1 = plt.subplot(1,1,1)
    plt.sca(ax1)  ##选择对ax1进行绘图
    ax1=plt.gca() #获得坐标轴的句柄
    r = range(len(df_dict_spin['yy1']['bond_corre']))
    ax1.plot(r,df_dict_spin['yy1']['bond_corre'],label=r"G",ls="-",lw=1.5,color="red",
             marker='o',alpha=1,markersize=6,markeredgewidth=1.5, markeredgecolor="red",
             markerfacecolor='None')
    label_x = r"i"
    label_y = "bond spin YY 1"
    ...
    plt.sca(ax1)  ##选择对ax1进行绘图
    ax1=plt.gca() #获得坐标轴的句柄
    r = range(len(df_dict_spin['yy2']['bond_corre']))
    ax1.plot(r,df_dict_spin['yy2']['bond_corre'],label=r"G",ls="-",lw=1.5,color="red",
             marker='o',alpha=1,markersize=6,markeredgewidth=1.5, markeredgecolor="red",
             markerfacecolor='None')
    label_x = r"i"
    label_y = "bond spin YY 2"
    ax1.set_xlabel(label_x, size= 25)
    ax1.set_ylabel(label_y, size= 25)
    #
    ax1.tick_params(labelsize = 25) # 设置坐标刻度对应数字的大小
    ...
    plt.sca(ax1)  ##选择对ax1进行绘图
    ax1=plt.gca() #获得坐标轴的句柄
    r = range(len(df_dict_spin['xx1']['bond_corre']))
    ax1.plot(r,df_dict_spin['xx1']['bond_corre'],label=r"G",ls="-",lw=1.5,color="red",
             marker='o',alpha=1,markersize=6,markeredgewidth=1.5, markeredgecolor="red",
             markerfacecolor='None')
    label_x = r"i"
    label_y = "bond spin XX 1"
    ax1.set_xlabel(label_x, size= 25)
    ax1.set_ylabel(label_y, size= 25)
    #
    ax1.tick_params(labelsize = 25) # 设置坐标刻度对应数字的大小
    ...
    plt.sca(ax1)  ##选择对ax1进行绘图
    ax1=plt.gca() #获得坐标轴的句柄
    r = range(len(df_dict_spin['xx2']['bond_corre']))
    ax1.plot(r,df_dict_spin['xx2']['bond_corre'],label=r"G",ls="-",lw=1.5,color="red",
             marker='o',alpha=1,markersize=6,markeredgewidth=1.5, markeredgecolor="red",
             markerfacecolor='None')
    label_x = r"i"
    label_y = "bond spin XX 2"
    ax1.set_xlabel(label_x, size= 25)
    ax1.set_ylabel(label_y, size= 25)
    #
    ax1.tick_params(labelsize = 25) # 设置坐标刻度对应数字的大小
    ...
    plt.sca(ax1)  ##选择对ax1进行绘图
    ax1=plt.gca() #获得坐标轴的句柄
    r = range(len(df_dict_spin['xx3']['bond_corre']))
    ax1.plot(r,df_dict_spin['xx3']['bond_corre'],label=r"G",ls="-",lw=1.5,color="red",
             marker='o',alpha=1,markersize=6,markeredgewidth=1.5, markeredgecolor="red",
             markerfacecolor='None')
    label_x = r"i"
    label_y = "bond spin XX 3"
    ax1.set_xlabel(label_x, size= 25)
    ax1.set_ylabel(label_y, size= 25)
    #
    ax1.tick_params(labelsize = 25) # 设置坐标刻度对应数字的大小
    ...
    plt.sca(ax1)  ##选择对ax1进行绘图
    ax1=plt.gca() #获得坐标轴的句柄
    r = range(len(df_dict_spin['xx4']['bond_corre']))
    ax1.plot(r,df_dict_spin['xx4']['bond_corre'],label=r"G",ls="-",lw=1.5,color="red",
             marker='o',alpha=1,markersize=6,markeredgewidth=1.5, markeredgecolor="red",
             markerfacecolor='None')
    label_x = r"i"
    label_y = "bond spin XX 4"
    ax1.set_xlabel(label_x, size= 25)
    ax1.set_ylabel(label_y, size= 25)
    #
    ax1.tick_params(labelsize = 25) # 设置坐标刻度对应数字的大小
    ...
    plt.sca(ax1)  ##选择对ax1进行绘图
    ax1=plt.gca() #获得坐标轴的句柄
    r = range(len(df_dict_spin['zz1']['bond_corre']))
    ax1.plot(r,df_dict_spin['zz1']['bond_corre'],label=r"G",ls="-",lw=1.5,color="red",
             marker='o',alpha=1,markersize=6,markeredgewidth=1.5, markeredgecolor="red",
             markerfacecolor='None')
    label_x = r"i"
    label_y = "bond spin ZZ 1"
    ax1.set_xlabel(label_x, size= 25)
    ax1.set_ylabel(label_y, size= 25)
    #
    ax1.tick_params(labelsize = 25) # 设置坐标刻度对应数字的大小
    ...
    plt.sca(ax1)  ##选择对ax1进行绘图
    ax1=plt.gca() #获得坐标轴的句柄
    r = range(len(df_dict_spin['zz2']['bond_corre']))
    ax1.plot(r,df_dict_spin['zz2']['bond_corre'],label=r"G",ls="-",lw=1.5,color="red",
             marker='o',alpha=1,markersize=6,markeredgewidth=1.5, markeredgecolor="red",
             markerfacecolor='None')
    label_x = r"i"
    label_y = "bond spin ZZ 2"
    ax1.set_xlabel(label_x, size= 25)
    ax1.set_ylabel(label_y, size= 25)
    #
    ax1.tick_params(labelsize = 25) # 设置坐标刻度对应数字的大小
...
if __name__ == "__main__":
    ...
    for it in range(len(Jz_list)):
        ...
        #
        #------ plot bond spin
        plot_bond_spin_curve(df_dict_spin=df_dict_spin,Jz=Jz)