# 对比不同 dim 值下的 correlation function
import numpy as np
import pandas as pd
...
if __name__ == "__main__":
    ...
    L8000, = ax1.plot(r_dim8000,corre_dim8000,label="dim={}".format(8000),ls="-",lw=1.5,color="b",
             marker='o',alpha=1,markersize=12,markeredgewidth=1.5, markeredgecolor="b",
             markerfacecolor='None')
    L10000, = ax1.plot(r_dim10000,corre_dim10000,label="dim={}".format(10000),ls="-",lw=1.5,color="green",
    ...
    legend1=plt.legend(handles=[L6000, L8000, L10000], loc = 4, bbox_to_anchor=(0.38, 0.02),
    ...
    plt.title("YY pairing, Jz=%.2f"%Jz, fontsize=25)
    plt.show()