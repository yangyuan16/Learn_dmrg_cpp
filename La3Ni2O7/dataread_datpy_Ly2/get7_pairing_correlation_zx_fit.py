...
def plot_expfit(df):
    ...
    xi = -1/slope 
    label_data = "$<\Delta_i^{zx} \Delta_j^{zx}>$"
...
if __name__ == "__main__":
    ...
    print(len(df))
    #================选定某些数据点==========================
    df_cut_exp = df.loc[[7,9,11,24,26,28,30]] # exponential fit
    df_cut_pow = df.loc[[1,5,8,10,13,16,19,22]] # power law fit
    ...
    Issave = True
    if Issave:
        filepath4 = "\\measurement_pairing_zx_fit.parquet" 
